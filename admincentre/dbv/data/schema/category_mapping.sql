CREATE TABLE `category_mapping` (
  ...
  `category_mapping_id` bigint(20) unsigned NOT NULL COMMENT 'sku / cat_id / sub_cat_id',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_join` (`category_mapping_id`,`level`,`country_id`,`status`) USING BTREE,
  KEY `idx_product_name` (`product_name`) USING BTREE,
  KEY `idx_ext_party` (`ext_party`) USING BTREE
