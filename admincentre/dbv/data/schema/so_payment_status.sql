CREATE TABLE `so_payment_status` (
  ...
  `risk_ref_1` varchar(256) NOT NULL DEFAULT '' COMMENT 'PayPal:PROTECTIONELIGIBILITY / GlobalCollect:AVSRESULT / MoneyBookers: VERIFICATIONLEVEL / Adyen:3DAUTHENTICATIONRESULT',
  `risk_ref_2` varchar(64) NOT NULL DEFAULT '' COMMENT 'PayPal:PROTECTIONELIGIBILITYTYPE / GlobalCollect:FRAUDRESULT, AltaPay:FraudRiskScore, Adyen:FraudScore',
  `risk_ref_3` varchar(64) NOT NULL DEFAULT '' COMMENT 'PayPal:ADDRESSSTATUS, AltaPay:FraudRecommendation, Adyen:AuthorisationCode',
  `risk_ref_4` varchar(256) NOT NULL DEFAULT '' COMMENT 'PayPal:PAYERSTATUS, AltaPay:FraudExplanation, Adyen:RefusalReason',
