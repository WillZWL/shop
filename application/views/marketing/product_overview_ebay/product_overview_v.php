...
<script>
	$( document ).ready(function() {
		...
		//     }
		// }
		// if($.urlParam('checkit') == 1){
		// 	$('tr').find("[dataname='act']").val("RE").change();
		// 	//$('#fm > table.tb_list > tbody > tr').addClass('marked');
		// }
...
<table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
	...
	<tr>
		<td></td>
		<td>
			Export as CSV <a href="/marketing/product_overview_ebay?<?=$query_string?>&csv=1">here</a>,
			after modification, upload the file below
			<form action="/marketing/product_overview_ebay/upload_sku_info" enctype="multipart/form-data" method="post">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
	<col width="20"><col width="60"><col><col width="60"><col width="80"><col width="40"><col width="50"><col width="95">
	<?php
	...
	?>
	<col width="80"><col width="75"><col width="60"><col width="70"><col width="50"><col width="50"><col width="27">
	<tr class="header">
		<td height="20">
		...
		<td title="<?=$lang["handling_time"]?>"><a href="#" onClick="SortCol(document.fm, 'handling_time', '<?=$xsort["handling_time"]?>')"><?=$lang["handling_time"]?> <?=$sortimg["handling_time"]?></a></td>
		...
		<td title="<?=$lang["action"]?>"><?=$lang["action"]?></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="padding-top:5px;">
	<tr>
		...
		<input type="button" id="readd" value="Re-Additem" class="button" onClick="if (CheckProfit(this.form)){needToConfirm=false;this.form.submit()}">
		<input type="button" id="revise" value="Revise Item" class="button" onClick="if (CheckProfit(this.form)){needToConfirm=false;this.form.submit()}">
		<input type="button" id="end" value="End Item" class="button" onClick="if (CheckProfit(this.form)){needToConfirm=false;this.form.submit()}">
			<input type="button" id="update" value="<?=$lang['cmd_button']?>" class="button" onClick="if (CheckProfit(this.form)){needToConfirm=false;this.form.submit()}">
		</td>
	</tr>
</table>
