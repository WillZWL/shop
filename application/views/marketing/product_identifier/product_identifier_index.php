...
<form name="fm" action="<?=base_url()?>marketing/product_identifier" method="get">
...
<tr height="70">
    ...
    <col width="140"><col width="120"><col width="120"><col width="120"><col width="120"><col width="120"><col width="40">
    <tr>
        <td><b><?=$lang["by_prod_grp_cd"]?></b></td>
        <td><input name="prod_grp_cd" class="input" value='<?=htmlspecialchars($this->input->get("prod_grp_cd"))?>'></td>
        ...
        <td><b><?=$lang["by_colour_id"]?></b></td>
        <td><input name="colour_id" class="input" value='<?=htmlspecialchars($this->input->get("colour_id"))?>'></td>
...
<iframe name="plist" id="plist" src="<?=base_url()?>marketing/product_identifier/plist/?<?=$_SERVER['QUERY_STRING']?>" width="200" style="float:left;border-right:1px solid #000000;" noresize frameborder="0" marginwidth="0" marginheight="0" hspace=0 vspace=0 onLoad="SetFrameFullHeight(this)"></iframe>
...
<script>
    ...
    top.frames["pview"].location.href='<?=base_url()?>marketing/product_identifier/view/' + hash;
</script>
</body>
</html>