...
<div id="main">
                ...
                <td align="right">
                    <table border="0" cellpadding="0" cellspacing="0" style="text-align:right">
                        ...
                        <tr>
                            ...
                            <td><input name="prod_grp_cd" class="input"
                                       value='<?= htmlspecialchars($this->input->get("prod_grp_cd")) ?>'></td>
                            ...
                            <td><input name="name" class="input"
                                       value='<?= htmlspecialchars($this->input->get("name")) ?>'></td>
                        ...
                        <td><input name="colour_id" class="input"
                                   value='<?= htmlspecialchars($this->input->get("colour_id")) ?>'></td>
                        <td><b><?= $lang["by_sku"] ?></b></td>
                        <td><input name="sku" class="input" value='<?= htmlspecialchars($this->input->get("sku")) ?>'>
                        </td>
                        <td></td>
                        <td></td>
                        </tr>
    ...
    <iframe name="plist" id="plist"
            src="<?= base_url() ?>marketing/product_identifier/plist/?<?= $_SERVER['QUERY_STRING'] ?>" width="200"
