...
<tr height="70">
	...
	<tr>
		...
		<td></td>
		<td><a href="/marketing/pricing_tool_website/bulk_list">Bulk List + Auto-price</a></td>
...
<iframe name="plist" id="plist" src="<?=base_url().$this->tool_path?>/plist/?<?=$_SERVER['QUERY_STRING']?>" width="200" style="float:left;border-right:1px solid #000000;" noresize frameborder="0" marginwidth="0" marginheight="0" hspace=0 vspace=0 onLoad="SetFrameFullHeight(this)"></iframe>
