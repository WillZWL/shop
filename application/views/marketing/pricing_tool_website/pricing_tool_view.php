                            ...
                            <tr>
                                ...
                                <td width="30%" class="value">
                                    ...
                                    <a class="iframe cboxElement"
                                       href="/marketing/pricing_tool_website/manage_feed/<?= $prod_obj->get_sku() ?>/<?= $platform ?>">Edit</a>
                                    (<a class="iframe cboxElement"
                                        ...
                                        if ($key == $obj->get_competitor_id()) {
                                            ...
                                            if ($islowestmatch == TRUE && $obj->get_match() == 1) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td bgcolor="greenyellow"><b><?= $obj->get_reprice_value() ?></b>
                                                    </td>
                                                    <td bgcolor="greenyellow">
                                                        <b><?= $obj->get_reprice_min_margin() ?></b></td>
                                                    <td bgcolor="greenyellow">
