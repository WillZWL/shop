...
<div id="main" style="width:auto;">
    <form name="fm" method="get" action="<?= base_url() ?>marketing/top_view_video/view_left/">
                ...
                if ($objlist) {
                    foreach ($objlist as $obj) {
                        ...
                        <tr class="row<?= $i % 2 ?> pointer" onMouseOver="AddClassName(this, 'highlight')"
                            ...
                            onClick="addToRight('<?= $obj->get_sku() ?>','<?= $obj->get_prod_name() ?>','<?= $obj->get_ref_id() ?>','<?= $obj->get_lang_id() ?>')">
                            <td nowrap style="white-space:nowrap;"><?= $obj->get_sku() ?></td>
                            <td>
                                <object width="195" height="135">
                                    <param name="movie"
                                    ...
                                    <embed
                                        ...
                                        allowfullscreen="true" width="195" height="135"></embed>
                                </object>
                            </td>
                        </tr>
                        <?php
