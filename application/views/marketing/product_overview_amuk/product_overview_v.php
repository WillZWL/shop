    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td width="400" align="right" class="title"><input type="button" value="<?= $lang["list_button"] ?>"
                                                               class="button"
                                                               onClick="Redirect('<?= site_url('marketing/product_overview_amuk/') ?>')">
            </td>
        </tr>
        <tr>
    ...
    <form name="fm" method="get" onSubmit="return CheckForm(this)">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
            ...
            <tr class="header">
                ...
                <td title="<?= $lang["latency"] ?>"><a href="#"
                                                       onClick="SortCol(document.fm, 'latency', '<?= $xsort["latency"] ?>')"><?= $lang["latency"] ?> <?= $sortimg["latency"] ?></a>
                </td>
            ...
            <tr class="search" id="tr_search" <?= $searchdisplay ?>>
                ...
                <td><input name="latency" class="input" value="<?= htmlspecialchars($this->input->get("latency")) ?>">
                </td>
                <td>
                    <?php
