...
<div id="main" style="width:auto;">
    ...
    <form name="fm" action="<?= base_url() ?>marketing/upselling/add_group/" method="POST" onSubmit="CheckForm(this);"
          target="_parent">
        ...
        <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#cccccc">
            <tr>
                <td height="25" bgcolor="#333333" style="padding-left:10px;"><font
                        style="color:#ffffff; font-weight:bold; font-size:12px;"><?= $lang["group_detail"] ?></font>
                </td>
            </tr>
        </table>
