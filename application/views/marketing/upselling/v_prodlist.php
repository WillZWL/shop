<html>
    ...
    <body class="frame_left" style="width:auto;">
        <div id="main" style="width:auto;">
            <form name="fm" method="get" action="<?=base_url()?>marketing/upselling/group_add_left/">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td rowspan="2"><input type="submit" style="background: rgb(204, 204, 204) url(/images/find.gif) no-repeat scroll center center; -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous; width: 30px; height: 25px;" class="search_button" value=""/></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                ...
                ?>
                        ...
                        <!--
                            ...
                            {
                                parent.frames['right'].addRow('upselling_group_form',sku,name);
                            }
                        -->
                        </script>
                        <hr>
