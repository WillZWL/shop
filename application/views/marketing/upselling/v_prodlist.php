        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td rowspan="2"><input type="submit"
                                       style="background: rgb(204, 204, 204) url(/images/find.gif) no-repeat scroll center center; -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous; width: 30px; height: 25px;"
                ...
                if ($objlist) {
                    foreach ($objlist as $obj) {
                        ...
                        <tr class="row<?= $i % 2 ?> pointer" onMouseOver="AddClassName(this, 'highlight')"
                            ...
                            onClick='addToRight("<?= $obj->get_sku() ?>","<?= addslashes($obj->get_name()) ?>")'>
