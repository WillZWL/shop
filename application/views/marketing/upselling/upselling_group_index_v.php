    ...
    <form name="fm" method="get">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
            ...
            <tr class="header">
                ...
                <td><a href="#"
                       onClick="SortCol(document.fm, 'group_name', '<?= $xsort["group_name"] ?>')"><?= $lang["group_name"] ?> <?= $sortimg["group_name"] ?></a>
                </td>
                <td><a href="#"
                       onClick="SortCol(document.fm, 'warranty', '<?= $xsort["warranty"] ?>')"><?= $lang["warranty"] ?> <?= $sortimg["warranty"] ?></a>
                </td>
                <td><a href="#"
            ...
            if ($objlist) {
                foreach ($objlist as $obj) {
                    ...
                    <tr class="row<?= $i % 2 ?> pointer" onMouseOver="AddClassName(this, 'highlight')"
                        ...
                        onClick="Redirect('<?= site_url('marketing/upselling/view_group/' . $obj->get_group_id()) ?>')">
