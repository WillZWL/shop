...
<div id="main" style="width:auto;">
    ...
    <form name="fm"
          action="<?= base_url() ?>marketing/upselling/view_group/<?= $ra_group_obj->get_group_id() ?>/<?= $lang_id ?>"
        ...
        <table border="0" cellpadding="0" cellspacing="1" width="100%" class="tb_list">
            <tr>
                ...
                <td class="value"><input type="text" name="group_name"
                                         value="<?= htmlentities($ra_group_obj->get_group_name()) ?>" class="input"
                                         notEmpty></td>
            ...
            <tr>
                ...
                <td class="value"><input type="text" name="group_display_name"
                                         value="<?= $ra_group_content_obj->get_group_display_name() ?>"
                                         style="width:80%" notEmpty>
        ...
        <table border="0" cellspacing="1" cellpadding="0" width="100%" class="tb_list">
            <tr class="header">
                <td height="25" style="padding-left:10px;"><font
        ...
        <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#333333">
            <tr>
                <td align="left" style="padding-left:20px;"><input type="button" value="<?= $lang["back"] ?>"
                                                                   onClick="parent.location.href = '<?= base_url() . "marketing/upselling/group_list/" ?>';"
                                                                   class="button"></td>
