...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
    <col width="20"><col width="60"><col><col width="60"><col width="80"><col width="40"><col width="50"><col width="95"><col width="80"><col width="80"><col width="75"><col width="60"><col width="70"><col width="50"><col width="50"><col width="27">
    <tr class="header">
        <td height="20">
        ...
        <td title="<?=$lang["asin"]?>"><a href="#" onClick="SortCol(document.fm, 'asin', '<?=$xsort["asin"]?>')"><?=$lang["asin"]?> <?=$sortimg["asin"]?></a></td>
        <td title="<?=$lang["clearance"]?>"><a href="#" onClick="SortCol(document.fm, 'clearance', '<?=$xsort["clearance"]?>')"><?=$lang["clear"]?> <?=$sortimg["clearance"]?></a></td>
        <td width="80" title="<?=$lang["listing_status"]?>"><a href="#" onClick="SortCol(document.fm, 'listing_status', '<?=$xsort["listing_status"]?>')"><?=$lang["listing_status"]?> <?=$sortimg["listing_status"]?></a></td>
        <td title="<?=$lang["inventory_qty"]?>"><a href="#" onClick="SortCol(document.fm, 'inventory', '<?=$xsort["inventory"]?>')"><?=$lang["qty"]?> <?=$sortimg["inventory"]?></a></td>
        ...
        <td title="<?=$lang["shiptype"]?>"><a href="#" onClick="SortCol(document.fm, 'shiptype_name', '<?=$xsort["shiptype_name"]?>')"><?=$lang["shiptype"]?> <?=$sortimg["shiptype_name"]?></a></td>
        <td title="<?=$lang["fulfillment_centre_id"]?>"><a href="#" onClick="SortCol(document.fm, 'fulfillment_centre_id', '<?=$xsort["fulfillment_centre_id"]?>')"><?=$lang["fulfillment_centre_id"]?> <?=$sortimg["fulfillment_centre_id"]?></a></td>
        ...
        <td title="<?=$lang["amazon_reprice_name"]?>"><a href="#" onClick="SortCol(document.fm, 'amazon_reprice_name', '<?=$xsort["amazon_reprice_name"]?>')"><?=$lang["amazon_reprice_name"]?> <?=$sortimg["amazon_reprice_name"]?></a></td>
        ...
        <td>
            ...
            <?php
                if($rp_array[$this->input->get("platform_id")])
                {
                    ...
                    {
            ?>
                <option value="<?=$rsvalue->get_id()?>" <?=$selected_rp[$rsvalue->get_id()]?>><?=$rsvalue->get_id()?>
            <?php
                    }
                }
            ?>
