    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0">
        <tr>
            ...
            <td align="right" class="title" height="30">
                <input type="button" value="<?= $lang["map_by_sku_button"] ?>" class="button"
                       onclick="Redirect('<?= base_url() ?>marketing/complementary_acc/')">
                <input type="button" value="<?= $lang["map_by_cat_button"] ?>" class="button"
                       onclick="Redirect('<?= base_url() ?>marketing/complementary_acc/map_cat')">
            </td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
        <tr>
            <td height="70" style="padding-left:8px;">
                ...
                <b style="font-size: 12px; color: rgb(0, 0, 0);"><?= $lang["header"] ?></b><br><?= $lang["header_message_mapcat"] ?>
                <b></b>
            </td>
        </tr>
    </table>
    <form name="fm_mapcat" id="fm_mapcat" action="<?= base_url() ?>marketing/complementary_acc/map_cat/<?= $country ?>"
                ...
                <tr>
                    ...
                    <td class="value" colspan="3">
                        <input type="text" size="90" name="new_acc_sku[<?= $country ?>]"
                               ...
                               onkeyup="showData('txtHint[<?= $country ?>]', this.value, '<?= $country ?>')" notEmpty>
