                    ...
                    <tr id="caprod_row_<?= $country ?>" style="display:none;">
                        ...
                        <td align="left">
                            ...
                            if (!empty($calist)) {
                                ?>
                                <form name="update"
                                      action="<?= base_url() ?>marketing/complementary_acc/view/<?= $sku ?>"
                                      method="POST" onSubmit="return CheckForm(this)">
                                    <table border="0" cellpadding="0" cellspacing="0" width="1042px" class="tb_main"
                                           name="mapped_ca" id="mapped_ca">
                                        <tr class="header">
                                            <td width="5%"></td>
...
HTML;
                                                    ...
                                                    echo $castatus_radio;
                                                    ?>
                                                    <input type="hidden" name="info[<?= $casku ?>][ctry_id]"
                                                           value=<?= $country ?>>
                                                </td>
                                            </tr>
                                        <?php
                            ...
                            ?>
                            <form name="add_new" action="<?= base_url() ?>marketing/complementary_acc/view/<?= $sku ?>"
                                  method="POST" onSubmit="return CheckForm(this)">
                                <table border="0" cellpadding="0" cellspacing="0" width="1042px" class="tb_main"
                                       name="new_ca_<?= $country ?>" id="new_ca_<?= $country ?>">
                                    <col width="5%">
                                    <col width="15%">
                                    <col width="30%">
                                    <col width="20%">
                                    ...
                                    <tr class="header">
                                        <td></td>
                                        <td colspan="5"><b>MAP NEW ACCESSORY</b> - Search by accessory SKU/name below
                                            and choose from dropdown list.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="value">&nbsp;</td>
                                        <td class="value" colspan="3">
                                            <input type="text" size="90" name="new_acc_sku[<?= $country ?>]"
                                                   id="new_acc_sku[<?= $country ?>]"
                                                   onkeyup="showData('txtHint[<?= $country ?>]', this.value, '<?= $country ?>')"
                                                   notEmpty>

                                            <div id="txtHint[<?= $country ?>]" name="txtHint[<?= $country ?>]"
                                                 style="display:none;background-color:#0F192A;overflow-y:scroll;max-height:300px;width:560px;"></div>
                                            <input type="hidden" name="posted" id="posted" value="1">
            ...
            <tr class="header">
                <td height="20" align="left" style="padding-left:8px;"><b
                        style="font-size: 12px; color: rgb(255, 255, 255);">BULK MAPPING / UPDATE
                    </b>
                </td>
            </tr>
            <?php
            if ($ca_country_list) {
                ...
                <tr>
                    <td align="left">
                        <form name="bulk_update" id="bulk_update"
                              action="<?= base_url() ?>marketing/complementary_acc/view/<?= $sku ?>" method="POST"
                              onSubmit="return CheckForm(this)">
                            <table border="0" cellpadding="0" cellspacing="0" width="1042px" class="tb_main"
                                   name="bulk_mapped_ca" id="bulk_mapped_ca">
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="field">
                                            <input type="hidden" name="ca_sku[<?= $ca_sku ?>]" id="ca_sku"
                                                   value="<?= $ca_sku ?>">
                                            <input type="hidden" name="country_list[<?= $ca_sku ?>]"
                                                   id="country_list[<?= $ca_sku ?>]" value="<?= $country_list ?>">
            ...
            <tr>
                <td>
                    <form name="bulk_new" action="<?= base_url() ?>marketing/complementary_acc/view/<?= $sku ?>"
                          method="POST" onSubmit="return CheckForm(this)">
                        <table border="0" cellpadding="0" cellspacing="0" width="1042px" class="tb_main"
                               name="new_ca_bulk" id="new_ca_bulk">
                            <col width="5%">
                            <col width="15%">
                            <col width="30%">
                            <col width="20%">
                            ...
                            <tr class="header">
                                <td></td>
                                <td colspan="5"><b>BULK MAP NEW ACCESSORY</b> - Search by accessory SKU/name below and
                            ...
                            <tr>
                                <td class="value">&nbsp;</td>
                                <td class="value" colspan="3">
                                    <input type="text" size="90" name="new_acc_sku[bulk]" id="new_acc_sku[bulk]"
                                           onkeyup="showData('txtHint[bulk]', this.value, 'bulk')" notEmpty>

                                    <div id="txtHint[bulk]" name="txtHint[bulk]"
                                         style="display:none;background-color:#0F192A;overflow-y:scroll;max-height:300px;width:560px;"></div>
                                    <input type="hidden" name="posted" id="posted" value="1">
