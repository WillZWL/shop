...
<form name="fm" action="<?=base_url()."marketing/complementary_acc"?>" method="get">
...
<iframe name="plist" id="plist" src="<?=base_url()?>marketing/complementary_acc/plist/?<?=$_SERVER['QUERY_STRING']?>" width="200" style="float:left;border-right:1px solid #000000;" noresize frameborder="0" marginwidth="0" marginheight="0" hspace=0 vspace=0 onLoad="SetFrameFullHeight(this)"></iframe>
...
<script>
	...
	top.frames["pview"].location.href='<?=base_url()?>marketing/complementary_acc/view/' + hash;
</script>
</body>
</html>