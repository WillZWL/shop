...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        ...
        <td width="400" align="right" class="title"><input type="button" value="<?=$lang["list_button"]?>" class="button" onClick="Redirect('<?=site_url('marketing/product_overview_amfr/')?>')"></td>
    </tr>
    <tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
    <col width="20"><col width="60"><col><col width="85"><col width="45"><col width="45"><col width="40"><col width="85"><col width="90"><col width="80"><col width="70"><col width="55"><col width="55"><col width="60"><col width="50"><col width="50"><col width="27">
    <tr class="header">
        <td height="20">
