...
<div id="main">
                ...
                <td align="right">
                    <table border="0" cellpadding="0" cellspacing="0" style="text-align:right">
                        ...
                        <tr>
                            ...
                            <td>
                                <select style="width:145px"
                                        onChange="Redirect('<?= base_url() ?>marketing/competitor_map/index/'+this.value)">
                                    <option></option>
                                    <?php
                        ...
                        <tr style="<?= $country_id ? "" : "display:none"; ?>;">
                            ...
                            <td><input name="country_id" type="hidden" class="input"
                                       value='<?= htmlspecialchars($country_id) ?>'></td>

                            <td align="center"><input type="submit" value="" class="search_button"
    ...
    <iframe name="plist" id="plist"
            src="<?= base_url() ?>marketing/competitor_map/plist/?<?= $_SERVER['QUERY_STRING'] ?>" width="200"
