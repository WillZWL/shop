    ...
    if ($sku != "") {
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr class="header">
                <td height="20" align="left" style="padding-left:8px;"><b
                        style="font-size:price_obj 12px; color: rgb(255, 255, 255);"><?= $lang["competitor_info"] ?></b>
                </td>
            </tr>
            <tr>
                <td width="100%">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="tb_main"
                        ...
                        <tr>
                            ...
                            <td class="field" align="centre" style="text-align:center">
                                <b><?= $lang["status"] ?></b><br/></td>
                            <td class="field" align="centre" style="text-align:center"><b><?= $lang["match"] ?></b><br/>
                            </td>
                            <td class="field" align="centre" style="text-align:center">
                                <b><?= $lang["reprice_min_margin"] ?></b><br/></td>
                            <td class="field" align="centre" style="text-align:center">
                                <b><?= $lang["reprice_value"] ?></b><br/></td>
                        </tr>
                        <?php
                        if ($active_compmap_list && $total_price_arr) {
                            ...
                            foreach ($total_price_arr as $key => $price) {
                                ...
                                if ($islowestmatch == TRUE && $match == 1) {
                                    ...
                                    ?>
                                    <tr>
                                        <td bgcolor="greenyellow" style="cursor:pointer;"><img
                                                src="<?= base_url() ?>images/info.gif"
                                                title='<?= $lang["create_on"] ?>:<?= $competitor_obj["create_on"] ?>&#13;<?= $lang["create_at"] ?>:<?= $competitor_obj["create_at"] ?>&#13;<?= $lang["create_by"] ?>:<?= $competitor_obj["create_by"] ?>&#13;<?= $lang["modify_on"] ?>:<?= $competitor_obj["modify_on"] ?>&#13;<?= $lang["modify_at"] ?>:<?= $competitor_obj["modify_at"] ?>&#13;<?= $lang["modify_by"] ?>:<?= $competitor_obj["modify_by"] ?>'>
                                        </td>
                                        <td bgcolor="greenyellow" id="comp[<?= $i ?>][name]">
                                            <b><?= htmlspecialchars($competitor_name) ?></b></td>
                                        <td bgcolor="greenyellow"><input type="text" class="input"
                                                                         name="comp[<?= $i ?>][price]"
                                                                         value="<?= $price ?>"></td>
                                        <td bgcolor="greenyellow"><input type="text" class="input"
                                                                         name="comp[<?= $i ?>][comp_ship_charge]"
                                                                         value="<?= htmlspecialchars($comp_ship_charge) ?>">
                                        </td>
                                        <td bgcolor="greenyellow"><input type="url" class="input"
                                                                         name="comp[<?= $i ?>][url]"
                                                                         value="<?= $product_url ?>"></td>
                                        <td bgcolor="greenyellow"><input type="text" class="input"
                                                                         name="comp[<?= $i ?>][note_1]"
                                                                         value="<?= htmlspecialchars($note_1) ?>"></td>
                                        <td bgcolor="greenyellow"><input type="text" class="input"
                                                                         name="comp[<?= $i ?>][note_2]"
                                                                         value="<?= htmlspecialchars($note_2) ?>"></td>
                                        <td bgcolor="greenyellow"
                                            align="center"><?= htmlspecialchars($stock_status_name) ?></td>
                                        <td bgcolor="greenyellow" <?= $status ? "" : "style=\"background-color:darkgray\"" ?>
                                            align="center">
                                            <select name="comp[<?= $i ?>][status]">
                                                ...
                                                foreach ($ar_status as $key => $value) {
                                                    ?>
                                                    <option
                                                        value="<?= $key ?>" <?= $status == $key ? "SELECTED" : "" ?>><?= $value ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                        </td>
                                        <td bgcolor="greenyellow" <?= $match ? "" : "style=\"background-color:darkgray\"" ?>
                                            align="center">
                                            <select name="comp[<?= $i ?>][match]">
                                                ...
                                                foreach ($ar_match as $key => $value) {
                                                    ?>
                                                    <option
                                                        value="<?= $key ?>" <?= $match == $key ? "SELECTED" : "" ?>><?= $value ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>

                                            <input type="hidden" name="comp[<?= $i ?>][competitor_id]"
                                                   value="<?= $competitor_id ?>">
                                        </td>
                                        <td bgcolor="greenyellow"><input isNumber type="text" class="input"
                                                                         name="comp[<?= $i ?>][reprice_min_margin]"
                                                                         id="comp[<?= $i ?>][reprice_min_margin]"
                                                                         value="<?= htmlspecialchars($reprice_min_margin) ?>">
                                        </td>
                                        <td bgcolor="greenyellow"><input isNumber type="text" class="input"
                                                                         name="comp[<?= $i ?>][reprice_value]"
                                                                         id="comp[<?= $i ?>][reprice_value]"
                                                                         value="<?= htmlspecialchars($reprice_value) ?>">
                                        </td>
                                    </tr>
                                    <?php
                                    $i++;
                                    ...
                                    ?>
                                    <tr>
                                        <td class="row1" style="cursor:pointer;"><img
                                                src="<?= base_url() ?>images/info.gif"
                                                title='<?= $lang["create_on"] ?>:<?= $competitor_obj["create_on"] ?>&#13;<?= $lang["create_at"] ?>:<?= $competitor_obj["create_at"] ?>&#13;<?= $lang["create_by"] ?>:<?= $competitor_obj["create_by"] ?>&#13;<?= $lang["modify_on"] ?>:<?= $competitor_obj["modify_on"] ?>&#13;<?= $lang["modify_at"] ?>:<?= $competitor_obj["modify_at"] ?>&#13;<?= $lang["modify_by"] ?>:<?= $competitor_obj["modify_by"] ?>'>
                                        </td>
                                        <td class="row1"
                                            id="comp[<?= $i ?>][name]"><?= htmlspecialchars($competitor_name) ?></td>
                                        <td class="row1"><input type="text" class="input" name="comp[<?= $i ?>][price]"
                                                                value="<?= $price ?>"></td>
                                        <td class="row1"><input type="text" class="input"
                                                                name="comp[<?= $i ?>][comp_ship_charge]"
                                                                value="<?= htmlspecialchars($comp_ship_charge) ?>"></td>
                                        <td class="row1"><input type="url" class="input" name="comp[<?= $i ?>][url]"
                                                                value="<?= $product_url ?>"></td>
                                        <td class="row1"><input type="text" class="input" name="comp[<?= $i ?>][note_1]"
                                                                value="<?= htmlspecialchars($note_1) ?>"></td>
                                        <td class="row1"><input type="text" class="input" name="comp[<?= $i ?>][note_2]"
                                                                value="<?= htmlspecialchars($note_2) ?>"></td>
                                        <td class="row1" align="center"><?= htmlspecialchars($stock_status_name) ?></td>
                                        <td class="row1" <?= $status ? "" : "style=\"background-color:darkgray\"" ?>
                                            align="center">
                                            <select name="comp[<?= $i ?>][status]">
                                                <?php
                                                foreach ($ar_status as $key => $value) {
                                        ...
                                        <td class="row1" <?= $match ? "" : "style=\"background-color:darkgray\"" ?>
                                            align="center">
                                            <select name="comp[<?= $i ?>][match]">
                                                <?php
                                                foreach ($ar_match as $key => $value) {
                                        ...
                                        <td class="row1"><input isNumber min="0" type="text" class="input"
                                                                name="comp[<?= $i ?>][reprice_min_margin]"
                                                                id="comp[<?= $i ?>][reprice_min_margin]"
                                                                value="<?= htmlspecialchars($reprice_min_margin) ?>">
                                        </td>
                                        <td class="row1"><input isNumber type="text" class="input"
                                                                name="comp[<?= $i ?>][reprice_value]"
                                                                id="comp[<?= $i ?>][reprice_value]"
                                                                value="<?= htmlspecialchars($reprice_value) ?>"></td>
                                    </tr>
                                    <?php
                                    $i++;
                                }
                        ...
                        if ($inactive_compmap_list) {
                            ...
                            foreach ($inactive_compmap_list as $competitor_obj) {
                                ...
                                ?>
                                <tr>
                                    <td bgcolor="lightgray" style="cursor:pointer;"><img
                                            src="<?= base_url() ?>images/info.gif"
                                            title='<?= $lang["create_on"] ?>:<?= $competitor_obj["create_on"] ?>&#13;<?= $lang["create_at"] ?>:<?= $competitor_obj["create_at"] ?>&#13;<?= $lang["create_by"] ?>:<?= $competitor_obj["create_by"] ?>&#13;<?= $lang["modify_on"] ?>:<?= $competitor_obj["modify_on"] ?>&#13;<?= $lang["modify_at"] ?>:<?= $competitor_obj["modify_at"] ?>&#13;<?= $lang["modify_by"] ?>:<?= $competitor_obj["modify_by"] ?>'>
                                    </td>
                                    <td bgcolor="lightgray" id="comp[<?= $i ?>][name]"><font
                                            color="gray"><?= htmlspecialchars($competitor_name) ?></font></td>
                                    <td bgcolor="lightgray"><input type="text" class="input"
                                                                   name="comp[<?= $i ?>][price]" value="<?= $price ?>">
                                    </td>
                                    <td bgcolor="lightgray"><input type="text" class="input"
                                                                   name="comp[<?= $i ?>][comp_ship_charge]"
                                                                   value="<?= htmlspecialchars($comp_ship_charge) ?>">
                                    </td>
                                    <td bgcolor="lightgray"><input type="url" class="input" name="comp[<?= $i ?>][url]"
                                                                   value="<?= $product_url ?>"></td>
                                    <td bgcolor="lightgray"><input type="text" class="input"
                                                                   name="comp[<?= $i ?>][note_1]"
                                                                   value="<?= htmlspecialchars($note_1) ?>"></td>
                                    <td bgcolor="lightgray"><input type="text" class="input"
                                                                   name="comp[<?= $i ?>][note_2]"
                                                                   value="<?= htmlspecialchars($note_2) ?>"></td>
                                    <td bgcolor="lightgray" align="center"><font
                                            color="darkslategray"><?= htmlspecialchars($stock_status_name) ?></font>
                                    </td>
                                    ...
                                    <td bgcolor="lightgray"><input isNumber min="0" type="text" class="input"
                                                                   name="comp[<?= $i ?>][reprice_min_margin]"
                                                                   id="comp[<?= $i ?>][reprice_min_margin]"
                                                                   value="<?= htmlspecialchars($reprice_min_margin) ?>">
                                    </td>
                                    <td bgcolor="lightgray"><input isNumber type="text" class="input"
                                                                   name="comp[<?= $i ?>][reprice_value]"
                                                                   id="comp[<?= $i ?>][reprice_value]"
                                                                   value="<?= htmlspecialchars($reprice_value) ?>"></td>
                                </tr>
            ...
            <tr class="header">
                <td id="addcompbutton" height="20" align="left" style="padding-left:8px;"><b
                        style="font-size:price_obj 12px; color: rgb(255, 255, 255);"><?= $lang["map_competitor_info"] ?></b>&nbsp;&nbsp;&nbsp;&nbsp;<input
                        type="button" id="addnewcomp_button" value="Show more" onClick="addnewcomp()"></td>
            </tr>
            <tr>
                <td width="100%">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="tb_main" id="addcompetitor"
                           style="display:none;">
                        <col width="3%">
                        <col width="12%">
                        <col width="6%">
                        ...
                        <tr>
                            ...
                            <td class="add_row">
                                <select name="add[<?= $k ?>][name]" id="add[<?= $k ?>][name]">
                                    ...
                                    foreach ($unmapped_competitor_list as $unmapped_competitor_name) {
                                        ?>
                                        <option
                                            value="<?= htmlspecialchars($unmapped_competitor_name) ?>"><?= htmlspecialchars($unmapped_competitor_name) ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <td class="add_row"><input type="text" class="input"
                                                       name="add[<?= $k ?>][comp_ship_charge]"></td>
                            ...
                            <td class="add_row"><input type="text" class="input"
                                                       name="add[<?= $k ?>][reprice_min_margin]"
                                                       id="add[<?= $k ?>][reprice_min_margin]"></td>
                            <td class="add_row"><input type="text" class="input" name="add[<?= $k ?>][reprice_value]"
                                                       id="add[<?= $k ?>][reprice_value]"></td>
                            <?php
                            }
                            ?>
        ...
        if ($canedit) {
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_detail">
                <tr>
                    <td align="right" style="padding-right:50px;" height="30"><input type="button" value="Update"
                                                                                     class="button"
                                                                                     onClick="if(CheckForm(this.form) && CheckVal(this.form)) this.form.submit();">
                    </td>
                </tr>
            </table>
        ...
        if ($inactive_mapped_list) {
            ...
            <tr class="header">
                <td height="20" align="left" style="background-color:darkslategray;padding-left:8px;"><b
                        style="font-size:price_obj 12px; color: lightgray;"><?= $lang["disabled_competitor_info"] ?></b>
                </td>
            </tr>
            <tr class="xrow0">
            ...
            <col width="70%">
            <tr>
                <td style="background-color:darkgray;"><font
                        color="darkslategray"><b><?= $lang["competitor_name"] ?></b></font></td>
                <td style="background-color:darkgray;"><font color="darkslategray"><b><?= $lang["price"] ?></b></font>
                </td>
            ...
            foreach ($inactive_mapped_list as $inactive_competitor) {
                ?>
                <tr>
                    <td style="background-color:lightgray;"><font
                            color="darkslategray"><?= htmlspecialchars($inactive_competitor["name"]) ?></font></td>
                    <td style="background-color:lightgray;"><font
                            color="darkslategray"><?= htmlspecialchars($inactive_competitor["price"]) ?></font></td>
                    <td style="background-color:lightgray;"><font
                            color="darkslategray"><?= htmlspecialchars($inactive_competitor["url"]) ?></font></td>
                </tr>
            <?php
