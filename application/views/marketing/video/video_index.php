...
<tr>
	<td width="15%" class="value" align="right" style="padding-right:8px;"><?=$lang["select_language"]?></td>
	<td width="15%" class="value" >
		<select id="language" onChange='SaveChange(this);gotoPage("<?=base_url()."marketing/video/main/"?>",this.value)' >
	...
	<td width="15%" class="value" align="right" style="padding-right:8px;" size='5'><?=$lang["select_country"]?></td>
	<td width="15%" class="value">
		<select onChange='SaveChange(this);gotoPage("<?=base_url()."marketing/video/main/ALL/"?>",this.value)' >
			<option value="" style="padding-right:50px;"> -- Please Select -- </option>
		<?php
...
{
?>
<iframe src="<?=base_url()?>marketing/video/view_left/<?=$lang_id?>/<?=$country_id?>" noresize frameborder="0" name="left" id="left" marginwidth="0" marginheight="0" hspace="0" vspace="0" width="200" height="380" style="float:left; border-right:1px solid #000000;" onLoad="SetFrameFullHeight(this)"></iframe>
<iframe src="" noresize frameborder="0" name="right" id="right" marginwidth="0" marginheight="0" hspace="0" vspace="0" width="1059" height="380" style="float:left; " onLoad="SetFrameFullHeight(this)"></iframe>
<?php
}
?>
</script>
