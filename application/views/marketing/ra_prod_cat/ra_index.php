...
<table border="0" cellpadding="0" cellspacing="0" height="70" bgcolor="#BBBBFF" width="100%">
    <tr>
        <td height="70" style="padding-left:8px"><b style="font-size:14px"><?=$lang["header"]?></b><br><?=$lang["subheader"]?><select onChange='gotoPage("<?=base_url()."marketing/ra_prod_cat/view/?sscat="?>",this.value)'><option value="">-- <?=$lang["please_select"]?> --</option><?php
