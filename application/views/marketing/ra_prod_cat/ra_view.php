...
<tr>
	...
	<td height="20" align="left" class="value">&nbsp;&nbsp;<select name="sscat<?=$i?>" style="width:200px;"><option value="" SELECTED>-- <?=$lang["not_defined"]?> --</option><?php
...
?>
<tr>
	<td width="172" height="20" class="field" align="right" style="padding-right:8px;"><?=$lang["warr_cat"]?></td>
	<td height="20" align="left" class="value">&nbsp;&nbsp;<select name="warranty_cat" style="width:200px;"><option value="" SELECTED>-- <?=$lang["not_defined"]?> --</option><?php
	foreach($warr_cat_list as $warr_obj)
	{
		?><option value="<?=$warr_obj->get_id()?>" <?=($warr_obj->get_id() == $ra_obj->get_warranty_cat()?"SELECTED":"")?>><?=$warr_obj->get_name()?></option><?php
	}
	?></select></td>
...
<tr>
	...
	<td height="20" align="left" class="value">&nbsp;&nbsp<select name="status" style="width:100px;"><option value="0" <?=($ra_obj->get_status() == 0?"SELECTED":"")?>><?=$lang["status0"]?></option><option value="1" <?=($ra_obj->get_status() == 1?"SELECTED":"")?>><?=$lang["status1"]?></option></select></td>
</tr>
</table>
