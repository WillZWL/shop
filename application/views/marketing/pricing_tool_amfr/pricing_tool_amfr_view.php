...
<tr>
	<td align="right" style="padding-right:8px;" height="30"><input type="submit" value="Update Pricing Tool" class="button" onClick="if(Checkform(this.form)) this.form.submit();"></td>
</tr>
</table>
