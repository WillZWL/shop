...
<div id="main">
    ...
    <iframe name="plist" id="plist" src="<?= base_url() ?>marketing/pricing_tool_amfr/plist/?" width="200"
    ...
    <iframe name="pview" id="pview" src="<?= base_url() ?>marketing/pricing_tool_amfr/view/" width="1059"
