...
<div id="main" style="width:auto;">
    ...
    ?>
    <div style="padding-top:20px; padding-bottom:20px;"><b style="font-size:16px;"><?= $lang["update_image"] ?> #<span
                id="typeval" style="font-size:16px; "><?= $type ?></span></b></div>
    <form action="<?= $_SERVER["PHP_SELF"] ?>" method="POST" onSubmit="return CheckForm(this)"
        ...
        <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#dddddd">
            <tr>
                ...
                <td width="85%" class="value">&nbsp;&nbsp;<input type="file" name="image" class="input"><br><i></i></td>
            </tr>
            <tr>
                <td width="15%" class="field" align="right" style="padding-right:8px;"><?= $lang["banner_flash"] ?></td>
                <td width="85%" class="value">&nbsp;&nbsp;<input type="file" name="flash"
            ...
            <tr>
                ...
                <td width="85%" class="value">&nbsp;&nbsp;<input type="text" name="link" class="input"></td>
            </tr>
            <tr>
                <td width="15%" class="field" align="right" style="padding-right:8px;"><?= $lang["status"] ?></td>
                <td width="85%" class="value">&nbsp;&nbsp;<select name="status">
