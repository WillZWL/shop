...
<div id="main" style="width:auto;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="page_header">
        <tr>
            <td width="100%" height="40" style="padding-left:8px;"><b
                    style="font-size:14px"><?= $lang["banner_setup"] . " - " . $catobj->get_name() ?></b></td>
        </tr>
    </table>
    <?php
    ...
    <form name="fm" action="<?= $_SERVER["PHP_SELF"] ?>" method="POST" onSubmit="return CheckForm(this)"
          enctype="multipart/form-data">
        <table width="100%" cellpadding="0" cellspacing="1" class="tb_list">
            <tr>
                <td width="15%" class="field" align="right" height="20"
                    style="padding-right:8px;"><?= $lang["banner_number"] ?></td>
                <td width="85%" class="value">&nbsp;&nbsp;<span id="typeval"><?= $type ?></span></td>
            </tr>
            <tr>
                <td width="15%" class="field" align="right" style="padding-right:8px;"><?= $lang["banner_image"] ?></td>
                <td width="85%" class="value">&nbsp;&nbsp;<input type="file" name="image"
                                                                 class="input"><br>&nbsp;&nbsp;<?= $lang["image_limit"] . "  " . $this->config->item("banner_height_" . $template_type . "_" . $type) . "(H) x" . $this->config->item("banner_width_" . $template_type . "_" . $type) . "(W)" ?>
                </td>
            </tr>
            <tr>
                <td width="15%" class="field" align="right" style="padding-right:8px;"><?= $lang["banner_flash"] ?></td>
                <td width="85%" class="value">&nbsp;&nbsp;<input type="file" name="flash" class="input"><br>&nbsp;&nbsp;<input
                        type="checkbox" name="removeflash" value="1">&nbsp;&nbsp;<?= $lang["remove"] ?>
            ...
            <tr>
                ...
                <td width="85%" class="value">&nbsp;&nbsp;<select name="link_type">
            ...
            <tr>
                ...
                <td width=8"5%" class="value">&nbsp;&nbsp;<select name="status">
                        <option value="A"><?= $lang["active"] ?></option>
                        <option value="I"><?= $lang["inactive"] ?></option>
                    </select></td>
            </tr>
            <tr>
                <td width="15%" class="field" align="right" style="padding-right:8px;"><?= $lang["publish"] ?></td>
                <td width="85%" class="value">&nbsp;&nbsp;<input type="checkbox" name="publish" value="1"></td>
            </tr>
            <tr>
                <td width="15%" class="field">&nbsp;</td>
                <td width="85%" class="value">&nbsp;&nbsp;<input type="button" value="<?= $lang["update_banner"] ?>"
