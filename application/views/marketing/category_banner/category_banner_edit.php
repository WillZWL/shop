...
<tr>
	...
	<td width="15%" class="field" align="right" style="padding-right:8px;">Please Select Sub Category</td>
...
?>
<tr>
	<td width="15%" class="field" align="right" style="padding-right:8px;" rowspan='2'><b>Category Banner</b><br>Dimension: 90px(W) X 87px(H)<br> Format: jpg, jpeg, gif, png<br></td>
	<td width="20%" class="value" rowspan='2'>
		<input type="file" name="image">
	</td>
	<td class="field special" align="center">
	<?if($updated_country){?>Updated Language: <?=$updated_language->get_name();}?><br>
	<?if($updated_country){?>Updated Countries:<br> <?foreach($updated_country AS $obj){echo $obj->get_name();$i++;if($i % 5 == 0){?><br><?}}}?></td>
</tr>
<tr>
...
<tr>
	<td align="right" style="padding-right:8px">&nbsp;&nbsp;<input type="button" value="<?=$lang["update_banner"]?>" onClick="if(CheckForm(this.form)) this.form.submit()"></td>
</tr>
</table>
<?php
}
