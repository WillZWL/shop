		...
		<tr>
			<td class="field"><?=$cat_obj->get_name()?></td>
				<?php
					...
					{
				?>
			<td class="value"><input min="0" name="factor[<?=$cat_id?>][<?=$class_id?>]" class="int_input" value="<?=isset($factor_list[$cat_id][$class_id]) ? htmlspecialchars($factor_list[$cat_id][$class_id]->get_factor()) : ""?>"></td>
				<?php
					}
				?>
			<td class="value"><input min="0" name="category[<?=$cat_id?>]" class="int_input" value="<?=$cat_obj->get_min_display_qty()?>"></td>
		</tr>
		<?php
				}
			}
		...
		<tr>
			<td class="bfield1"><?=$lang["default"]?></td>
				<?php
					...
					{
				?>
			<td class="bvalue1"><input min="0" name="class[<?=$class_id?>][default_factor]" class="int_input" value="<?=$class_obj->get_default_factor()?>"></td>
				<?php
					}
				?>
			<td class="bvalue1"><input min="0" name="default_min_display_qty" class="int_input" value="<?=isset($default_min_display_qty) ? $default_min_display_qty->get_value() : ""?>"></td>
		</tr>
		<tr>
			<td class="bfield0"><?=$lang["drop_qty_by"]?></td>
				<?php
					...
					{
				?>
			<td class="bvalue0"><input min="0" name="class[<?=$class_id?>][drop_qty]" class="int_input" value="<?=$class_obj->get_drop_qty()?>"></td>
				<?php
					}
				?>
			<td class="bvalue0"></td>
