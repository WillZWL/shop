...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_main">
    <tr>
        ...
        <td class="value"><input name="name" class="input read" value="<?=htmlspecialchars($product->get_name())?>" notEmpty READONLY></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="value"><input name="discount" class="int_input" value="<?=htmlspecialchars($product->get_discount())?>" min="0" isNumber> %</td>
    </tr>
</table>
