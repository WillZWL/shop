...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        ...
        <td width="400" align="right" class="title"><input type="button" value="<?=$lang["list_button"]?>" class="button" onclick="Redirect('<?=site_url('marketing/bundle/')?>')"></td>
    </tr>
    <tr>
...
<table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
    <tr>
        <td height="70" style="padding-left:8px">
            <div style="float:left"><img src='<?=get_image_file($product->get_image(), 's', $product->get_sku())?>?<?=$product->get_modify_on()?>'> &nbsp;</div>
                <?=$lang["header"]?><br><b style="font-size:14px; color:#000000;"><?=$product->get_name()?></b><br><?=$lang["sku"]?>: <?=$product->get_sku()?>
        </td>
    </tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_main">
    <col width="200"><col width="430"><col width="200"><col>
    <tr class="header">
    ...
    <tr>
        ...
        <td class="value"><input name="discount" class="int_input" min="0" value="<?=htmlspecialchars($product->get_discount())?>"> %</td>
    </tr>
<!--
    <tr>
...
-->
    ...
    <tr>
        ...
        <td class="value">
            ...
            <div id="image_file_h" style="position:absolute;left:-100000px;top:-100000px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod='image');height:1px;width:1px;">
        </td>
        <td class="field">&nbsp;</td>
        <td class="value">&nbsp;</td>
<!--
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
    <col width="60"><col><col width="50"><col width="50"><col width="50"><col width="50"><col width="50"><col width="50"><col width="50"><col width="50"><col width="50"><col width="50"><col width="50"><col width="50"><col width="50"><col width="50">
<?=$components?>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_detail">
    <tr>
        <td colspan="2" height="40"><input type="button" name="back" value="<?=$lang['back_list']?>" onClick="Redirect('<?=isset($_SESSION['LISTPAGE'])?$_SESSION['LISTPAGE']:base_url().'/marketing/bundle'?>')"></td>
        <td colspan="2" align="right" style="padding-right:8px;">
            <input type="submit" value="<?=$lang['cmd_button']?>"<?if ($cmd=="edit") {?>onClick="if (top.frames['ra_prod'].document.forms[0]) top.frames['ra_prod'].document.forms[0].submit();"<?}?>>
        </td>
    </tr>
</table>
