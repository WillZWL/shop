...
<div id="main" style="width:auto;">
    ...
    <form name="fm" action="/marketing/display_banner/edit_home" method="POST" onSubmit="return CheckForm(this)"
        ...
        <table width="100%" cellpadding="0" cellspacing="1" class="tb_list">
            ...
            <tr>
                ...
                <td width="20%" class="value">&nbsp;&nbsp;
                    <select
                        onChange='SaveChange(this);gotoPage("<?= base_url() . "marketing/display_banner/view_home/" ?>",this.value)'>
                ...
                <td width="20%" class="field" align="right" style="padding-right:8px;" size='5'>Please Select Country
                </td>
                <td width="20%" class="value">&nbsp;&nbsp;
            ...
            if ($language_id) {
                ...
                <tr>
                    <td colspan="7" class="field" align="left" style="padding-right:8px;"><b>Display Banner</b><br>Dimension:
                        1000px(W) X 240px(H)<br> Format: jpg, jpeg, gif, png, swf<br></td>
                </tr>
                <?php
...
-->
                <tr>
                    <td width="15%" class="field" align="right" style="padding-right:8px;" rowspan="2">Main Image
                        (noFlash)
                    </td>
                    ...
                    <td width="51%" class="field" align="left" style="padding-right:8px;" colspan="3">&nbsp;&nbsp;<b>Link</b>
                    </td>
                </tr>
                <tr>
                    <td width="35%" class="value" align="left" style="padding-right:8px;">
                        <input type="text" name="link[0][1]" id="link[0][1]" class="input" id="link"
                               value="<?php echo $link;?>" onchange="has_change()">
                    </td>
                    <td width="8%" class="value">&nbsp;&nbsp;
                        <select name="link_type[0][1]" onchange="has_change()">
                            <option
                                value="I"<?php echo(($link_type == 'I') ? ' selected' : '');?>><?= $lang["internal"] ?></option>
                            <option
                                value="E"<?php echo(($link_type == 'E') ? ' selected' : '');?>><?= $lang["external"] ?></option>
                        </select>
                    </td>
                    <td width="8%" class="value">
                        <select name="status[0][1]" id="status[0][1]" onchange="changeValue(0, 1)">
                            <option
                                value="1"<?php echo(($status == 1) ? ' selected' : '');?>><?= $lang["active"] ?></option>
                            <option
                                value="0"<?php echo(($status == 0) ? ' selected' : '');?>><?= $lang["inactive"] ?></option>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3" class="field" align="left" style="padding-right:8px;"><b>Display Scrolling
                            Banner</b><br>Dimension: 1000px(W) X 240px(H)<br> Format: jpg, jpeg, gif, png, swf
                    </td>
                    <td class="field" align="left" style="padding-right:8px;">&nbsp;&nbsp;<b>Time Interval<br>&nbsp;(sec)</b>&nbsp;&nbsp;
                    </td>
                    <td colspan="3" class="field" align="left" style="padding-right:8px;" ?
                    <b>&nbsp;&nbsp;Link&nbsp;&nbsp;</b></td>
                </tr>
                <?php
                for ($imge = 1; $imge <= 6; $imge++) {
                    ...
                    <tr>
                        ...
                        <td width="5%" class="value">
                            <input type="text" name="time_interval[1][<?= $imge; ?>]" class="input"
                                   value="<?php echo $time_interval;?>" onchange="has_change()">
                        </td>
                        <td width="35%" class="value" align="left" style="padding-right:8px;">
                            <input type="text" name="link[1][<?= $imge; ?>]" class="input" id="link[1][<?= $imge; ?>]"
                                   value="<?php echo $link;?>" onchange="has_change()">
                        </td>
                        <td width="8%" class="value">
                            &nbsp;&nbsp;
                        ...
                        <td width="8%" class="value">
                            <select name="status[1][<?= $imge; ?>]" id="status[1][<?= $imge; ?>]"
                                    onchange="changeValue(1,<?= $imge; ?>)" onchange="has_change()">
                                <option
                                    value="1"<?php echo(($status == 1) ? ' selected' : '');?>><?= $lang["active"] ?></option>
                                <option
                                    value="0"<?php echo(($status == 0) ? ' selected' : '');?>><?= $lang["inactive"] ?></option>
                ...
                ?>
                <tr>
                    <td colspan="4" class="field" align="left" style="padding-right:8px;"><b>Top Categories Banners</b>
                    </td>
                    <td colspan="3" class="field" align="left" style="padding-right:8px;"><b>&nbsp;&nbsp;Link&nbsp;&nbsp;</b>
                    </td>
                </tr>
                <?php
                for ($imge = 2; $imge <= 5; $imge++) {
                    ...
                    ?>
                    <tr>
                        <td width="15%" class="field" align="right" style="padding-right:8px;">
                            Position: <?= $position ?><br>Dimension: <?= $width ?>px(W) X <?= $height ?>px(H)<br>
                        ...
                        <td width="35%" class="value" align="left" style="padding-right:8px;">
                            <input type="text" name="link[<?= $imge; ?>][1]" class="input" id="link[<?= $imge; ?>][1]"
                                   value="<?php echo $link;?>" onchange="has_change()">
                        </td>
...
<tr>
    <td width="15%" class="field" align="right" style="padding-right:8px;"><?= $lang["publish"] ?></td><td colspan="4" width="85%" class="value">&nbsp;&nbsp;<input type="checkbox" name="publish" value="1"></td>
                ...
                <tr>
                    ...
                    <td colspan="6" width="85%" class="value">&nbsp;&nbsp;<input type="button"
