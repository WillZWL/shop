...
?>
    <div id="imgslide_<?=$publish_key?>" style="width:<?=$extended_banner_width?$extended_banner_width:$banner_width?>px;height:<?=$extended_banner_height?$extended_banner_height:$banner_height?>px;">
    <a href="<?=$result_link?>" target="<?=$type?>">
<?php
    }
?>
<img width="<?=$extended_banner_width?$extended_banner_width:$banner_width?>" height="<?=$extended_banner_height?$extended_banner_height:$banner_height?>" border="0" src="<?=$graphic[0]?>">
<?php
    if($link)
    {
?>
