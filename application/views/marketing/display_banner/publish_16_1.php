...
elseif($banner_type == "I")
{
	...
	if($link_type[0] == "L")
	{
		...
		{
?>
		<a href="<?="http://".$lytebox_country_id.".chatandvision.com/header/lytebox/".$publish_key?>" rel="lyteframe[header]" rev="width: 620px; height:410px; scrolling: auto;padding: 40px;" target="lbIframe" title="<?=$lang["lytebox_title"]?>"><img width="<?=$banner_width?>" height="<?=$banner_height?>" border="0" src="<?=$graphic[0]?>"></a>
<?php
		}
		else
		{
?>
		...
		<a href="<?=base_url()."header/lytebox/".$publish_key?>" rel="lyteframe[header]" rev="width: 620px; height:410px; scrolling: auto;padding: 40px;" target="lbIframe" title="<?=$lang["lytebox_title"]?>"><img width="<?=$banner_width?>" height="<?=$banner_height?>" border="0" src="<?=$graphic[sizeof($graphic)-1]?>"></a>
<?php
		}
	}
	else
