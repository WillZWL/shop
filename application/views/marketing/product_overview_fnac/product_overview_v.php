            ...
            <tr>
                ...
                <td>
                    <select id="surplusqty_prefix" name="surplusqty_prefix">
                        <option value="2" <?= $this->input->get("surplusqty_prefix") == "2" ? "SELECTED" : "" ?>>Smaller
                            <=
                        </option>
                        <option value="1" <?= $this->input->get("surplusqty_prefix") == "1" ? "SELECTED" : "" ?>>> 0 and
                            Smaller <=
                        </option>
                        <option value="3" <?= $this->input->get("surplusqty_prefix") == "3" ? "SELECTED" : "" ?>>Greater
                            >=
                        </option>
                    </select>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="padding-top:5px;">
            <tr>
                <td align="right" style="padding-right:8px;">
                    <input type="button" style="width:180px" value="<?= $lang['sync_button'] ?>" class="button"
                           onClick="if (CheckProfit(this.form)){ document.getElementById('sync').value=1;needToConfirm=false;this.form.submit()}">
                </td>
