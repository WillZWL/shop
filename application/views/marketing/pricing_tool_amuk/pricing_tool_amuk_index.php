...
<div id="main">
<table cellpadding="0" cellspacing="0" width="100%" border="0" class="frame_left">
<tr bgcolor="#FF8888">
...
<form name="fm" action="<?=base_url()."marketing/pricing_tool_amuk/plist/"?>" method="get" target="plist">
...
<iframe name="plist" id="plist" src="<?=base_url()?>marketing/pricing_tool_amuk/plist/?" width="200" style="float:left;border-right:1px solid #000000;" noresize frameborder="0" marginwidth="0" marginheight="0" hspace=0 vspace=0 onLoad="SetFrameFullHeight(this)"></iframe>
<iframe name="pview" id="pview" src="<?=base_url()?>marketing/pricing_tool_amuk/view/" width="1059" style="float:left;border-left:1px solid #999999;" noresize frameborder="0" marginwidth="0" marginheight="0" hspace=0 vspace=0 onLoad="SetFrameFullHeight(this)"></iframe>
</div>
</body>
</html>