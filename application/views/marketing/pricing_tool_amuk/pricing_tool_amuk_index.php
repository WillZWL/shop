...
<div id="main">
    ...
    <iframe name="plist" id="plist" src="<?= base_url() ?>marketing/pricing_tool_amuk/plist/?" width="200"
    ...
    <iframe name="pview" id="pview" src="<?= base_url() ?>marketing/pricing_tool_amuk/view/" width="1059"
            style="float:left;border-left:1px solid #999999;" noresize frameborder="0" marginwidth="0" marginheight="0"
            hspace=0 vspace=0 onLoad="SetFrameFullHeight(this)"></iframe>
</div>
</body>
</html>