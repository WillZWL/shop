...
<div id="main">
    <iframe src="<?= base_url() ?>marketing/on_sale/view_left/?cat=<?= $catid ?>&level=<?= $level ?>" noresize
    ...
    <iframe src="<?= base_url() ?>marketing/on_sale/view_right/<?= $catid ?>" noresize frameborder="0" name="right"
