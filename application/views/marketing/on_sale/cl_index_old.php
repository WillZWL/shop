...
<tr>
	<td colspan="3" height="70" style="padding-left:8px"><b style="font-size:14px"><?=$lang["title"]?></b><br><?=$lang["subheader"]?></td>
</tr>
<tr>
...
<tr>
	<td></td>
	<td colspan="2" height="35" valign="middle" align="left"><input type="submit" value="<?=$lang["submit"]?>"></td>
</tr>
</table>
</form>
<iframe width="100%" frameborder="0" src="<?=base_url()?>marketing/best_seller/view/" height="420" name="bottom"></iframe>
