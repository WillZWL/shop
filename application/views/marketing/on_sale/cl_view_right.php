...
<div id="main" style="width:auto;">
    ...
    <form name="fm" method="post" action="<?= $_SERVER["PHP_SELF"] . "/" . $catid ?>">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr class="header">
                <td width="55%" height="40" style="padding-left:20px;"><input type="button" value="<?= $lang["back"] ?>"
                                                                              onClick="parent.document.location.href='<?= $_SESSION["LISTPAGE"] ?>';"
                                                                              class="button"></td>
                <td align="left">&nbsp;&nbsp;
                    <input type="submit" name="for_all_platform_use" value="For All Platform Use"
                           onclick="return confirm('Do you want to use these products as default for All Platforms?');"
                           title="use these products for ALL platforms" value="1">
                    <!-- blow submit's value is used to detect which button is clicked. therefore, $lang['submit'] should not be empty -->
                    <input type="submit" name="posted" value="<?= $lang["submit"] ?>" class="button">&nbsp;&nbsp;<input
