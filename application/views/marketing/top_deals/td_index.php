...
<div id="main">
        ...
        <table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
            ...
            <tr>
                ...
                <td colspan=3 class="value value_text">&nbsp;&nbsp;
                    <select
                        onChange='SaveChange(this);gotoPage("<?= base_url() . "marketing/top_deals/main/" . $catid . "/" . $level . "/" ?>",this.value)'>
    ...
    <?php  if ($display) {
        ...
        <iframe src="<?= base_url() ?>marketing/top_deals/view_right/<?= $catid ?>/<?= $level ?>/<?= $platform ?>"
