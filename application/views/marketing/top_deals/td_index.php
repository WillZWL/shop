...
<tr>
	...
	<td  colspan=3 class="value value_text">&nbsp;&nbsp;
		<select onChange='SaveChange(this);gotoPage("<?=base_url()."marketing/top_deals/main/".$catid."/".$level."/"?>",this.value)' ><option value=""> -- Please select -- </option><?php
...
{
?>
<iframe src="<?=base_url()?>marketing/top_deals/view_left/<?=$catid?>/<?=$level?>/<?=$platform?>" noresize frameborder="0" name="left" id="left" marginwidth="0" marginheight="0" hspace="0" vspace="0" width="200" height="380" style="float:left; border-right:1px solid #000000;" onLoad="SetFrameFullHeight(this)"></iframe>
<iframe src="<?=base_url()?>marketing/top_deals/view_right/<?=$catid?>/<?=$level?>/<?=$platform?>" noresize frameborder="0" name="right" id="right" marginwidth="0" marginheight="0" hspace="0" vspace="0" width="1059" height="380" style="float:left; " onLoad="SetFrameFullHeight(this)"></iframe>
<?php
}
?>
	</script>
