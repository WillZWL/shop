...
<div id="main">
    ...
    <form name="fm" method="post">
        <table border="0" cellpadding="0" cellspacing="1" class="tb_list" width="100%" class="tb_pad">
            <col width="20">
            <col width="200">
            <col>
            <col width="150">
            ...
            if (!empty($list)) {
                if ($total > 0) {
                    foreach ($list as $category) {
                        ...
                        $link = base_url() . "marketing/top_deals/main/" . $category->get_id() . "/" . $category->get_level();
                        ?>
