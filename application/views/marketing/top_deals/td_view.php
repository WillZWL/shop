...
<div id="main">
    <iframe src="<?= base_url() ?>marketing/top_deals/view_left/?cat=<?= $catid ?>&level=<?= $level ?>" noresize
    ...
    <iframe src="<?= base_url() ?>marketing/top_deals/view_right/<?= $catid ?>" noresize frameborder="0" name="right"
            id="right" marginwidth="0" marginheight="0" hspace="0" vspace="0" width="1059" height="450"
