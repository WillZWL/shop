...
<?=$notice["img"]?>
<form name="catview" action="<?=$_SERVER["PHP_SELF"]?>?level=<?=$this->input->get('level')?>&parent=<?=$this->input->get('parent')?>" method="POST">
...
<tr>
	<td width="142" height="20" valign="top" class="field" align="left">&nbsp;&nbsp;<?=$lang["category_name"]?></td>
	<td height="20" valign="top" class="value" align="left">&nbsp;&nbsp;<input type="text" name="name" value=""></td>
</tr>
<tr>
	<td width="142" valign="top" class="field" align="left">&nbsp;&nbsp;<?=$lang["category_desc"]?></td>
	<td align="left" class="value">&nbsp;&nbsp;<textarea cols="60" rows="5" name="description"></textarea></td>
</tr>
<tr>
...
?>
<tr>
	<td width="142" height="20" valign="top" class="field" align="left">&nbsp;&nbsp;<?=$lang["category_cat"]?></td>
	<td height="20" valign="top" class="value" align="left">&nbsp;&nbsp;<?=$parent_obj->get_name()?></td>
</tr>
<?php
		}
		else
...
<tr>
	<td width="142" height="20" valign="top" class="field" align="left">&nbsp;&nbsp;<?=$lang["category_cat"]?></td>
	<td height="20" valign="top" class="value" align="left">&nbsp;&nbsp;<?=$parent_obj->get_cat_name()?></td>
</tr>
<tr>
	<td width="142" height="20" valign="top" class="field" align="left">&nbsp;&nbsp;<?=$lang["category_subcat"]?></td>
	<td height="20" valign="top" class="value" align="left">&nbsp;&nbsp;<?=$parent_obj->get_name()?></td>
</tr>
<?php
		}
...
<tr>
	...
	<td align="right" style="padding-right:8px"><input type="submit" name="submit" value="<?=$lang["add_category"]?>" style="font-size:11px"></td>
</tr>
</table>
