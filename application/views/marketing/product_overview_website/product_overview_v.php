...
<table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
	...
	<tr>
		...
		<td>
			...
			<form action="/marketing/product_overview_website/upload_sku_info" enctype="multipart/form-data" method="post">
		...
		<td style="width:50%;text-align:left;">
			...
			<form action="/marketing/product_overview_website/upload_clearance_sku_info" enctype="multipart/form-data" method="post">
	...
	<tr>
		...
		<td>
			<select id="surplus_quantity_prefix" name="surplus_quantity_prefix">
				<option value="2" <?=$this->input->get("surplus_quantity_prefix") == "2"?"SELECTED":""?>>Smaller <=</option>
				<option value="1" <?=$this->input->get("surplus_quantity_prefix") == "1"?"SELECTED":""?>>> 0 and Smaller <=</option>
				<option value="3" <?=$this->input->get("surplus_quantity_prefix") == "3"?"SELECTED":""?>>Greater >=</option>
			</select>
			<input name="surplus_quantity" class="input" value="<?=$this->input->get("surplus_quantity")==""?"10000":$this->input->get("surplus_quantity")?>" style="width:200px">
		</td>
	</tr>
	<tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
	<col width="20"><col width="50"><col width="60"><col><col width="60"><col width="80"><col width="80"><col width="100">
	<?php
	...
	?>
	<col width="80"><col width="75"><col width="110"><col width="50"><col width="70"><col width="50"><col width="50">
	<tr class="header">
		<td height="20">
		...
		<td title="<?=$lang["supplier_status"]?>"><a href="#" onClick="SortCol(document.fm, 'surplus_quantity', '<?=$xsort["surplus_quantity"]?>')">Surplus Quantity<?=$sortimg["surplus_quantity"]?></a></td>
