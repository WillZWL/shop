...
<div id="main">
    ...
    <table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
        ...
        <tr>
            <td></td>
            <td>
                Export as CSV <a href="/marketing/product_overview_website?<?= $query_string ?>&csv=1">here</a>,
                after modification, upload the file below
                <form action="/marketing/product_overview_website/upload_sku_info" enctype="multipart/form-data"
                      method="post">
            ...
            <td style="width:50%;text-align:left;">
                ...
                <form action="/marketing/product_overview_website/upload_clearance_sku_info"
    ...
    <form name="fm" method="get" onSubmit="return CheckForm(this)">
        <table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
            ...
            <tr>
                ...
                <td>
                    <select id="surplus_quantity_prefix" name="surplus_quantity_prefix">
                        <option value="2" <?= $this->input->get("surplus_quantity_prefix") == "2" ? "SELECTED" : "" ?>>
                            Smaller <=
                        </option>
                        <option value="1" <?= $this->input->get("surplus_quantity_prefix") == "1" ? "SELECTED" : "" ?>>>
                            0 and Smaller <=
                        </option>
                        <option value="3" <?= $this->input->get("surplus_quantity_prefix") == "3" ? "SELECTED" : "" ?>>
                            Greater >=
                        </option>
                    </select>
                    <input name="surplus_quantity" class="input"
                           value="<?= $this->input->get("surplus_quantity") == "" ? "10000" : $this->input->get("surplus_quantity") ?>"
                           style="width:200px">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select id="affiliate_feed" name="affiliate_feed" onchange="check_feed_selection(this)">
                        <option value="">---</option>
                        <?php
                    ...
                    <script>
                        check_feed_selection(document.getElementById("affiliate_feed"));
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
            ...
            <tr class="header">
                ...
                <td title="<?= $lang["supplier_status"] ?>"><a href="#"
                        ...
                        Quantity<?= $sortimg["surplus_quantity"] ?></a></td>
                <td title="<?= $lang["supplier_status"] ?>"><a href="#"
                                                               onClick="SortCol(document.fm, 'supplier_status', '<?= $xsort["supplier_status"] ?>')"><?= $lang["supplier_status"] ?> <?= $sortimg["supplier_status"] ?></a>
                </td>
            ...
            <tr class="search" id="tr_search" <?= $searchdisplay ?>>
                ...
                <td>
                    ...
                    if ($this->input->get("auto_price") != "") {
                        $selected_aucb[$this->input->get("auto_price")] = "SELECTED";
                    }
                    ?>
                    <select name="auto_price" class="input">
                        <option value=""></option>
                        <option value="Y" <?= $selected_aucb["Y"] ?>>Auto</option>
                        <option value="N" <?= $selected_aucb["N"] ?>>Manual</option>
                    </select>
                </td>
