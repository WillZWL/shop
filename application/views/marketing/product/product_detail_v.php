                            ...
                            $m++; ?>
                                ...
                                <td style="padding: 0px; border: none;">
                                    <table width="100%" style="padding-right: 5px;">
                                        ...
                                        <? for($i=0; $i<count($optionhs);  $i++){ ?>
                                            <? if($optionhs[$i]['country_id'] == $phs[$j]['country_id']) { ?>
                            ...
                            $m++; ?>
                                ...
                                <td style="padding: 0px; border: none;">
                                    ...
                                    <?if(strpos($psarr, $arrcountry[$j] ) !==false) {?>
                                        ...
                                        <? for($i=0; $i<count($optionhs);  $i++){ ?>
                                            <? if($optionhs[$i]['country_id'] == $arrcountry[$j]) { ?>
                                ...
                                <? } ?>
                                    ...
                                    <?if(strpos($psarr, $arrcountry[$j] ) !==false) {?>
                                        ...
                                        <?if(count($phs)>0) {
                                            ...
                                            <? for ($g=0; $g<count($phs); $g++){
                                                if($phs[$g]['country_id'] == $arrcountry[$j]) { ?>
                                                    <? $pduty = $phs[$g]['duty_pcent'];
            ...
            <div id="div_tab_<?=$cur_lang_id?>" class="x-tab" title="<?=$cur_name?>">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_main">
                    ...
                    <tr>
                        ...
                        <td class="value"><input name="banner_link_<?=$cur_lang_id?>" class="input" value="<?if($product_banner[$cur_lang_id]){echo $product_banner[$cur_lang_id]->get_link();}?>"></td>
                    </tr>
                    <tr>
...
jQuery(function(){
        ...
        ?>
            ...
            ?>
            var platform_id_list = ['<? echo implode('\',\'', $platform_id_list) ?>'];
