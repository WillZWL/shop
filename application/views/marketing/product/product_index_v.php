    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td width="600" align="right" class="title">
                ...
                ?>
                <input type="button" value="<?= $lang["translat_button"] ?>" class="button"
                       onclick="Redirect('<?= site_url('marketing/product/translat_all_sku') ?>')">
            </td>
        </tr>
        <tr>
            ...
            if ($objlist) {
                foreach ($objlist as $obj) {
                    ...
                    <tr class="row<?= $i % 2 ?> pointer" onMouseOver="AddClassName(this, 'highlight')"
                        ...
                        onClick="Redirect('<?= site_url('marketing/product/view/' . $obj->get_sku()) ?>')">
