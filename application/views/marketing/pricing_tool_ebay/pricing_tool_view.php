...
<body onload="showHide('EBAYUS');showHide('EBAYAU');showHide('EBAYSG');" marginheight="0" marginwidth="0" topmargin="0" leftmargin="0" class="frame_left">
<?php
...
?>
	...
	<tr>
		...
		<td colspan="3" class="value"><input name="price_ext[<?=$platform?>][title]" value="<?=htmlspecialchars($price_ext_obj->get_title())?>" class="input" maxlength="80"></td>
	</tr>
	<tr>
		<td width="20%" class="field"><?=$lang["category"]?></td>
		<td width="30%" class="value"><input name="price_ext[<?=$platform?>][ext_ref_1]" value="<?=htmlspecialchars($price_ext_obj->get_ext_ref_1())?>"></td>
		<td width="20%" class="field"><?=$lang["category2"]?></td>
		<td width="30%" class="value"><input name="price_ext[<?=$platform?>][ext_ref_2]" value="<?=htmlspecialchars($price_ext_obj->get_ext_ref_2())?>"></td>
	</tr>
	<tr>
	...
	<?php
		if($store_cat_2_list[$platform])
		{
			...
			{
				?><option value="<?=$store_cat_2->get_ext_id()?>" <?=($price_ext_obj->get_ext_ref_4() == $store_cat_2->get_ext_id()?"SELECTED":"")?>><?=$store_cat_2->get_ext_name()?></option><?php
			}
		}
	?>
		</td>
	...
	<tr>
		...
		<td class="value"><input name="price_ext[<?=$platform?>][ext_qty]" value="<?=htmlspecialchars($price_ext_obj->get_ext_qty())?>">
...
?>
	<tr>
		...
		<td class="value">
			<select name="action[<?=$platform?>]" style="width:130px;" onChange="if(this.value == 'E') { document.getElementById('end_reason[<?=$platform?>]').style.display = '' } else { document.getElementById('end_reason[<?=$platform?>]').style.display = 'none' }">
				<option></option>
