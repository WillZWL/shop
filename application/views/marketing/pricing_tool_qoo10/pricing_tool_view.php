                    ...
                    <td align="left">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb_main">
                            ...
                            <tr>
                                ...
                                <td class="value">
                                    <select name="listing_status[<?= $platform ?>]"
                                            onChange="if(this.value == 'N') {document.getElementById('action[<?= $platform ?>]').value ='E'} else {document.getElementById('action[<?= $platform ?>]').value =''}"
                                            style="width:130px;">
