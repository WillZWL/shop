...
?>
	...
	<tr>
		...
		<td width="30%" class="value"><input name="price_ext[<?=$platform?>][ext_qty]" value="<?=htmlspecialchars($price_ext_obj->get_ext_qty())?>" style="width:100%"></td>
	...
	<tr>
		...
		<td width="30%" <?=$ean_style?>><?=$ean?>
			<br><input name="price_ext[<?=$platform?>][ext_ref_3]" value="<?=htmlspecialchars($price_ext_obj->get_ext_ref_3())?>" style="width:100%">
	...
	<tr>
		...
		<td class="value"><input type="checkbox" name="update[<?=$platform?>]" value="1" style="width:10%" <?=$checkupdate?>></td>
...
<tr>
	<td align="right" style="padding-right:8px;" height="30"><input type="button" value="Update and Sync Price to Fnac" style="width:180px" class="button" onClick="if(CheckForm(this.form)) { document.getElementById('sync').value = 1; this.form.submit(); }"></td>
	<td align="right" style="padding-right:8px;" height="30" width="120px"><input type="button" value="Update Pricing Tool" class="button" onClick="if(CheckForm(this.form)) this.form.submit();"></td>
</tr>
</table>
</form>
<?php /*
