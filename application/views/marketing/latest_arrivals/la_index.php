...
<div id="main">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr> <td height="30" class="title"><b style="font-size:16px;color:#000000"><?= $lang["subtitle"] ?></b></td> </tr>
        <tr class="header"> <td height="2"></td> </tr>
    </table>
    <form action="" method="POST" name="form" style="padding:0; margin:0" onSubmit="return CheckForm(this)" enctype="multipart/form-data">
        <table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
            ...
            <tr>
                ...
                <td align="right">
                    <table align="right">
                        <tr> <td align="left"><?= $lang["header_algo"] ?></td> </tr>
                    </table>
                </td>
            </tr>
            <tr>
                ...
                <td colspan=3 class="value value_text">&nbsp;&nbsp;
                    <select onChange='SaveChange(this);gotoPage("<?= base_url() . "marketing/latest_arrivals/main/?catid=" . $this->input->get('catid') . "&level=" . $this->input->get('level') . "&platform=" ?>",this.value)'>
                        <option value=""> -- Please select --</option>
                        <?php foreach ($platform_id_list as $obj): ?>
                        <option value="<?= $obj->get_selling_platform_id() ?>" <?= ($obj->get_selling_platform_id() == $platform ? "SELECTED" : "") ?>><?= $obj->get_selling_platform_id() ?></option>
                        <?php endforeach ?>
                    </select>
                </td>
            </tr>
