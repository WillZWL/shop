...
<div id="main">
        ...
        <table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
            ...
            <tr>
                ...
                <td colspan=3 class="value value_text">&nbsp;&nbsp;
                    <select
                        onChange='SaveChange(this);gotoPage("<?= base_url() . "marketing/latest_arrivals/main/?catid=" . $this->input->get('catid') . "&level=" . $this->input->get('level') . "&platform=" ?>",this.value)'>
    ...
    <? if ($display) {
        ?>
        <iframe
            src="<?= base_url() ?>marketing/latest_arrivals/view_left/?cat=<?= $catid ?>&level=<?= $level ?>&platform=<?= $platform ?>"
            noresize frameborder="0" name="left" id="left" marginwidth="0" marginheight="0" hspace="0" vspace="0"
            width="200" height="380" style="float:left; border-right:1px solid #000000;"
            onLoad="SetFrameFullHeight(this)"></iframe>
        <iframe src="<?= base_url() ?>marketing/latest_arrivals/view_right/<?= $catid ?>/<?= $platform ?>" noresize
                frameborder="0" name="right" id="right" marginwidth="0" marginheight="0" hspace="0" vspace="0"
                width="1059" height="380" style="float:left; " onLoad="SetFrameFullHeight(this)"></iframe>
    <?php
    }
    ?>
    </script>
