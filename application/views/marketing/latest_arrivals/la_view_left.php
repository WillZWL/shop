...
<form name="fm" method="get" action="<?=base_url()?>marketing/latest_arrivals/view_left/">
...
?>
	...
	<tr class="row<?=$i%2?> pointer" onMouseOver="AddClassName(this, 'highlight')" onMouseOut="RemoveClassName(this, 'highlight')" onClick="addToRight('<?=$obj->get_sku()?>','<?=htmlentities(addslashes($obj->get_name()))?>')">
