...
<div id="main">
        ...
        <table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
            ...
            <tr>
                ...
                <td colspan=3 class="value value_text">&nbsp;&nbsp;
                    <select
                        onChange='SaveChange(this);gotoPage("<?= base_url() . "marketing/best_seller/main/" . $catid . "/" . $level . "/" ?>",this.value)'>
    ...
    <? if ($display) {
        ...
        <iframe src="<?= base_url() ?>marketing/best_seller/view_left/<?= $catid ?>/<?= $level ?>/<?= $platform ?>"
        ...
        <iframe src="<?= base_url() ?>marketing/best_seller/view_right/<?= $catid ?>/<?= $level ?>/<?= $platform ?>"
