        ...
        foreach($lang_list as $lang_obj)
        {
                    ...
                    foreach($platform_list as $platform_obj)
                    {
                        if($promo_text_obj_w_platform[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()])
                        {
                            ...
                            <tr class="row<?=$i%2?> pointer" onMouseOver="AddClassName(this, 'highlight')" onMouseOut="RemoveClassName(this, 'highlight')">
                                <td height="20"></td>
                                <td>&nbsp;&nbsp;<?=$type?></td>
                                <td>&nbsp;&nbsp;<?=$promo_text_obj_w_platform[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()]->get_lang_id()?></td>
                                <td>&nbsp;&nbsp;<?=$platform_name[$promo_text_obj_w_platform[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()]->get_platform_id()]?></td>
                                <td>&nbsp;&nbsp;<?=$promo_text_obj_w_platform[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()]->get_sku()?></td>
                                <td>&nbsp;&nbsp;<input name="promo_text[<?=$promo_text_obj_w_platform[$type][$lang_id][$platform_obj->get_selling_platform_id()]->get_platform_type()?>][<?=$promo_text_obj_w_platform[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()]->get_lang_id()?>][<?=$promo_text_obj_w_platform[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()]->get_platform_id()?>][<?=$promo_text_obj_w_platform[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()]->get_id()?>]" class="input" value="<?=$promo_text_obj_w_platform[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()]->get_promo_text()?>" notEmpty maxLen=256></td>
                            </tr>
                                <?php
                            $i++;
                        }
            ...
            else
            {
                ...
                <tr class="row<?=$i%2?> pointer" onMouseOver="AddClassName(this, 'highlight')" onMouseOut="RemoveClassName(this, 'highlight')">
                    <td height="20"></td>
                    <td>&nbsp;&nbsp;<?=$type?></td>
                    <td>&nbsp;&nbsp;<?=$promo_text_obj_w_lang[$type][$lang_obj->get_id()]->get_lang_id()?></td>
                    <td>&nbsp;&nbsp;<?=$promo_text_obj_w_lang[$type][$lang_obj->get_id()]->get_platform_id()?></td>
                    <td>&nbsp;&nbsp;<?=$promo_text_obj_w_lang[$type][$lang_obj->get_id()]->get_sku()?></td>
                    <td>&nbsp;&nbsp;<input name="promo_text[<?=$promo_text_obj_w_lang[$type][$lang_obj->get_id()]->get_platform_type()?>][<?=$promo_text_obj_w_lang[$type][$lang_obj->get_id()]->get_lang_id()?>][<?=$promo_text_obj_w_lang[$type][$lang_obj->get_id()]->get_id()?>]" class="input" value="<?=$promo_text_obj_w_lang[$type][$lang_obj->get_id()]->get_promo_text()?>" notEmpty maxLen=256></td>
                </tr>
                    <?php
                $i++;
                }
                else
                {
                    ...
                    <tr class="row<?=$i%2?> pointer" onMouseOver="AddClassName(this, 'highlight')" onMouseOut="RemoveClassName(this, 'highlight')">
                        ...
                        <td>&nbsp;&nbsp;<??></td>
                        <td>&nbsp;&nbsp;<??></td>
                        <td>&nbsp;&nbsp;<input name="promo_text[<?=$type?>][<?=$lang_obj->get_id()?>]" class="input" value="" notEmpty maxLen=256></td>
                    </tr>
                        <?php
                    $i++;
                }
