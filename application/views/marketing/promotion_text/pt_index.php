...
{
?>
<iframe src="<?=base_url()?>marketing/promotion_text/view_left/<?=$lang_id?>/<?=$platform_id?>" noresize frameborder="0" name="left" id="left" marginwidth="0" marginheight="0" hspace="0" vspace="0" width="200" height="380" style="float:left; border-right:1px solid #000000;" onLoad="SetFrameFullHeight(this)"></iframe>
<iframe src="" noresize frameborder="0" name="right" id="right" marginwidth="0" marginheight="0" hspace="0" vspace="0" width="84%" height="380" style="float:left; " onLoad="SetFrameFullHeight(this)"></iframe>
<?php
}
?>
</script>
