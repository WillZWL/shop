                        ...
                        foreach ($platform_list as $platform_obj) {
                            if ($promo_text_obj_w_sku[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()][$sku]) {
                                ...
                                <tr class="row<?= $i % 2 ?> pointer" onMouseOver="AddClassName(this, 'highlight')"
                                    ...
                                    <td>&nbsp;&nbsp;<?= $type ?></td>
                                    <td>
                                        &nbsp;&nbsp;<?= $promo_text_obj_w_sku[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()][$sku]->get_lang_id() ?></td>
                                    <td>
                                        &nbsp;&nbsp;<?= $platform_name[$promo_text_obj_w_sku[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()][$sku]->get_platform_id()] ?></td>
                                    <td>
                                        &nbsp;&nbsp;<?= $promo_text_obj_w_sku[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()][$sku]->get_sku() ?></td>
                                    <td>&nbsp;&nbsp;<input
                                            name="promo_text[<?= $promo_text_obj_w_sku[$type][$lang_id][$platform_obj->get_selling_platform_id()][$sku]->get_platform_type() ?>][<?= $promo_text_obj_w_sku[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()][$sku]->get_lang_id() ?>][<?= $promo_text_obj_w_sku[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()][$sku]->get_platform_id() ?>][<?= $promo_text_obj_w_sku[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()][$sku]->get_id() ?>]"
                                            class="input"
                                            value="<?= $promo_text_obj_w_sku[$type][$lang_obj->get_id()][$platform_obj->get_selling_platform_id()][$sku]->get_promo_text() ?>"
