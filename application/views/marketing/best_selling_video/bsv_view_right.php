            ...
            for ($i = 1; $i <= $limit; $i++) {
                ...
                <tr height="20">
                    ...
                    <td class="value" align="left">
                        &nbsp;&nbsp;<?= $asku[$i] . ($asku[$i] == "" ? "" : " - ") . $aname[$i] ?></br>
                        <?php
                        if ($avalue[$i] != $lang["not_assigned"]) {
                            ?>
                            <object width="300" height="225">
                                <param name="movie"
                                       value="http://www.youtube.com/v/<?= $avalue[$i] ?>&amp;hl=en_US&amp;fs=1"></param>
                                <param name="allowFullScreen" value="true"></param>
                                <param name="allowscriptaccess" value="always"></param>
                                <embed src="http://www.youtube.com/v/<?= $avalue[$i] ?>&amp;hl=en_US&amp;fs=1"
                                       type="application/x-shockwave-flash" allowscriptaccess="always"
                                       allowfullscreen="true" width="300" height="225"></embed>
                            </object>
                        <?php
                        }
                        ?>
                    ...
                    <td class="value" align="left">
                        &nbsp;&nbsp;<?= $osku[$i] . ($osku[$i] == "" ? "" : " - ") . $oname[$i] ?></br>
                        <?php
                        if ($ovalue[$i] != $lang["not_assigned"]) {
                            ?>
                            <object width="300" height="225">
                                <param name="movie"
                                       value="http://www.youtube.com/v/<?= $ovalue[$i] ?>&amp;hl=en_US&amp;fs=1"></param>
                                <param name="allowFullScreen" value="true"></param>
                                <param name="allowscriptaccess" value="always"></param>
                                <embed src="http://www.youtube.com/v/<?= $ovalue[$i] ?>&amp;hl=en_US&amp;fs=1"
                                       type="application/x-shockwave-flash" allowscriptaccess="always"
                                       allowfullscreen="true" width="300" height="225"></embed>
                            </object>
                        <?php
        ...
        <table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#cccccc">
            ...
            for ($i = 1; $i <= $limit; $i++) {
                ...
                <tr>
                    ...
                    <td class="value" align="left">
                        &nbsp;&nbsp;<?= $sku[$i] . ($sku[$i] == "" ? "" : " - ") . $name[$i] ?></br>
                        <?php
                        if ($value[$i] != $lang["not_assigned"]) {
                            ?>
                            <object width="300" height="225">
                                <param name="movie"
                                       value="http://www.youtube.com/v/<?= $value[$i] ?>&amp;hl=en_US&amp;fs=1"></param>
                                <param name="allowFullScreen" value="true"></param>
                                <param name="allowscriptaccess" value="always"></param>
                                <embed src="http://www.youtube.com/v/<?= $value[$i] ?>&amp;hl=en_US&amp;fs=1"
                                       type="application/x-shockwave-flash" allowscriptaccess="always"
                                       allowfullscreen="true" width="300" height="225"></embed>
                            </object>
                        <?php
