...
{
?>
<iframe src="<?=base_url()?>marketing/best_selling_video/view_left/?cat=<?=$catid?>&level=<?=$level?>&platform=<?=$platform?>&type=<?=$type?>&src=<?=$src?>" noresize frameborder="0" name="left" id="left" marginwidth="0" marginheight="0" hspace="0" vspace="0" width="300" height="380" style="float:left; border-right:1px solid #000000;" onLoad="SetFrameFullHeight(this)"></iframe>
<iframe src="<?=base_url()?>marketing/best_selling_video/view_right/<?=$catid?>/<?=$platform?>/<?=$type?>/<?=$src?>" noresize frameborder="0" name="right" id="right" marginwidth="0" marginheight="0" hspace="0" vspace="0" width="959" height="380" style="float:left; " onLoad="SetFrameFullHeight(this)"></iframe>
<?php
}
?>
</script>
