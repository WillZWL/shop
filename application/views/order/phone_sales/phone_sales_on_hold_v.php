...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
    <col width="20"><col width="100"><col><col><col width="80"><col width="120"><col width="120"><col width="150">
    <tr class="header">
...
<form name="fm_proc_<?=$obj->get_so_no()?>" method="post">
    <tr class="row<?=$i%2?>">
        ...
        <td><input type="button" value="<?=$lang["delete"]?>" onClick="if (confirm('<?=$lang["delete_confirm"]?>')){Proc('<?=$obj->get_so_no()?>', 0);}"> &nbsp; &nbsp; <input type="button" value="<?=$lang["approve"]?>" onClick="if(confirm('<?=$lang["move_to_cc"]?>'))Proc('<?=$obj->get_so_no()?>', 2);"></td>
    </tr>
