...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
    <col width="20"><col width="70"><col width="60"><col><col width="100"><col width="100"><col width="100"><col width="100"><col width="50"><col width="70"><col width="26">
    <tr class="header">
        <td height="20">
            <?php
                if ($prod_grp_cd == "")
...
?>
    ...
    <tr class="row<?=$i%2?>" onMouseOver="AddClassName(this, 'highlight')" onMouseOut="RemoveClassName(this, 'highlight')">
        ...
        <?$wsstatus = (($obj->get_website_status() == "I" && $obj->get_website_quantity()<1) || $obj->get_listing_status() <> "L")?"O":$obj->get_website_status()?>
        ...
        {
        ?>
            <input type="button" value="<?=$lang["add"]?>" onClick="top.frames['fcart'].document.fm_cart.add.value='<?=$obj->get_sku()?>';top.frames['fcart'].document.fm_cart.submit();">
        <?php
        }
        ?>
        </td>
