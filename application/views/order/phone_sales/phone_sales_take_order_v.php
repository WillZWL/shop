    ...
    <form name="fm_checkout" method="post" onSubmit="return CheckSubmit(this)">
        <table width="100%" cellspacing="0" cellpadding="4">
            <tr style="font-weight:bold;background:#DDDDDD">
                ...
                <td align="right" width="60" style="border:1px solid #BBBBBB; border-width:1px 0px 1px 1px;">Sub-Total
                </td>
            ...
            <tr>
                ...
                <td align="right" bgcolor="#F0F0F0"
                    style="border-left:1px solid #BBBBBB;"><?= number_format($dc_sub_total = ($dc[$cur_delivery]["charge"] - $dc[$cur_delivery]["vat"]), 2) ?></td>
                <td align="right" bgcolor="#F0F0F0"
                    style="border-left:1px solid #BBBBBB;"><?= number_format($dc[$cur_delivery]["vat"], 2) ?></td>
                <td align="right" bgcolor="#FFEEAA" style="border:1px solid #BBBBBB; border-width:0px 1px 0px 1px;">
                    <b><?= number_format($dc[$cur_delivery]["charge"], 2) ?></b></td>
            </tr>
            <?php
            if ($_SESSION["promotion_code"]) {
                ...
                <tr>
                    ...
                    <td colspan="2" align="right" bgcolor="#DDDDDD"
                        style="border:1px solid #BBBBBB; border-width:1px 0px 1px 1px;">
                        <b><?= $lang["promotion_code"] ?></b></td>
                    <td colspan="3" align="right" bgcolor="#F0F0F0"
                        style="border:1px solid #BBBBBB; border-width:1px 1px 1px 1px;"><?= $_SESSION["promotion_code"] ?></td>
                </tr>
            <?php
            }
            ?>
            ...
            if ($offline_fee) {
                ...
                <tr>
                    <td colspan="2">&nbsp;</td>
                    <td colspan="2" align="right" bgcolor="#DDDDDD"
                        style="border:1px solid #BBBBBB; border-width:1px 0px 1px 1px;"><b>Offline Fee</b></td>
                    <td align="right" bgcolor="#F0F0F0" style="border:1px solid #BBBBBB; border-width:1px 0px 1px 1px;">
                        &nbsp;</td>
                    <td align="right" bgcolor="#F0F0F0" style="border:1px solid #BBBBBB; border-width:1px 0px 1px 1px;">
                        &nbsp;</td>
                    <td align="right" bgcolor="#FFEEAA" style="border:1px solid #BBBBBB; border-width:1px 1px 1px 1px;">
                        <b><?= number_format($offline_fee, 2) ?></b></td>
                </tr>
            <?php
            }
            ?>
            ...
            if (isset($promo)) {
                ...
                <tr>
                    <td colspan="7" align="right"
                        style="color:<?= $display_color ?>;font-weight:bold;"><?= $display_msg ?></td>
                    <td></td>
                </tr>
            <?php
            }
        ...
        <table cellpadding="4" cellspacing="0" width="60%" class="bg_row">
            ...
            <tr>
                <td width="23" colspan="2"><input type="checkbox" name="billaddr" id="billaddr" onclick="showBaddr()"
                                                  value="1"/>Click here if Billing Address and Cardholder Name is
                    different from Delivery Detail
                </td>
            </tr>
            <tr>
                <td height="10px"></td>
            ...
            <tr>
                ...
                <td>
                    <select id="country_id" name="client[country_id]" class="text"
                            onchange="document.getElementById('state').style.display = 'none'; document.getElementById('state').disabled = true;update_state_field()">
                        <?php
                        if ($country_list)
                        {
            ...
            <tr id="JS_nc">
                <td>NIF / CIF:</td>
                <td><input name="client[client_id_no]" dname="NIF / CIF" class="text"
                           value="<?= htmlspecialchars($_POST["client"]["client_id_no"]) ?>"></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input id="state" name="client[state]" dname="State" class="text"
            ...
            <tr id='del_country_id' style="display:none">
                ...
                <td>
                    <select id='d_country_id' name="client[del_country_id]" class="text"
                            onchange="update_state_field()">
                        <?php
                        if ($country_list)
                        {
            ...
            <tr id='del_name' style="display:none">
                ...
                <td>
                    ...
                    <input id="del_name" name="client[del_name]" dname="Delivery First Name" class="text2"
                           value="<?= htmlspecialchars($_POST["client"]["del_name"]) ?>">
                </td>
            </tr>
            <tr id='del_address' style="display:none">
                <td><span class="warn">*</span> Delivery Address:</td>
                <td>
                    <input id="del_address_1" name="client[del_address_1]" dname="Delivery Address Line 1" class="text"
            ...
            <tr id='del_state' style="display:none">
                ...
                <td>
                    <input id="d_state" name="client[del_state]" dname="Delivery State" class="text"
