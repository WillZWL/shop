...
<table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
	<tr>
		...
		<select name="warehouse_id" onChange="document.location.href='<?=base_url()?>order/integrated_order_fulfillment/index/'+this.value">
			<?php
	...
	<tr>
		<td align="right" colspan=2>
			<input type="button" value="<?=$lang["wms_allocation"]?>" onClick="document.location.href='<?=base_url()?>order/integrated_order_fulfillment/get_wms_allocation_plan_order'">
		</td>
	</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
	...
	<col width="2%"><col width="8%"><col width="5%"><col width="10%"><col width="10%"><col width="10%"><col width="5%"><col width="8%"><col width="8%"><col width="10%"><col width="10%"><col width="10%"><col width="15%"><col width="10%"><col width="15%"><col width="10%"><col width="3%"><col width="3%"><col width="15%"><col width="15%">
	<tr class="header">
		<td height="20">
...
?>
	<tr name="row<?=$n?>" class="<?=$row_style?>"  onMouseOver="AddGroupClassName('row<?=$n?>', 'highlight')" onMouseOut="RemoveGroupClassName('row<?=$n?>', 'highlight')" valign="top">
		...
		<td <?=$row_span?>>
			...
			<div align="right"><a href="<?=base_url()?>order/integrated_order_fulfillment/add_note/<?=$obj->get_so_no()?>/<?=$i?>" rel="lyteframe[note]" rev="width: 400px; height: 400px; scrolling: auto;" title="<?=$lang["add_note"]?>: <?=$obj->get_so_no()?>"><?=$lang["add_note"]?></a>
			</div>
		</td>
		<?=$splitgrouprow?>
