    ...
    <form name="fm" method="get" onSubmit="return CheckForm(this)">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
            ...
            <tr class="header">
                ...
                <td title="<?= $lang["packing_date"] ?>"><a href="#"
                                                            onClick="SortCol(document.fm, 'packing_date', '<?= $xsort["packing_date"] ?>')"><?= $lang["packing_date"] ?> <?= $sortimg["packing_date"] ?></a>
                </td>
            ...
            foreach ($objlist as $obj) {
                ...
                <?php } else {
                    ...
                    <tr name="row<?= $n ?>" class="<?= $row_style ?>" <?= $row_span ?>
                        ...
                        <td <?= $row_span ?> nowrap style="white-space:nowrap;"><?= $obj->get_courier_id() ?> -><input
                                size="6" style="width:50px" name="courier[<?= $obj->get_sh_no() ?>]"
                                value="<?= htmlspecialchars($_POST["courier"][$obj->get_sh_no()]) ?>"><br><input
                                name="tracking[<?= $obj->get_sh_no() ?>]" class="input"
                                value="<?= htmlspecialchars($obj->get_tracking_no()) ?>"></td>
                        ...
                        <td <?= $row_span ?> align="center"><input type="checkbox"
                                                                   name="check[<?= $obj->get_sh_no() ?>]"
                                                                   id="check[<?= $obj->get_so_no() ?>]"
                                                                   value="<?= $obj->get_so_no() ?>"<?= $check_html ?>>
                        </td>
                    </tr>
                    <?php
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="padding-top:5px;">
            <tr>
                <td align="right" style="padding-right:8px;">
                    ...
                    &nbsp;|&nbsp
                    <input type="button" value="<?= $lang['import_trackingfile'] ?>"
                           onClick="document.getElementById('a_check').onclick();"> <a id="a_check"
                                                                                       href="<?= base_url() ?>order/integrated_order_fulfillment/import_trackingfile"
                                                                                       rel="lyteframe"
                                                                                       rev="width: 700px; height: 500; scrolling: auto;"
                                                                                       title="<?= $lang['import_trackingfile'] ?>"></a>
                    &nbsp;|&nbsp
                    ...
                    <input type="button" value="<?= $lang['return_selected'] ?>"
                           onClick="document.fm_edit.dispatch_type.value='r';this.form.submit();"> &nbsp;|&nbsp
