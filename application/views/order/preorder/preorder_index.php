        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
            ...
            <tr class="header">
                ...
                <td style="white-space:nowrap"><a href="#"
                                                  onClick="SortCol(document.fm, 'so_no', '<?= $xsort["so_no"] ?>')"><?= $lang["so_number"] ?> <?= $sortimg["so_no"] ?></a>
                </td>
                <td style="white-space:nowrap"><a href="#"
                                                  onClick="SortCol(document.fm, 'sku', '<?= $xsort["sku"] ?>')"><?= $lang["sku"] ?> <?= $sortimg["sku"] ?></a>
                </td>
                <td style="white-space:nowrap"><a href="#"
                                                  onClick="SortCol(document.fm, 'prod_name', '<?= $xsort["prod_name"] ?>')"><?= $lang["produt_name"] ?> <?= $sortimg["prod_name"] ?></a>
                </td>
                <td style="white-space:nowrap"><a href="#"
                ...
                <td style="white-space:nowrap"><a href="#"
                                                  onClick="SortCol(document.fm, 'expected_delivery_date', '<?= $xsort["expected_delivery_date"] ?>')"><?= $lang["current_edd"] ?> <?= $sortimg["expected_delivery_date"] ?></a>
                </td>
                <td style="white-space:nowrap"><a href="#"
                                                  onClick="SortCol(document.fm, 'create_on', '<?= $xsort["create_on"] ?>')"><?= $lang["order_date"] ?> <?= $sortimg["create_on"] ?></a>
                </td>
                <!--        <td style="white-space:nowrap"><?= $lang["action"] ?></td>    -->
                <td title="<?= $lang["check_all"] ?>"><input type="checkbox" name="chkall" value="1"
                                                             onClick="checkall(document.fm, this, 1);"></td>
            </tr>
            <tr class="search" id="tr_search" <?= $searchdisplay ?>>
                <td>&nbsp;</td>
                <td><input name="so_no" class="input" value="<?= htmlspecialchars($this->input->get_post("so_no")) ?>">
                </td>
                <td><input name="prod_sku" class="input"
                           value="<?= htmlspecialchars($this->input->get_post("prod_sku")) ?>"></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <!--        <td>&nbsp;</td> -->
                <td align="center"><input type="submit" name="searchsubmit" value=""
                                          onClick="checkall(document.fm, this, 0);" class="search_button"
