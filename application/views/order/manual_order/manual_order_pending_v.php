        ...
        if ($objlist) :
            foreach ($objlist as $obj) :
                ...
                <tr class="row<?= $i % 2 ?>">
                    ...
                    <td align='center'>
                        <input type="button" value="<?= $lang["previous"] ?>"
                                  onClick="if(confirm('<?= $lang["move_back_to_hold"] ?>'))Proc('<?= $obj->getSoNo() ?>', 'b');">
                        &nbsp; &nbsp;
                        <input type="button" value="<?= $lang["process"] ?>"
                                  onClick="if(confirm('<?= $lang["approve_order"] ?>'))Proc('<?= $obj->getSoNo() ?>', 'p');">
                    </td>
