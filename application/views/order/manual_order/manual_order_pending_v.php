...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
    <col width="20"><col width="100"><col><col><col width="120"><col width="230"><col width="26">
    <tr class="header">
...
?>
    ...
    <tr class="row<?=$i%2?>">
        ...
        <td align='center'><input type="button" value="<?=$lang["previous"]?>" onClick="if(confirm('<?=$lang["move_back_to_hold"]?>'))Proc('<?=$obj->get_so_no()?>', 'b');"> &nbsp; &nbsp;<!--input type="button" value="<?=$lang["cc_hold"]?>" onClick="Proc('<?=$obj->get_so_no()?>', 'c');"--> &nbsp; &nbsp;<input type="button" value="<?=$lang["process"]?>" onClick="if(confirm('<?=$lang["approve_order"]?>'))Proc('<?=$obj->get_so_no()?>', 'p');"></td>
