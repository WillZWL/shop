...
<div id="main">
    ...
    <iframe src="<?=base_url()."order/amend_supplier_order/view_right/".$po_number?>" noresize frameborder="0" name="right" id="right" marginwidth="0" marginheight="0" height="600" hspace=0 vspace=0 width="1058" style="float:left;border-left:1px solid #999999;" onLoad="SetFrameFullHeight(this)"></iframe>
<div>
</body>
</html>