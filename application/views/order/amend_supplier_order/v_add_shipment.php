...
<tr class="header2">
    <td style="padding-left:10px;"><font style="color:#ffffff; font-weight:bold; font-size:12px;"><?=$lang["order_detail"]?></font></td>
</tr>
<table>
...
<table border="0" cellspacing="1" cellpadding="0" width="100%" class="tb_list">
<tr>
    <td align="left" style="padding-left:20px;"><input type="button" value="<?=$lang["back"]?>" onClick="parent.location.href = '<?=base_url()."order/amend_supplier_order/index/"?>';" class="button"></td>
