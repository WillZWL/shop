...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        ...
        <td width="400" align="right" class="title"><input type="button" value="<?=$lang["add_button"]?>" class="button" onclick="Redirect('<?=site_url('order/amend_supplier_order/add/')?>')"></td>
    </tr>
    <tr>
...
<table border="0" cellpadding="0" cellspacing="1" bgcolor="#000000" width="100%" class="tb_pad">
    <col width="20"><col width="170"><col width="170"><col width="200"><col width="150"><col width="100"><col width="150"><col>
    <tr class="header">
        ...
        <td><a href="#" onClick="SortCol(document.fm, 'eta', '<?=$xsort["eta"]?>')"><?=$lang["eta"]?> <?=$sortimg["eta"]?></a></td>
        <td></td>
    </tr>
...
?>
    <tr class="row<?=$i%2?>" onMouseOver="AddClassName(this, 'highlight')" onMouseOut="RemoveClassName(this, 'highlight')" class="pointer" >
        ...
        <td><input type="button" value="View PO Detail" OnClick="Redirect('<?=site_url('order/amend_supplier_order/view/'.$po->get_po_number())?>')" <?=($po->get_status() == "CL"?"DISABLED":"")?>></td>
    </tr>
    <tr class="detail">
...
<br/><input type="hidden" name="pm_number" value="<?=$po->get_po_number()?>"><input type="hidden" name="add_message" value="1"><input type="button" value="<?=$lang["submit_message"]?>" onClick="if(CheckForm(this.form)) this.form.submit();"></form>
        </td>
    </tr>
<?php
                $i++;
