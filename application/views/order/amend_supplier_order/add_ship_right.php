...
<form name="fm" action="<?=base_url()?>order/amend_supplier_order/view_ship/<?=$po_obj->get_po_number()?>" method="POST" onSubmit="CheckForm(this);" target="_parent">
...
<?php
				...
				{
?>
	<td class="value" rowspan="<?=$row?>"><a href="<?=base_url()?>order/amend_supplier_order/gen_shipment_csv/<?=$shipment_id?>" target="csv_frame"><?=$shipment_id?></a></td>
<?php
				}
?>
