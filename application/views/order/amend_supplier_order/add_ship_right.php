...
<div id="main" style="width:auto;">
    ...
    <form name="fm" action="<?= base_url() ?>order/amend_supplier_order/view_ship/<?= $po_obj->get_po_number() ?>"
                ...
                <tr>
                    ...
                    if (!$key) {
                        ...
                        <td class="value" rowspan="<?= $row ?>"><a
                                href="<?= base_url() ?>order/amend_supplier_order/gen_shipment_csv/<?= $shipment_id ?>"
