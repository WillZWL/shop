    ...
    <form name="fm" method="get">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
            ...
            <tr class="header">
                ...
                <td><a href="#"
                       onClick="SortCol(document.fm, 'sub_category', '<?= $xsort["sub_category"] ?>')"><?= $lang["sub_cat"] ?> <?= $sortimg["sub_category"] ?></a>
                </td>
                <td><a href="#"
                       onClick="SortCol(document.fm, 'sub_sub_category', '<?= $xsort["sub_sub_category"] ?>')"><?= $lang["sub_sub_cat"] ?> <?= $sortimg["sub_sub_category"] ?></a>
                </td>
                <td><a href="#"
