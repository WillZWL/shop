...
<head>
    ...
    <script>
        ...
        function populateSoData(client_id) {
            var url = "<?php print base_url() . 'order/special_order/find_all_so_by_email/'; ?>" + client_id;
...
<div id="main">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td width="650" align="right" class="title"><input type="button" value="<?= $lang["add_button"] ?>"
                                                               class="button"
        ...
        <tr>
            ...
            <td align="right" style="padding-right:8px">
                ...
                <select style="width:100px"
                        onChange="Redirect('<?= base_url() ?>order/special_order/index/'+this.value);">
                    <option></option>
                    <?php
            ...
            <td align="right" style="padding-right:8px">
                ...
                <select style="width:250px" <?= $platform_type ? "" : "disabled" ?>
                        onChange="Redirect('<?= base_url() ?>order/special_order/index/<?= $platform_type ?>/'+this.value)">
                    <option></option>
                    <?php
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="bg_row">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input name="soi[<?= $i ?>][name]" value="<?= htmlspecialchars($_POST["soi"][$i]["name"]) ?>" style="width:60%" READONLY onKeyUp="calcTotal()"> <a href="<?= base_url() ?>order/special_order/prod_list/<?= $i ?>/<?= $platform_id ?>" rel="lyteframe" rev="width: 1024px; height: 400px; scrolling: auto;" title="Select Product" class="search_button" style="background: url('<?= base_url() ?>images/find.gif') no-repeat;">&nbsp; &nbsp; &nbsp;</a> x <input name="soi[<?= $i ?>][qty]" value="<?= htmlspecialchars($_POST["soi"][$i]["qty"]) ?>" class="int_input" onKeyUp="calcTotal()"> &nbsp; <?= $lang["price"] ?>: <input name="soi[<?= $i ?>][price]" value="<?= htmlspecialchars($_POST["soi"][$i]["price"]) ?>" class="int_input" onKeyUp="calcTotal()">
                    </td>
                </tr>
                    </td>
                </tr>
                                ...
                                <td width="50%">
                                    <table cellpadding="4" cellspacing="0" width="100%" class="bg_row">
                                        <tr>
                                            ...
                                            <td>
                                                <input name="client[email]" dname="Email Address" class="text"
                                                       value="<?= htmlspecialchars($_POST["client"]["email"]) ?>"
                                                       notEmpty validEmail> <input type="button" value="Check Email"
                                                                                   onClick="if (document.fm_checkout.elements['client[email]'].value != '') {document.getElementById('a_check').href='<?= base_url() ?>/order/special_order/check_email/'+document.fm_checkout.elements['client[email]'].value;document.getElementById('a_check').onclick()}">
                                                <a id="a_check"
                                                   href="<?= base_url() ?>/order/special_order/check_email/"
                                        ...
                                        <tr>
                                            ...
                                            <td><input disabled name="client[delivery_company]" dname="Company"
                                                       class="text2"
                                                       value="<?= htmlspecialchars($_POST["client"]["delivery_company"]) ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input disabled name="client[delivery_name]" dname="First Name"
                                                       class="text2"
                                                       value="<?= htmlspecialchars($_POST["client"]["delivery_name"]) ?>"
                                                       notEmpty>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input disabled name="client[delivery_address_1]" dname="Address Line 1"
                                                       class="text"
                                                       value="<?= htmlspecialchars($_POST["client"]["delivery_address_1"]) ?>"
                                                       notEmpty>
                                                <input disabled name="client[delivery_address_2]" dname="Address Line 2"
                                                       class="text"
                                                       value="<?= htmlspecialchars($_POST["client"]["delivery_address_2"]) ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><span class="warn">*</span> City/Town:</td>
                                            <td>
                                                <input disabled name="client[delivery_city]" dname="City" class="text"
                                                       value="<?= htmlspecialchars($_POST["client"]["delivery_city"]) ?>"
                                                       notEmpty>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Postal Code:</td>
                                            <td>
                                                <input disabled name="client[delivery_postcode]" dname="Postcode"
                                                       class="text"
                                                       value="<?= htmlspecialchars($_POST["client"]["delivery_postcode"]) ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Telephone number:</td>
                                            <td>
                                                <input disabled name="client[tel_1]" dname="Telephone Country Code"
                                                       size="3"
                                                       value="<?= htmlspecialchars($_POST["client"]["tel_1"]) ?>"> -
                                                <input disabled name="client[tel_2]" dname="Telephone Area Code"
                                                       size="3"
                                                       value="<?= htmlspecialchars($_POST["client"]["tel_2"]) ?>"> -
                                                <input disabled name="client[tel_3]" dname="Telephone"
                                                       style="width:190px"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="so_extend[order_reason]" id="order_reason"
                                                        dname="Reason For Order" notEmpty>
                                                    <option value=""></option>
                                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="so_extend[notes]" class="input"
                                                       value="<?= htmlspecialchars($_POST["so_extend"]["notes"]) ?>"
                                                       maxLen="255" style="width:250px;">
                                            </td>
                                        </tr>
                                        <tr>
        ...
        <script type="text/javascript">
            ...
            function calcTotal() {
                ...
                /*
                 for(var j=0; j<5; j++)
                 {
                 if(document.fm_checkout.elements["new_prod["+j+"][qty]"].value != "" && document.fm_checkout.elements["new_prod["+j+"][price]"].value != "")
                 {

                 var cur_price = document.fm_checkout.elements["new_prod["+j+"][qty]"].value * 1;
                 var cur_qty = document.fm_checkout.elements["new_prod["+j+"][price]"].value * 1;
                 var cur_subtotal = cur_qty * cur_price;
                 subtotal += cur_subtotal;
                <?php
                    if ($platform_id == "WSAU")
...
//  document.fm_checkout.vat.value = vat.toFixed(2);
            ...
            function response(str) {
                ...
                fm.elements['client[delivery_address_1]'].value = client["delivery_address_1"];
