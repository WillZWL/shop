...
<table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
    ...
    <tr>
        ...
        <td align="right" style="padding-right:8px">
            ...
            <select style="width:100px" onChange="Redirect('<?=base_url()?>order/special_order/index/'+this.value);">
                <option></option>
                <?php
        ...
        <td align="right" style="padding-right:8px">
            <?=$lang["selling_platform"]?>:
            <select style="width:250px" <?=$platform_type?"":"disabled"?> onChange="Redirect('<?=base_url()?>order/special_order/index/<?=$platform_type?>/'+this.value)">
                <option></option>
                <?php
        ...
        <td width="50%">
            <table cellpadding="4" cellspacing="0" width="100%" class="bg_row">
                <tr>
                    ...
                    <td>
                            <input name="client[email]" dname="Email Address" class="text" value="<?=htmlspecialchars($_POST["client"]["email"])?>" notEmpty validEmail> <input type="button" value="Check Email" onClick="if (document.fm_checkout.elements['client[email]'].value != '') {document.getElementById('a_check').href='<?=base_url()?>/order/special_order/check_email/'+document.fm_checkout.elements['client[email]'].value;document.getElementById('a_check').onclick()}"> <a id="a_check" href="<?=base_url()?>/order/special_order/check_email/" rel="lyteframe" rev="width: 300px; height: 275px; scrolling: auto;" title="Check Email"></a>
                ...
                <tr>
                    ...
                    <td><input disabled name="client[delivery_company]" dname="Company" class="text2" value="<?=htmlspecialchars($_POST["client"]["delivery_company"])?>"></td>
                </tr>
                <tr>
