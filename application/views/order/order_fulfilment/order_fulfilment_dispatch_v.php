        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
            ...
            <tr class="header">
                ...
                <td title="<?= $lang["warehouse"] ?>"><a href="#"
                                                         onClick="SortCol(document.fm, 'warehouse_id', '<?= $xsort["warehouse_id"] ?>')"><?= $lang["wh"] ?> <?= $sortimg["warehouse_id"] ?></a>
                </td>
                <!--        <td title="<?= $lang["shipment_no"] ?>"><a href="#" onClick="SortCol(document.fm, 'warehouse_id', '<?= $xsort["sh_no"] ?>')"><?= $lang["ship_no"] ?> <?= $sortimg["sh_no"] ?></a></td> -->
                <td title="<?= $lang["tracking_no"] ?>"><a href="#"
        ...
        if ($objlist) {
            ...
            foreach ($objlist as $obj) {
                ...
                <tr name="row<?= $i ?>" class="<?= $row_style ?>"<?= $row_span ?>
                    ...
                    <td<?= $row_span ?> align="center"><input type="checkbox" name="check[<?= $obj->get_sh_no() ?>]"
                ...
                <td align="right" style="padding-right:8px;">
                    ...
                    <input type="button" value="<?= $lang['import_trackingfile'] ?>"
                           onClick="document.getElementById('a_check').onclick();"> <a id="a_check"
                                                                                       href="<?= base_url() ?>order/order_fulfilment/import_trackingfile"
                                                                                       rel="lyteframe"
