...
<table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
	<col width="10%"><col width="30%"><col width="10%"><col width="15%">
	<tr>
		...
		<td>
			...
			<img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.getElementById('orderstart'), false, false, false, '2010-01-01')" align="absmiddle">
		</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		...
		<td>
			...
			<img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.getElementById('orderend'), false, false, false, '2010-01-01')" align="absmiddle">
		</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			<img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.getElementById('cbstart'), false, false, false, '2010-01-01')" align="absmiddle">
		</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		...
		<td>
			...
			<img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.getElementById('cbend'), false, false, false, '2010-01-01')" align="absmiddle">
		</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
