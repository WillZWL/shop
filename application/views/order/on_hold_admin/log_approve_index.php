    ...
    if ($objlist) {
        foreach ($objlist as $obj) {
            ...
            <tr class="row<?= $i % 2 ?>">
                ...
                <td align="center"><input type="button" value="<?= $lang["decline"] ?>"
                                          onClick="Redirect('<?= base_url() ?>order/on_hold_admin/log_decline/<?= $obj->get_so_no() ?>')">
                    <input type="button" value="<?= $lang["approve"] ?>"
                           onClick="Redirect('<?= base_url() ?>order/on_hold_admin/log_approve/<?= $obj->get_so_no() . "/" . $reason ?>')">
                </td>
                <td></td>
            </tr>
            <tr class="row<?= $i % 2 ?>">
