...
?>
    ...
    <tr class="row<?=$i%2?>">
        ...
        <td align="center">
        <input type="button" value="<?=$lang["request_cc"]?>" onclick="Redirect('<?=base_url()."order/on_hold_admin/oc_request/".$obj->get_so_no()."/cscc"?>')" <?=$obj->get_reason() == "contacted"?"DISABLED":""?>>
