    ...
    if ($objlist) {
        foreach ($objlist as $obj) {
            ...
            <tr class="row<?= $i % 2 ?>">
                ...
                <td><?= $obj->get_email() ?></td>
                <td><?= $lang["password"] ?>: <a
                        href="<?= base_url() ?>order/manager_approval_page/chk_pw/?pw=<?= urlencode($obj->get_password()) ?>"
                ...
                <td align="center"><input type="button" value="<?= $lang["approve"] ?>"
                                          onClick="Redirect('<?= base_url() ?>order/manager_approval_page/approve/<?= $obj->get_so_no() ?>')">
                </td>
                <td></td>
            </tr>
            <tr class="row<?= $i % 2 ?>">
                ...
                <td align="left">
                    ...
                    <form action="<?= base_url() ?>order/manager_approval_page/hold/<?= $obj->get_so_no() ?>"
                          method="post">
