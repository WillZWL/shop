...
<div id="main" <?= $viewtype == "" ? "" : "style='width:1004px;'" ?> class="bp">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td class="title" align="right"><input type="button" value="<?= $lang["list_button"] ?>" class="button"
                                                   onclick="Redirect('<?= site_url('order/rma/') ?>')"></td>
        </tr>
        <tr>
    ...
    if (!$so_obj) {
        ...
        <table border="0" cellpadding="0" cellspacing="1" bgcolor="#BBBBFF" width="100%" id="maintb">
            <tr>
                <td style="padding-left:8px" class="header1"><b style="font-size:11px;color:#000000"></b>Invalid So
                    Number: <?= $rma_obj->get_so_no() ?></td>
            </tr>
        </table>
        <?php
        exit;
    ...
    <table border="0" cellpadding="0" cellspacing="1" bgcolor="#BBBBFF" width="100%" id="maintb">
        <tr>
            <td style="padding-left:8px" class="header1"><b
                    style="font-size:11px;color:#000000"><?= $lang["purchase_detail"] ?></b></td>
        </tr>
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                    ...
                    <tr>
                        ...
                        <td colspan="3" align="left" class="value1"><a
                                href="<?= base_url() . '/cs/quick_search/view/' . $rma_obj->get_so_no(); ?>"
                                target="quick_search"><?= implode("-", array($rma_obj->get_client_id(), $rma_obj->get_so_no())); ?></a>
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td style="padding-left:8px" class="header2"><b
                    style="font-size:11px;color:#000000"><?= $lang["personal_detail"] ?></b></td>
        </tr>
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                    <tr>
                        ...
                        <td width="35%" align="left"
                            class="value2"><?= implode(" ", array($rma_obj->get_forename(), $rma_obj->get_surname())); ?></td>
        ...
        <tr>
            <td style="padding-left:8px" class="header3"><b
                    style="font-size:11px;color:#000000"><?= $lang["product_detail"] ?></b>&nbsp;&nbsp;</td>
        </tr>
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
        ...
        <tr>
            <td style="padding-left:8px" class="header4"><b
                    style="font-size:11px;color:#ffffff"><?= $lang["return_detail"] ?></b>&nbsp;&nbsp;</td>
        </tr>
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                    ...
                    <tr>
                        ...
                        <td colspan="3" align="left"
                            class="value4"><?= $action_arr[$rma_obj->get_action_request()] ?></td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td style="padding-left:8px" class="header5"><b
                    style="font-size:11px;color:#000000"><?= $lang["remark"] ?></b></td>
        </tr>
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="1" border="0" bgcolor="#cccccc">
                    <tr bgcolor="#eeeeff">
                        <td width="15%" align="left" style="padding-left:8px;"
                            class="field5"><?= strtoupper($lang["order_notes"]) ?></td>
                        <td colspan="3" width="85%" align="left" class="value5">
                            <form action="<?= base_url() ?>order/rma/add_note/<?= $rma_obj->get_id() ?>" method="POST">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="1" border="0"
                                            ...
                                            foreach ($rma_notes_obj as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <i><?= $lang["create_by"] . " " . $obj->get_modify_by() ?></i>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <i><?= $lang["create_on"] . " " . $obj->get_modify_on() ?></i>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php
                                ...
                                <div><b><?= $lang["create_note"] ?></b><br><input type="text" name="note" class="input"><input
                                        type="hidden" name="addnote" value="1"><br><input type="button"
                                                                                          value="<?= $lang["add_note"] ?>"
                    ...
                    <tr bgcolor="#eeeeff">
                        <td width="15%" align="left" style="padding-left:8px"
                            class="field5"><?= strtoupper($lang["order_status"]) ?></td>
                        <td colspan="3" width="85%" align="left" class="value5">
                            <form action="<?= base_url() ?>order/rma/update_rma_status/<?= $rma_obj->get_id() ?>"
                                  method="POST">
                                <div style="width:100%; height:100px; overflow-y:scroll">
                                    <?php
                                ...
                                <div>
                                    ...
                                    <input type="button" value="<?= $lang["update_status"] ?>"
                                           onClick="this.form.submit();">
                            </form>
                        </td>
                    </tr>
