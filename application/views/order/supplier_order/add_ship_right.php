    ...
    <form name="fm" action="<?= base_url() ?>order/supplier_order/view_ship/<?= $po_obj->get_po_number() ?>"
        ...
        <table border="0" cellpadding="0" cellspacing="1" width="100%" class="tb_list">
            ...
            <tr>
                ...
                <td class="value"><span id="scurr"><?= $po_obj->get_currency() ?></span>&nbsp;<span
            ...
            <table>
                <table border="0" cellspacing="1" cellpadding="0" width="100%" id="order_form" class="tb_list">
                    ...
                    <tr class="header2">
                        ...
                        foreach ($wh_list as $wobj) {
                            ?>
                            <td class="offield" onclick="qtyMoveHere(this)">
                                <span><?= $lang["ship_to"] . " " . $wobj->get_id() ?></span></td>
                        <?php
                        }
                        ?>
                    ...
                    foreach ($po_item_list as $obj) {
                        ...
                        <tr>
                            ...
                            <td class="value"><input class='order_qty' type="text" name="qty[]"
                                                     value="<?= $obj->get_order_qty() ?>" class="input"
                                                     onKeyUp="calculatePrice();" isInteger
                            ...
                            foreach ($wh_list as $wobj) {
                                ?>
                                <td class="value">
                                    <input name="<?= strtolower($wobj->get_id()) ?>[]" type="text" value="0"
                                           class="input dynamic_move_qty" data=<?= $wh_cnt ?> isInteger
                ...
                <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#333333">
                    <tr height="25">
                        ...
                        <td align="right"><font
                                style="color:#ffffff; font-weight:bold; font-size:11px;"><?= $lang["courier"] ?><select
                                    name="courier">
                                    <option value=""></option>
                                ...
                                </select>&nbsp;&nbsp;<?= $lang["tracking_no"] ?>&nbsp;<input type="text"
                                                                                             name="tracking_no"
                                                                                             value="<?= $this->input->post("tracking_no") ?>"></font>
                        </td>
        ...
        foreach ($shipment_info as $obj) {
            ...
            foreach ($info as $key => $value) {
                ...
                <tr>
                    ...
                    if (!$key) {
                        ?>
                        <td class="value" rowspan="<?= $row ?>"><a
                                href="<?= base_url() ?>order/supplier_order/gen_shipment_csv/<?= $shipment_id ?>"
                                target="csv_frame"><?= $shipment_id ?></a></td>
                    <?php
                    }
                    ?>
