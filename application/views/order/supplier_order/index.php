    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td width="400" align="right" class="title"><input type="button" value="<?= $lang["add_button"] ?>"
                                                               class="button"
                                                               onclick="Redirect('<?= site_url('order/supplier_order/add/') ?>')">
            </td>
        </tr>
        <tr>
                ...
                foreach ($purchase_order_list as $po) {
                    ...
                    <tr class="row<?= $i % 2 ?>" onMouseOver="AddClassName(this, 'highlight')"
                        ...
                        <td><input type="button" value="View PO Detail"
                                   OnClick="Redirect('<?= site_url('order/supplier_order/view/' . $po->get_po_number()) ?>')" <?= ($po->get_status() == "CL" ? "DISABLED" : "") ?>>&nbsp;&nbsp<input
                                type="button" value="View PO Shipment"
                                OnClick="Redirect('<?= site_url('order/supplier_order/view_ship/' . $po->get_po_number()) ?>')" <?= ($po->get_status() == "CL" ? "DISABLED" : "") ?>>
                        </td>
                    </tr>
                    <tr class="detail">
