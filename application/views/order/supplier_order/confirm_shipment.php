...
?>
		<td><?=$val_arr[1]?><input type="hidden" id="pon[<?=$i?>][<?=$step?>]" name="pon[<?=$i?>][<?=$step?>]" value="<?=$val_arr[0]?>"></td>
		<td><?=$val_arr[2]?><input type="hidden" id="linen[<?=$i?>][<?=$step?>]" name="linen[<?=$i?>][<?=$step?>]" value="<?=$val_arr[5]?>"><input type="hidden" name="trans[<?=$i?>][<?=$step?>]" value="<?=$val_arr[6]?>"></td>
		<td><?=$val_arr[3]?><input name="sq[<?=$i?>][<?=$step?>]" id="sq[<?=$i?>][<?=$step?>]" type="hidden" value="<?=$val_arr[3]?>"></td>
		<td><?=$val_arr[4]?></td>
		<td><input class="input" type="text" name="rqty[<?=$i?>][<?=$step?>]" id="rqty[<?=$i?>][<?=$step?>]" value="<?=$val_arr[3]?>" onKeyUp="checkQty('<?=$i?>','<?=$step?>')"></td>
...
<tr>
	<td align="right" style="padding-right:8px;">
		<input type="button" value="Download CSV" onClick="document.fm.action='<?=base_url()?>/order/supplier_order/download_csv/<?=$wh?>';document.fm.target='report';document.fm.submit();document.fm.action='';document.fm.target=''">
