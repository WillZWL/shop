...
<form name="fm" action='<?php print $_SERVER['PHP_SELF'];?>/export_csv' method="post" onSubmit="return CheckForm(this)">
...
<tr height="80">
	...
	<tr>
		<td><input type='checkbox' name="check[order_create]" value='1' checked><b>Order Create Date</b></td>
		<td><b>From</b></td>
	...
	<tr>
		<td colspan="10" align="right" style="padding-top:5px; padding-right:8px;"><input type="button" value="Export CSV" class="button3" onClick="if (CheckForm(this.form)){this.form.submit();}"></td>
	</tr>
