...
<table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
    <tr>
        <td height="70" style="padding-left:8px"><b style="font-size:14px">Freight Cost(<?=$origin_country?>) <?=$lang["header"]?></b><br><?=$lang["header_message"]?>
        </td>
    </tr>
</table>
...
<?php
    ...
    <tr>
        ...
        <td nowrap style="white-space:nowrap;">
            ...
            <input name="value[<?=$cur_cat_id?>][<?=$country_id?>]" class="int_input" value="<?=$fcc_obj->get_amount()?>" notEmpty isNumber min=0>
        </td>
        <?php
                }
            }
