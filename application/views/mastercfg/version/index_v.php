    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td width="400" align="right" class="title"><input type="button" value="<?= $lang["show_all_cc"] ?>"
                                                               class="button"
                                                               onclick="Redirect('<?= site_url('mastercfg/version/') ?>')">
            </td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" height="70" class="tb_list" width="100%">
        ...
        <form name="fm" method="get">
            <tr class="header">
                ...
                <td><a href="#"
                       onClick="SortCol(document.fm, 'desc', '<?= $xsort["desc"] ?>')"><?= $lang["name"] ?></a> <?= $sortimg["desc"] ?>
                </td>
                <td><a href="#"
            ...
            foreach ($vlist as $obj) {
                if ($obj->get_id() != $eid || $edit != 1) {
                    ...
                    <tr class="row<?= $i++ % 2 ?> pointer" onMouseOver="AddClassName(this, 'highlight')"
                        ...
                        onClick='Redirect("<?= base_url() . "mastercfg/version/index/1/" . $obj->get_id() . "/?" . $_SERVER["QUERY_STRING"] ?>");'>
                ...
                <?php
                    ...
                    ?>
                    <form name="fm_edit" action="<?= base_url() . "mastercfg/version/?" . $_SERVER["QUERY_STRING"] ?>"
                        ...
                        <tr class="row<?= $i++ % 2 ?>">
                            ...
                            <td><input name="posted" type="hidden" value="1"><input name="action" type="hidden"
                                    ...
                                    onClick='Redirect("<?= base_url() . "mastercfg/version/?" . $_SERVER["QUERY_STRING"] ?>");'
                                    class="button"></td>
                        </tr>
                    </form>
                <?php
