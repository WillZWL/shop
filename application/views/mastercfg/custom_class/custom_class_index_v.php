...
?>
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
        ...
        <form name="fm_add" action="<?= base_url() ?>mastercfg/custom_class/add/?<?= $_SERVER['QUERY_STRING'] ?>"
                    ...
                    if ($is_edit) :
                        ...
                        <form name="fm_edit"
                            ...
                            <td align="center"><input type="submit" value="<?= $lang["update"] ?>"> &nbsp; <input
                                    ...
                                    onClick="Redirect('<?= site_url('mastercfg/custom_class/index/' . $country_id) ?>?<?= $_SERVER['QUERY_STRING'] ?>')">
                            </td>
                        </form>
                    <?php
                    else :
