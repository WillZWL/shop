    ...
    <form action="<?= $_SERVER["PHP_SELF"] ?>" method="post" name="tform" style="padding:0; margin:0">
        ...
        <table border="0" cellpadding="0" cellspacing="1" height="20" class="tb_list" width="100%">
            ...
            <tr>
                ...
                <td height="20" class="value">&nbsp;&nbsp;<input type="text" name="in_stock"
                                                                 value="<?= $profit_obj->get_latency_in_stock() ?>"
                                                                 style="font-size:11px;width:60px" <?= (!$editable ? "readonly" : "") ?>>
                </td>
            </tr>
            <tr>
                <td width="150" class="field">&nbsp;&nbsp;<?= $lang["out_of_stock"] ?></td>
                <td height="20" class="value">&nbsp;&nbsp;<input type="text" name="out_of_stock"
                                                                 value="<?= $profit_obj->get_latency_out_of_stock() ?>"
                                                                 style="font-size:11px;width:60px" <?= (!$editable ? "readonly" : "") ?>>
                </td>
            </tr>
        </table>
