...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="page_header">
    <tr height="70">
        ...
        <td align="right">
            ...
            <col width="320"><col width="80"><col width="100"><col width="100"><col width="40">
                <tr align='right'>
                    ...
                    <td rowspan="2">
                        ...
                        ?>
                            ...
                            <option value="worldpay_moto" <?=$selected_gw["worldpay_moto"]?>><?=$lang["worldpay_moto"]?>
                            ...
                            <option value="moneybookers" <?=$selected_gw["moneybookers"]?>><?=$lang["moneybookers"]?>
                    ...
                    <td>
                        <input name="start_date" value='<?=htmlspecialchars($start_date)?>' notEmpty><img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.fm.start_date, false, false, false, '2012-05-01')" align="absmiddle">
                    </td>
