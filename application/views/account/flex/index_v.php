...
<form name="fm" action="<?=base_url()."account/flex/sales"?>" method="post" target="_self">
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="page_header">
    <tr height="70">
        ...
        <td align="right">
            ...
            <col width="500"><col width="100"><col width="40">
                <tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
    <col width="26"><col width="70"><col><col width="26">
    <tr class="header">
        <td height="20"></td>
        <td><?=$lang["date"]?></a></td>
        <td><?=$lang["filename"]?></td>
