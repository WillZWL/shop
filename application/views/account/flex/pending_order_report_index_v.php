		...
		<td align="right">
			<table border="0" cellpadding="2" cellspacing="0">
				<tr align='right'>
					...
					<td><input name="ship_date" value='<?=htmlspecialchars($ship_date)?>' notEmpty><img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.fm.ship_date, false, false, false, '2010-01-01')" align="absmiddle"></td>
					<td rowspan="2" align="right"><input type="submit" value="" class="search_button" style="background: url('<?=base_url()?>/images/find.gif') #CCCCCC no-repeat center; width: 30px; height: 25px;"> &nbsp; </td>
				</tr>
			</table>
		</td>
	</tr>
