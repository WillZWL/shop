...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<td width="400" align="right" class="title">
			...
			-->
			<input type="button" value="<?=$lang["download_batch"]?>" class="button" onclick="Redirect('<?=site_url('account/gateway_report')?>')">&nbsp&nbsp
		</td>
	</tr>
	<tr>
...
<table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
	<tr>
		<td height="70" style="padding-left:8px"><b style="font-size:14px"><?=$lang["header"]?></b><br><?=$lang["header_message"]?><br>
			<?=$lang["pmgw"]?> :
			<select name="country_id" onChange="Redirect('<?=base_url()?>account/gateway_report/upload/'+this.value)">
				<option value=""></option>
				...
				<option value="paypal_hk" <?=$pmgw == "paypal_hk"?"SELECTED":""?>><?=$lang["paypal_hk"]?></option>
				...
				<option value="paypal_nz" <?=$pmgw == "paypal_nz"?"SELECTED":""?>><?=$lang["paypal_nz"]?></option>
				<option value="inpendium" <?=$pmgw == "inpendium"?"SELECTED":""?>><?=$lang["inpendium"]?></option>
				<option value="moneybookers" <?=$pmgw == "moneybookers"?"SELECTED":""?>><?=$lang["moneybookers"]?></option>
				<option value="trademe" <?=$pmgw == "trademe"?"SELECTED":""?>><?=$lang["trademe"]?></option>
				<option value="global_collect" <?=$pmgw == "global_collect"?"SELECTED":""?>><?=$lang["global_collect"]?></option>
				...
				<option value="newegg_us" <?=$pmgw == "newegg_us"?"SELECTED":""?>><?=$lang["newegg_us"]?></option>
