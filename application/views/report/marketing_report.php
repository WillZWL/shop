...
<div id="main">
                            ...
                            <td><b><?= $lang["day"] ?>
                                    ...
                                    <select name="from_hour">
                                        ...
                                        for ($i = 0; $i <= 23; $i++) {
                                            ?>
                                            <option
                                                value="<?php echo ($i < 10) ? "0$i" : "$i";?><?php echo ":00:00";?>" <?php echo ($i == 0) ? "selected" : "";?>>
                                                <?php echo $i;?>
                                            </option>
                                        <?php
                                        }
                                ...
                                <b><?= $lang["day"] ?>
                                    ...
                                    <select name="to_hour">
                                        ...
                                        for ($i = 0; $i <= 23; $i++) {
                                            ?>
                                            <option
                                                value="<?php echo ($i < 10) ? "0$i" : "$i";?><?php echo ":59:59";?>" <?php echo ($i == 23) ? "selected" : "";?>>
                                                <?php echo $i;?>
                                            </option>
                                        <?php
                                        }
    ...
    <iframe name="report" id="report" src="<?= base_url() ?>report/marketing_report/query" width="1259"
