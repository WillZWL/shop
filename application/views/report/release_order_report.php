...
<div id="main">
    ...
    <form name="fm" action='<?= base_url() . "report/order_release_report/export_csv"; ?>' method="post"
    ...
    <form name="fm_2" action='<?= base_url() . "report/order_release_report/index"; ?>' method="post"
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list" style="text-align:center">
        ...
        <form name="fm_3" method="get" onSubmit="return CheckForm(this)">
            <tr class="header">
                <td height="20"></td>
                <td><a href="#"
                       onClick="SortCol(document.fm_3, 'roh.so_no', '<?= $xsort["roh.so_no"] ?>')"><?= $lang["order_number"] ?><?= $sortimg["roh.so_no"] ?></a>
                </td>
                <td><a href="#"
                       onClick="SortCol(document.fm_3, 'sohr.reason', '<?= $xsort["sohr.reason"] ?>')"><?= $lang["hold_reason"] ?> <?= $sortimg["sohr.reason"] ?></a>
                </td>
                <td><a href="#"
                       onClick="SortCol(document.fm_3, 'sohr.create_on', '<?= $xsort["sohr.create_on"] ?>')"><?= $lang["hold_date"] ?><?= $sortimg["sohr.create_on"] ?></a>
                </td>
                <td><a href="#"
                       onClick="SortCol(document.fm_3, 'sohr.create_by', '<?= $xsort["sohr.create_by"] ?>')"><?= $lang["hold_by"] ?><?= $sortimg["sohr.create_by"] ?></a>
                </td>
                <td><a href="#"
                       onClick="SortCol(document.fm_3, 'roh.release_reason', '<?= $xsort["roh.release_reason"] ?>')"><?= $lang["release_reason"] ?><?= $sortimg["roh.release_reason"] ?></a>
                </td>
                <td><a href="#"
                       onClick="SortCol(document.fm_3, 'roh.create_on', '<?= $xsort["roh.create_on"] ?>')"><?= $lang["release_date"] ?><?= $sortimg["roh.create_on"] ?></a>
                </td>
                <td><a href="#"
                       onClick="SortCol(document.fm_3, 'roh.create_at', '<?= $xsort["roh.create_at"] ?>')"><?= $lang["release_at"] ?><?= $sortimg["roh.create_at"] ?></a>
                </td>
                <td><a href="#"
                       onClick="SortCol(document.fm_3, 'roh.create_by', '<?= $xsort["roh.create_by"] ?>')"><?= $lang["release_by"] ?><?= $sortimg["roh.create_by"] ?></a>
                </td>
                <td></td>
            </tr>
            <tr class="search" id="tr_search" <?= $searchdisplay ?>>
                ...
                <td><input name="hold_reason" type="text" class="input" value="<?= $this->input->get("hold_reason") ?>">
                </td>
                <td><input name="hold_date" type="text" class="input" value="<?= $this->input->get("hold_date") ?>">
                </td>
                <td><input name="hold_by" type="text" class="input" value="<?= $this->input->get("hold_by") ?>"></td>
                <td><input name="release_reason" type="text" class="input"
                           value="<?= $this->input->get("release_reason") ?>"></td>
                <td><input name="release_date" type="text" class="input"
                           value="<?= $this->input->get("release_date") ?>"></td>
                <td><input name="release_at" type="text" class="input" value="<?= $this->input->get("release_at") ?>">
                </td>
                <td><input name="release_by" type="text" class="input" value="<?= $this->input->get("release_by") ?>">
                </td>
