                ...
                <td colspan='3'>
                    <select name="country_id"
                        ...
                        foreach ($country_list as $country_obj) {
                            ?>
                            <option
                                value="<?= $country_obj->get_id() ?>" <?= $country_id == $country_obj->get_id() ? "SELECTED" : "" ?>><?= $country_obj->get_id() ?>
                                - <?= $country_obj->get_name() ?></option>
                        <?php
                        }
                        ?></select>
                </td>
                ...
                <td colspan='3'>
                    <select name="competitor_id">
                        ...
                        foreach ($all_competitors_list as $competitor_obj) {
                            ?>
                            <option
                                value="<?= $competitor_obj->get_id() ?>" <?= $this->input->get("competitor_id") == $competitor_obj->get_id() ? "SELECTED" : "" ?>><?= $competitor_obj->get_competitor_name() ?></option>
                        <?php
                        }
                        ?></select>
                </td>
