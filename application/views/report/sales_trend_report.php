    ...
    <div class="panel panel-default">
        ...
        <form id="search" role="form" class="form panel-body">
            ...
            <div class="top my-group">
                ...
                <span>or</span>
                <textarea class="form-control" name="ext_sku" placeholder="Master SKU, separated by new line"
                          rows="3"></textarea>
                <span>or</span>
                <textarea class="form-control" name="prod_sku" placeholder="Local SKU, separated by new line"
                          rows="3"></textarea>
            </div>
...
<script type="text/javascript"
        src="//cdnjs.cloudflare.com/ajax/libs/datatables/1.10.0/js/jquery.dataTables.min.js"></script>
<script type="text/javascript"
