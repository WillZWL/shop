...
<tr>
	<td align="left" class="title" height="30" width="650"><b style="font-size: 16px; color: rgb(0, 0, 0);"><?=$lang["title_split_orders"]?></b></td>
...
<form name="fm"  action="<?=base_url()?>report/sales_report/split_orders_report" method="post" target="report">
	...
	<tr height="70">
		<td align="left" style="padding-left:8px;"><b style="font-size: 14px; color: rgb(0, 0, 0);"><?=$lang["header_split_orders"]?></b><br><?=$lang["header_message"]?></td>
		<td align="left">
		<table border="0" cellpadding="2" cellspacing="0">
		<col width="100"><col width="200"><col width="100">
		<tr>
			<td align='right'><b><?=$lang["start_date"]?></b></td>
			<td><input name="start_date" value='<?=htmlspecialchars($start_date)?>' notEmpty><img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.fm.start_date, false, false, false, '2012-05-01')" align="absmiddle">
			</td>
		...
		<tr>
			...
			<td>
				<input name="end_date" value='<?=htmlspecialchars($end_date)?>' notEmpty><img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.fm.end_date, false, false, false, '2010-01-01','<?=$today?>')" align="absmiddle">
