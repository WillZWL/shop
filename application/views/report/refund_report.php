...
<tr height="80">
    ...
    <tr>
        <td><input id="check_order_create" type='checkbox' name="check[order_create]" value='1'><b>Order Create Date</b></td>
        <td><b><?=$lang["start_date"]?></b></td>
        <td><input id="oc_start_date" name="start_date[order_create]" value='<?=htmlspecialchars($start_date)?>'><img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.fm.oc_start_date, false, false, false, '2012-05-01')" align="absmiddle"></td>
        <td></td>
        <td><b><?=$lang["end_date"]?></b></td>
        <td><input id="oc_end_date" name="end_date[order_create]" value='<?=htmlspecialchars($end_date)?>'><img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.fm.oc_end_date, false, false, false, '2010-01-01','<?=$today?>')" align="absmiddle"></td>
        <td></td>
    </tr>
    <tr>
        <td><input id="check_cs_request" type='checkbox' name="check[cs_request]" value='1'><b>CS Request Refund Date</b></td>
        <td><b><?=$lang["start_date"]?></b></td>
        <td><input id="cs_start_date" name="start_date[cs_request]" value='<?=htmlspecialchars($start_date)?>'><img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.fm.cs_start_date, false, false, false, '2012-05-01')" align="absmiddle"></td>
        <td></td>
        <td><b><?=$lang["end_date"]?></b></td>
        <td><input id="cs_end_date" name="end_date[cs_request]" value='<?=htmlspecialchars($end_date)?>'><img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.fm.cs_end_date, false, false, false, '2010-01-01','<?=$today?>')" align="absmiddle"></td>
        <td></td>
    </tr>
    <tr>
        <td><input id="check_refund" type='checkbox' name="check[refund]" value='1' CHECKED><b>Refund Date</b></td>
        <td><b><?=$lang["start_date"]?></b></td>
        <td><input id="rf_start_date" name="start_date[refund]" value='<?=htmlspecialchars($start_date)?>'><img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.fm.rf_start_date, false, false, false, '2012-05-01')" align="absmiddle"></td>
        <td></td>
        <td><b><?=$lang["end_date"]?></b></td>
        <td><input id="rf_end_date" name="end_date[refund]" value='<?=htmlspecialchars($end_date)?>'><img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.fm.rf_end_date, false, false, false, '2010-01-01','<?=$today?>')" align="absmiddle"></td>
        <td></td>
    </tr>
    <!--
    <tr>
    ...
    <tr>
        <td colspan="10" align="right" style="padding-top:5px; padding-right:8px;">
            <b><font color="#ffffff" size="4" id="error_tip"></font> </b> <input type="button" value="<?=$lang["export_csv"]?>" class="button3" onClick="refundReportVerify();">
            <br/>
        </td>
    </tr>
