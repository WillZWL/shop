                ...
                <td align="right">
                    <table border="0" cellpadding="0" cellspacing="0" width="220">
                        ...
                        <tr>
                            ...
                            <td><input name="date_after" value='' size="10" notEmpty><img src="/images/cal_icon.gif"
                                                                                          class="pointer"
                                                                                          onclick="showcalendar(event, document.fm.date_after, false, false, false, '2010-01-01')"
                                                                                          align="absmiddle"></td>
