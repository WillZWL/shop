                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="340" style="line-height:8px;">
                        ...
                        <tr>
                            ...
                            <td><input name="start_date" value='<?= htmlspecialchars($start_date) ?>' notEmpty><img
                                    ...
                                    align="absmiddle"></td>
                            <td align="center" rowspan="2"><input type="button"
                                                                  value="<?= $lang["display_on_screen"] ?>"
                                                                  class="button"
                                                                  onClick="this.form.display_type.value='view';if (CheckForm(this.form)){this.form.submit();}"><br><br><input
                                    type="button" value="<?= $lang["download_as_csv"] ?>" class="button"
                                    onClick="this.form.display_type.value='csv';if (CheckForm(this.form)){this.form.submit();}">
                            </td>
                        </tr>
                        <tr>
