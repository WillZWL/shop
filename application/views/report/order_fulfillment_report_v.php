...
<tr height="70">
    ...
    <col><col width="140"><col width="80"><col width="200"><col width="40">
    <tr>

        <td align='right'><?=$lang["order_status"]?></td>
        <td>
            <select name='order_status' id='order_status' class="input">
                <option value='-1'><?=$lang["all"]?></option>
                <option value='1'><?=$lang["fulfilled"]?></option>
                <option value='0'><?=$lang["not_fulfilled"]?></option>

            </select>
        </td>
        <td align='right'><b><?=$lang["start_date"]?></b></td>
        <td>
            <input name="start_date" value='<?=$start_date?>' notEmpty><img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.fm.start_date, false, false, false, '2010-01-01')" align="absmiddle">
        </td>
    ...
    <tr>
        ...
        <td>
            <input name="end_date" value='<?=$end_date?>' notEmpty><img src="/images/cal_icon.gif" class="pointer" onclick="showcalendar(event, document.fm.end_date, false, false, false, '2010-01-01')" align="absmiddle">
        </td>
    </tr>
    </table>
    </td>
