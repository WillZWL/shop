    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td width="400" align="right" class="title"><input type="button" value="<?= $lang["list_button"] ?>"
                                                               class="button"
                                                               onclick="Redirect('<?= base_url() . $this->report_path ?>')">
            </td>
        </tr>
    ...
    <form name="fm" method="post">
        <table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
            ...
            <tr>
                ...
                <td style="padding-top:5px;"><input name="rec_date_from" id="rec_date_from"
                                                    value="<?= $now_date ?>"><img src="/images/cal_icon.gif"
                                                                                  class="pointer"
                                                                                  onclick="showcalendar(event, document.getElementById('rec_date_from'), false, false, false, '2010-01-01')"
                                                                                  align="absmiddle"></td>
            </tr>
            <tr>
                <td style="padding-top:5px;padding-right:8px" align="right"><b><?= $lang["rec_date_to"] ?></b></td>
                <td style="padding-top:5px;"><input name="rec_date_to" id="rec_date_to" value="<?= $now_date ?>"><img
                        src="/images/cal_icon.gif" class="pointer"
                        onclick="showcalendar(event, document.getElementById('rec_date_to'), false, false, false, '2010-01-01')"
                        align="absmiddle"></td>
            </tr>
            <tr>
                <td style="padding-top:5px;padding-right:8px" align="right"><b><?= $lang["order_date_from"] ?></b></td>
                <td style="padding-top:5px;"><input name="order_date_from" id="order_date_from" value=""><img
                        src="/images/cal_icon.gif" class="pointer"
                        onclick="showcalendar(event, document.getElementById('order_date_from'), false, false, false, '2010-01-01')"
                        align="absmiddle"></td>
            </tr>
            <tr>
                <td style="padding-top:5px;padding-right:8px" align="right"><b><?= $lang["order_date_to"] ?></b></td>
                <td style="padding-top:5px;"><input name="order_date_to" id="order_date_to" value=""><img
                        src="/images/cal_icon.gif" class="pointer"
                        onclick="showcalendar(event, document.getElementById('order_date_to'), false, false, false, '2010-01-01')"
                        align="absmiddle"></td>
            </tr>
            <tr>
                ...
                <td style="padding-top:5px;"><select name="bank_acc" id="bank_acc">
                        ...
                        foreach ($bank_acc_list as $bank_acc_obj) {
                            ?>
                            <option
                                value="<?= $bank_acc_obj->get_id() ?>"><?= htmlspecialchars($bank_acc_obj->get_acc_no()) ?></option>
                        <?php
                        }
            ...
            <tr>
                <td></td>
                <td style="padding-top:5px;padding-bottom:5px; padding-right:8px;" align="left"><input type="submit"
