...
<tr height="80">
    ...
    <tr>
        <td colspan="2" align="right" style="padding-top:5px; padding-right:8px;"><input type="button" value="<?=$lang["export_csv"]?>" class="button3" onClick="if (CheckForm(this.form)){this.form.submit();}"></td>
    </tr>
...
<?php
    ...
    if ($posted)
    {
        ...
        $url = base_url()."report/aftership_report/export_csv/{$start_date}/{$end_date}";
    }
?>
