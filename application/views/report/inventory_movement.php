...
<div id="main">
    ...
    <form name="fm" action="<?= base_url() . "report/inventory_movement/query" ?>" method="post" target="report"
                ...
                <td align="right">
                    <table border="0" cellpadding="0" cellspacing="0" width="340">
                        ...
                        <tr>
                            ...
                            <td><input name="end_date" class="input" value='' notEmpty><input type="hidden"
                                                                                              name="is_query" value="1">
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <iframe name="report" id="report" src="<?= base_url() ?>report/inventory_movement/query" width="1259"
