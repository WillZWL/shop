...
<div id="main">
    ...
    <form name="fm" action="<?= base_url() . "report/sales_comparison_by_period_report/query" ?>" method="post"
          target="report">
                ...
                <td align="right">
                    <table border="0" cellpadding="0" cellspacing="0" width="700" style="line-height:8px;">
                        ...
                        <tr>
                            ...
                            <td><input name="from_date1" value='<?= htmlspecialchars($start_date) ?>' notEmpty><img
                                    src="/images/cal_icon.gif" class="pointer"
                                    onclick="showcalendar(event, document.fm.from_date1, false, false, false, '2010-01-01')"
                                    align="absmiddle"></td>
                            <td><b><?= $lang["to_date1"] ?></b></td>
                            <td><input name="to_date1" value='<?= htmlspecialchars($end_date) ?>' notEmpty><img
                                    src="/images/cal_icon.gif" class="pointer"
                                    onclick="showcalendar(event, document.fm.to_date1, false, false, false, '2010-01-01')"
                                    align="absmiddle"></td>
    ...
    -->
                        <tr>
                            ...
                            <td><input name="from_date2" value='<?= htmlspecialchars($start_date) ?>' notEmpty><img
                                    src="/images/cal_icon.gif" class="pointer"
                                    onclick="showcalendar(event, document.fm.from_date2, false, false, false, '2010-01-01')"
                                    align="absmiddle"></td>
                            <td><b><?= $lang["to_date2"] ?></b></td>
                            <td><input name="to_date2" value='<?= htmlspecialchars($end_date) ?>' notEmpty><img
                                    src="/images/cal_icon.gif" class="pointer"
                                    onclick="showcalendar(event, document.fm.to_date2, false, false, false, '2010-01-01')"
                                    align="absmiddle"></td>
    ...
    <iframe name="report" id="report" src="<?= base_url() ?>report/sales_comparison_by_period_report/query" width="1259"
