            ...
            if (!empty($purchase_order_list)) {
                if ($total > 0) {
                    foreach ($purchase_order_list as $po) {
                        ...
                        <tr bgcolor="<?= $cur_color ?>" onmouseover="ChgBg(this, '#DDFFDD')"
                            onmouseout="ChgBg(this, '<?= $cur_color ?>')" class="pointer">
                        ...
                        <tr class="detail">
                            ...
                            <td align="left" style="padding-left:10px;" valign="top">
                                ...
                                <form method="post" onSubmit="return CheckForm(this);"><input type="text" name="message"
                                                                                              class="input"
                                                                                              maxlength="255" notEmpty>
                                    <br/><input type="hidden" name="pm_number"
                                                value="<?= $po->get_po_number() ?>"><input type="hidden"
                                                                                           name="add_message" value="1"><input
                                        type="button" value="<?= $lang["submit_message"] ?>" onClick="if(Chec
