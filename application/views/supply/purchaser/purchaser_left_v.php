...
?>
    ...
    <tr class="row<?=$i%2?> pointer" onMouseOver="AddClassName(this, 'highlight')" onMouseOut="RemoveClassName(this, 'highlight')" onClick="top.window.location.hash = '<?=$obj->get_sku()?>';parent.frames['pview'].document.location.href = '<?=site_url('supply/purchaser/view/'.$obj->get_sku())?>'">
