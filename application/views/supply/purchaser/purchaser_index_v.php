...
<div id="main">
    ...
    <iframe name="plist" id="plist" src="<?= base_url() ?>supply/purchaser/index/left/?<?= $_SERVER['QUERY_STRING'] ?>"
            width="250" style="float:left;border-right:1px solid #000000;" noresize frameborder="0" marginwidth="0"
            marginheight="0" hspace=0 vspace=0 onLoad="SetFrameFullHeight(this)"></iframe>
    <iframe name="pview" id="pview" src="" width="1009" style="float:left;border-left:1px solid #999999;" noresize
