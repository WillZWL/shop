...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
    <col width="20"><col width="40"><col><col width="85"><col width="200"><col width="200"><col width="100"><col width="100"><col width="27">
    <tr class="header">
        ...
        <td><a href="#" onClick="SortCol(document.fm, 'currency_id', '<?=$xsort["currency_id"]?>')"><?=$lang["currency"]?> <?=$sortimg["currency_id"]?></a></td>
        <td><a href="#" onClick="SortCol(document.fm, 'supplier_reg', '<?=$xsort["supplier_reg"]?>')"><?=$lang["supplier_region"]?> <?=$sortimg["supplier_reg"]?></a></td>
        <td><a href="#" onClick="SortCol(document.fm, 'sourcing_reg', '<?=$xsort["sourcing_reg"]?>')"><?=$lang["sourcing_region"]?> <?=$sortimg["sourcing_reg"]?></a></td>
    ...
    <tr class="search" id="tr_search" <?=$searchdisplay?>>
        ...
        <td><input name="currency_id" class="input" value="<?=htmlspecialchars($this->input->get("currency_id"))?>"></td>
        <td><input name="supplier_reg" class="input" value="<?=htmlspecialchars($this->input->get("supplier_reg"))?>"></td>
        <td><input name="sourcing_reg" class="input" value="<?=htmlspecialchars($this->input->get("sourcing_reg"))?>"></td>
        <td>&nbsp;</td>
        <td>
...
?>
    ...
    <tr class="row<?=$i%2?> pointer" onMouseOver="AddClassName(this, 'highlight')" onMouseOut="RemoveClassName(this, 'highlight')" onClick="Redirect('<?=site_url('supply/supplier/view/'.$obj->get_id())?>')">
