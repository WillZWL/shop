...
<div id="main">
    ...
    <table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
        <tr>
            <td height="70" style="padding-left:8px"><b style="font-size:14px"><?= $lang["header"] ?> - <?= $func ?></b><br><?= $lang["header_message"] ?>
            </td>
        </tr>
    </table>
                    ...
                    <tr class="row<?= $i % 2 ?>" onMouseOver="AddClassName(this, 'highlight')"
                        ...
                        <td align="center">
                            ...
                            if ($obj->get_batch_status() == "F") {
                                ?>
                                <input type="button" value="<?= $lang["investigated"] ?>"
                                       title="<?= $lang["investigated"] ?>" class="button"
                                       onClick="Redirect('<?= site_url("integration/integration/investigated/ixtens_repice_pg/{$obj->get_batch_id()}?sku={$obj->get_sku()}/") ?>')">
                            <?php
                            }
                            ?>
                        </td>
