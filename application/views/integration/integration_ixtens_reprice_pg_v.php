...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td height="30" class="title"><?=$lang["title"]?> - <?=$func?> </td>
...
<table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
    <tr>
        <td height="70" style="padding-left:8px"><b style="font-size:14px"><?=$lang["header"]?> - <?=$func?></b><br><?=$lang["header_message"]?></td>
    </tr>
</table>
<form name="fm" method="get">
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
    <col width="20"><col width="120"><col width="150"><col width="150"><col width="250"><col><col width="100">
    <tr class="header">
        ...
        <td><a href="#" onClick="SortCol(document.fm, 'price', '<?=$xsort["price"]?>')"><?=$lang["price"]?> <?=$sortimg["price"]?></a></td>
...
?>
    <tr class="row<?=$i%2?>" onMouseOver="AddClassName(this, 'highlight')" onMouseOut="RemoveClassName(this, 'highlight')">
        ...
        <td align="center">
            <?php
                if($obj->get_batch_status() == "F")
                {
            ?>
            <input type="button" value="<?=$lang["investigated"]?>" title="<?=$lang["investigated"]?>" class="button" onClick="Redirect('<?=site_url("integration/integration/investigated/ixtens_repice_pg/{$obj->get_batch_id()}?sku={$obj->get_sku()}/")?>')">
            <?php
                }
            ?>
        </td>
