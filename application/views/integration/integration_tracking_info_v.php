...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
	...
	<tr class="header">
		...
		<td><a href="#" onClick="SortCol(document.fm, 'ship_method', '<?=$xsort["ship_method"]?>')"><?=$lang["ship_method"]?> <?=$sortimg["ship_method"]?></a></td>
	...
	<tr class="search" id="tr_search" <?=$searchdisplay?>>
		...
		<td><input name="tracking_info" class="input" value="<?=htmlspecialchars($this->input->get("tracking_info"))?>"></td>
		<td><input name="courier_id" class="input" value="<?=htmlspecialchars($this->input->get("courier_id"))?>"></td>
		<td><input name="ship_method" class="input" value="<?=htmlspecialchars($this->input->get("ship_method"))?>"></td>
		<td>
			<?php
