    ...
    <form name="fm" method="get">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
            ...
            <tr class="header">
                ...
                <td><a href="#"
                       onClick="SortCol(document.fm, 'ref_id', '<?= $xsort["ref_id"] ?>')"><?= $lang["ref_id"] ?> <?= $sortimg["ref_id"] ?></a>
                </td>
                <td><a href="#"
                       onClick="SortCol(document.fm, 'view_count', '<?= $xsort["view_count"] ?>')"><?= $lang["view_count"] ?> <?= $sortimg["view_count"] ?></a>
                </td>
                <td><a href="#"
            ...
            <tr class="search" id="tr_search" <?= $searchdisplay ?>>
                ...
                <td><input name="ref_id" class="input" value="<?= htmlspecialchars($this->input->get("ref_id")) ?>">
                </td>
                <td><input name="view_count" class="input"
                           value="<?= htmlspecialchars($this->input->get("view_count")) ?>"></td>
                <td>
                    <?php
