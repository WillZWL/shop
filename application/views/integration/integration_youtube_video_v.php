...
<table border="0" cellpadding="0" cellspacing="0" height="70" class="page_header" width="100%">
	<tr>
		<td height="70" style="padding-left:8px"><b style="font-size:14px"><?=$lang["header"]?> - Tracking Information</b><br><?=$lang["header_message"]?></td>
	</tr>
</table>
<form name="fm" method="get">
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
	<col width="20"><col><col width="250"><col width="250"><col width="200"><col width="200">
	<tr class="header">
		...
		<td><a href="#" onClick="SortCol(document.fm, 'ref_id', '<?=$xsort["ref_id"]?>')"><?=$lang["ref_id"]?> <?=$sortimg["ref_id"]?></a></td>
		<td><a href="#" onClick="SortCol(document.fm, 'view_count', '<?=$xsort["view_count"]?>')"><?=$lang["view_count"]?> <?=$sortimg["view_count"]?></a></td>
	...
	<tr class="search" id="tr_search" <?=$searchdisplay?>>
		...
		<td><input name="ref_id" class="input" value="<?=htmlspecialchars($this->input->get("ref_id"))?>"></td>
		<td><input name="view_count" class="input" value="<?=htmlspecialchars($this->input->get("view_count"))?>"></td>
		<td>
			<?php
...
?>
	<tr class="row<?=$i%2?>">
		...
		<td><?=$obj->get_sku()?></td>
		<td><?=$obj->get_ref_id()?></td>
		<td><?=$obj->get_view_count()?></td>
