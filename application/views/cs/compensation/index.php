...
<tr height="30">
    <td style="padding-left:20px;"><input class="button" type="button" onClick="Redirect('<?=base_url()?>cs/compensation/create/')" value="<?=$lang["create"]?>"></td>
    ...
    ?>
<tr height="30">
    <td style="padding-left:20px;"><input class="button" type="button" onClick="Redirect('<?=base_url()?>cs/compensation/manager_approval')" value="<?=$lang["manager_approval"]?>" <?=$disable_approve?>></td>
