    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#000033">
        <tr>
            <td align="left" height="20" style="padding-left:10px;"><a
                    ...
                    onClick="showHide('p1')"><?= $lang["compensation_history"] . " " . $orderid ?></a></td>
        </tr>
    </table>
    ...
    <form name="fm" method="POST" onSubmit="CheckForm(this);">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#000033">
            <tr>
                <td align="left" height="20" style="padding-left:10px;"><font
                        style="font-size:12px; color:#ffffff; font-weight:bold;"><?= $lang["compensation_detail"] ?></font>
                </td>
            </tr>
        ...
        <table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#cccccc">
            <tr>
                ...
                <td width="70%" align="left" style="padding-left:10px;" class="value"><textarea id="cnotes"
                                                                                                name="cnotes"
                                                                                                class="input"
                                                                                                rows="5"></textarea>
                </td>
            ...
            <tr height="25">
                ...
                <td width="70%" align="right" style="padding-left:10px;" class="value">&nbsp;
                    <input type="button" style="width:120px" value="<?= $lang["approve"] ?>"
                           onClick="if(CheckForm(this.form)) { document.getElementById('action').value = 'A'; document.fm.submit(); }">&nbsp;
                    <input type="button" style="width:120px" value="<?= $lang["reject"] ?>"
                           onclick="if(checkNote() && CheckForm(this.form)) { document.getElementById('action').value = 'D'; document.fm.submit(); }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
        </table>
