...
<tr>
    <td align="left" height="20" style="padding-left:10px;"><font style="font-size:12px; color:#ffffff; font-weight:bold;"><?=$lang["compensation_history"]." ".$orderid?></font></td>
</tr>
</table>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#000033">
<tr>
    <td align="left" height="20" style="padding-left:10px;"><font style="font-size:12px; color:#ffffff; font-weight:bold;"><?=$lang["request_compensation"]?></font></td>
</tr>
</table>
<table id="tb_list_item" border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc" width="100%" style="display:none">
<col width="1%"><col width="18%"><col width="40%"><col width="10%"><col width="10%"><col width="10%"><col width="1%">
<tr class="header">
    <td height="20">&nbsp;</td>
    <td style="padding-left:4px;"><?=$lang["item_sku"]?></td>
    <td style="padding-left:4px;"><?=$lang["prod_name"]?></td>
...
<tr class="row1">
    ...
    <td style="padding-left:4px;" align="center"><input type="button" style="width:80px" value="<?=$lang["remove"]?>" onClick="removeitem();"></td>
    <td>&nbsp;</td>
</tr>
</table>
...
<tr class="row1" height="30px">
    ...
    <td align="left" colspan="5">
        <a href="<?=base_url()?>cs/compensation_create/prod_list/<?=$i?>/<?=$orderobj->get_platform_id()?>" style="padding-left:10px" rel="lyteframe" rev="width: 1024px; height: 600px; scrolling: auto;" title="Add Compensation Item" class="search_button"><input type="button" value="Add Compensation Item"></a>
    </td>
    <td>&nbsp;</td>
</tr>
</table>
...
<tr>
    ...
    <?php
        ...
        {
    ?>
            <select name="cnotes" dname="Compensation Reason" class="text" onchange="checknote(this.value)" notEmpty>
            <option></option>
    <?php
            foreach($reason_list as $reason_obj)
            {
                ?>
                    <option value="<?=$reason_obj->get_id()?>"><?=$reason_obj->get_reason_cat() . " - " . $reason_obj->get_description()?></option>
                <?php
            }
    ?>
            </select>
    ...
    ?>
    <input id="others_reason" name="others_reason" dname="Others Reason" value="" style="width:55%;display:none" Disabled>
    </td>
</tr>
<tr>
...
<tr height="20" bgcolor="#000033">
    <td style="padding-left:10px;"><input type="button" value="<?=$lang["back_to_list"]?>" onClick="Redirect('<?=base_url()."cs/compensation/create/?".$_SESSION["QUERY"]?>')"></td>
</tr>
<tr height="20">
    <td>&nbsp;</td>
</tr>
