    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
        ...
        <form name="fm" method="get" onSubmit="return CheckForm(this)">
            <tr class="header">
                ...
                <td><a href="#"
                       onClick="SortCol(document.fm, 's.txn_id', '<?= $xsort["s.txn_id"] ?>')"><?= $lang["txn_id"] ?> <?= $sortimg["s.txn_id"] ?></a>
                </td>
                <td><a href="#"
                ...
                <td><a href="#" coords="<?= $multiSort['multi_sort_od'] ?>" class='multiSortMode'
                       onClick="MultiSort('multi_sort_od')"
                       name="multi_sort_od"><?= $lang["order_date"] ?> <?= $sortimg["r.order_date"] ?></a></td>
                <td><a href="#"
                ...
                <td><a href="#" coords="<?= $multiSort['multi_sort_rs'] ?>" class='multiSortMode'
                       onClick="MultiSort('multi_sort_rs')"
                       name="multi_sort_rs"><?= $lang["refund_score"] ?> <?= $sortimg["sors.score"] ?></a></td>
        ...
        ?>onClick="Redirect('<?= site_url('cs/refund/account_view/' . $obj->get_id()) ?>/?<?= $_SERVER['QUERY_STRING'] ?>')"<?
        }?>>
            <td height="20"></td>
            <td><?= $obj->get_id() ?></td>
            <td><?= $obj->get_so_no() ?></td>
        ...
        <tr class="header">
            <td></td>
            <td colspan="12"><input type="button" onClick="Redirect('<?= base_url() ?>cs/refund/');"
