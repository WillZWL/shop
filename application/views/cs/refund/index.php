...
<div id="main">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="page_header">
        <tr height="30">
            <td style="padding-left:20px;"><input class="button" type="button"
                                                  onClick="Redirect('<?= base_url() ?>cs/refund/create/')"
        ...
        if (check_app_feature_access_right($app_id, "CS000200_log_btn")) {
            ...
            <tr height="30">
                <td style="padding-left:20px;"><input class="button" type="button"
                                                      onClick="Redirect('<?= base_url() ?>cs/refund/logistics')"
                                                      value="<?= $lang["logistic"] ?>"></td>
        ...
        if (check_app_feature_access_right($app_id, "CS000200_cs_btn")) {
            ...
            <tr height="30">
                <td style="padding-left:20px;"><input class="button" type="button"
                                                      onClick="Redirect('<?= base_url() ?>cs/refund/cs')"
                                                      value="<?= $lang["cs"] ?>"></td>
        ...
        if (check_app_feature_access_right($app_id, "CS000200_acc_btn")) {
            ...
            <tr height="30">
                <td style="padding-left:20px;"><input class="button" type="button"
                                                      onClick="Redirect('<?= base_url() ?>cs/refund/account')"
                                                      value="<?= $lang["account"] ?>"></td>
    ...
    <td style="padding-left:20px;"><?= $lang["report_desc"] ?></td>
        ...
        if (check_app_feature_access_right($app_id, "CS000200_refund_btn")) {
            ...
            <tr height="40">
                <td style="padding-left:20px;"><input class="button" type="button"
                                                      onClick="Redirect('<?= base_url() ?>cs/refund/reason/')"
                                                      value="<?= $lang["reason"] ?>"></td>
