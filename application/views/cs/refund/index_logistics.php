...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tb_list">
	<col width="20"><col width="150"><col width="150"><col><col width="150"><col width="120"><col width="120"><col width="20">
...
?>
	...
	<tr class="row<?=$i%2?> pointer" onMouseOver="AddClassName(this, 'highlight')" onMouseOut="RemoveClassName(this, 'highlight')" <?if (!($is_edit)){?>onClick="Redirect('<?=site_url('cs/refund/logistics_view/'.$obj->get_id())?>/?<?=$_SERVER['QUERY_STRING']?>')"<?}?>>
		<td height="20"></td>
		<td><?=$obj->get_id()?></td>
		<td><?=$obj->get_so_no()?></td>
