...
<div id="main" <?= $viewtype == "" ? "" : "style='width:1004px;'" ?> class="bp">
            ...
            <td align="right" style="padding-right:10px;" class="title">
                <form method='POST'>
                    <?php if (check_app_feature_access_right($app_id, "ORD000403_print_invoice")) {
                        ...
                        <input type="button" value="<?= $lang["print_custom_invoice"] ?> (HKD)"
                        ...
                        <input type="button" value="<?= $lang["print_custom_invoice"] ?>"
                        ...
                        <input type="button" value="<?= $lang["print_selected_invoice"] ?>"
                        ...
                        <input type="hidden" name="check[<?= $so_obj->get_so_no() ?>]"
                               value="<?= $so_obj->get_so_no() ?>">
                    <?php } ?>
    ...
    <table border="0" cellpadding="0" cellspacing="1" bgcolor="#BBBBFF" width="100%" id="maintb">
            ...
            <td>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                    ...
                    <tr>
                        ...
                        <? if ($client_obj->get_client_id_no() == "") { ?>
                            <td width="35%" align="left"
                                class="value1"><?= $client_obj->get_forename() . " " . $client_obj->get_surname() ?></td>
                        <?php } else { ?>
                            <td width="35%" align="left"
                                class="value1"><?= $client_obj->get_forename() . " " . $client_obj->get_surname() ?> /
                                ID: <?= $client_obj->get_client_id_no() ?></td>
                        <?php } ?>
                        <td width="15%" align="left"
                            class="field1"><?= (check_app_feature_access_right($app_id, "CS000100_password")) ? strtoupper($lang["password"]) : "" ?></td>
                        <td width="35%" align="left"
                            class="value1"><?= (check_app_feature_access_right($app_id, "CS000100_password")) ? $this->encrypt->decode($client_obj->get_password()) : "" ?></td>
                    </tr>
                    <tr>
                        ...
                        <td width="35%" align="left" class="value1">
                            <?php if (check_app_feature_access_right($app_id, 'CS000102_deactivate_client') === TRUE && $client_obj->get_status() == 1): ?>
                                <form action="<?php echo current_url(); ?>" method="POST" name="deactivate_client">
                                    ...
                                    <span id="client_status"><?php echo $lang['active']; ?><a
                                            onclick="document.deactivate_client.submit();" href="#"
                                            style="color:#000;display:inline-block;float:right;margin-right:10px">[<?php echo $lang['deactivate_account']; ?>
                                            ]</a></span>
                                </form>
                            <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td width="35%" align="left"
                            class="value1"><?= trim($client_obj->get_tel_1() . " " . $client_obj->get_tel_2() . " " . $client_obj->get_tel_3()) . " / " . $client_obj->get_mobile() ?></td>
        ...
        <tr>
            <td style="padding-left:8px" class="header2"><b
                    style="font-size:11px;color:#000000"><?= $lang["order_billaddr"] ?></b></td>
        </tr>
        <tr>
            <td>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
        ...
        if ($this->input->get('caddr') == "") {
            ?>
            <tr>
                <td style="padding-left:8px" class="header3"><b
                        style="font-size:11px;color:#000000"><?= $lang["order_deladdr"] ?></b>&nbsp;&nbsp;
                    <?php
                    if (($order_obj->get_status() < 6) && (check_app_feature_access_right($app_id, "CS000102_change_delivery_addr"))) {
                        ?>
                        <input type="button" value="<?= $lang["change_delivery_addr"] ?>"
                               onClick="document.location.href='<?= base_url() . "cs/quick_search/view/" . $order_obj->get_so_no() . "/" . $viewtype . "?caddr=1" ?>';">
                    <?php
                    }
                    ?>
                </td>
                ...
                <td>
                    <table width="100%" cellpadding="0" cellspacing="1" border="0">
                        ...
                        <tr>
                            ...
                            <td width="35%" align="left"
                                class="value3"><?= trim($client_obj->get_del_tel_1() . " " . $client_obj->get_del_tel_2() . " " . $client_obj->get_del_tel_3()) . " / " . $client_obj->get_del_mobile() ?></td>
        ...
        <?php
            ...
            <form name="changeaddr" onSubmit="return CheckForm(this);" method="POST"
                  action='<?= base_url() . "cs/quick_search/view/" . $order_obj->get_so_no() ?>'>
                <input type="hidden" name="ca" value="1">
                <tr>
                    <td style="padding-left:8px" class="header3"><b
                            style="font-size:11px;color:#000000"><?= $lang["order_deladdr"] ?></b>&nbsp;&nbsp;<input
                            type="button" onClick="if(CheckForm(this.form)) document.changeaddr.submit();"
                            value="<?= $lang["update_addr"] ?>"></td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" cellpadding="0" cellspacing="1" border="0">
                            <tr>
                                <td width="15%" align="left" class="field3"><?= strtoupper($lang["del_name"]) ?></td>
                                <td width="35%" align="left" class="value3"><input type="text" name="dname"
                                                                                   value="<?= $so_obj->get_delivery_name(); ?>"
                                                                                   notEmpty class="input"></td>
                                <td width="15%" align="left"
                                    class="field3"><?= strtoupper($lang["del_company_name"]) ?></td>
                                <td width="35%" align="left" class="value3"><input type="text" name="dcomp"
                                                                                   value="<?= $so_obj->get_delivery_company() ?>"
                                                                                   class="input"></td>
                            </tr>
                            <tr>
                                <td width="15%" align="left" class="field3"><?= strtoupper($lang["del_addr_l1"]) ?></td>
                                <td width="35%" align="left" class="value3"><input type="text" name="daddr1"
                                                                                   value="<?= $address[0] ?>" notEmpty
                                                                                   class="input"></td>
                                <td width="15%" align="left" class="field3"><?= strtoupper($lang["postcode"]) ?></td>
                                <td width="35%" align="left" class="value3"><input type="text" name="dpostcode"
                                                                                   value="<?= $so_obj->get_delivery_postcode() ?>"
                                                                                   class="input"></td>
                            </tr>
                            <tr>
                                <td width="15%" align="left" class="field3"><?= strtoupper($lang["del_addr_l2"]) ?></td>
                                <td width="35%" align="left" class="value3"><input type="text" name="daddr2"
                                                                                   value="<?= $address[1] ?>"
                                                                                   class="input"></td>
                                <td width="15%" align="left" class="field3"><?= strtoupper($lang["city"]) ?></td>
                                <td width="35%" align="left" class="value3"><input type="text" name="dcity"
                                                                                   value="<?= $so_obj->get_delivery_city() ?>"
                                                                                   notEmpty class="input"></td>
                            </tr>
                            <tr>
                                <td width="15%" align="left" class="field3"><?= strtoupper($lang["del_addr_l3"]) ?></td>
                                <td width="35%" align="left" class="value3"><input type="text" name="daddr3"
                                                                                   value="<?= $address[2] ?>"
                                                                                   class="input"></td>
                                <td width="15%" align="left" class="field3"><?= strtoupper($lang["state"]) ?></td>
                                <td width="35%" align="left" class="value3"><input type="text" name="dstate"
                                                                                   value="<?= $so_obj->get_delivery_state() ?>"
                                                                                   class="input"></td>
                            </tr>
                            <tr>
                                ...
                                <td width="15%" align="left" class="field3"></td>
                                <td width="35%" align="left" class="value3"><select type="text" name="dcountry"
                                                                                    class="input">
                                        <?php
                                        foreach ($country_list as $country_obj) {
                                            ?>
                                            <option
                                                value="<?= $country_obj->get_id() ?>" <?= ($so_obj->get_delivery_country_id() == $country_obj->get_id() ? "SELECTED" : "") ?>><?= $country_obj->get_id() . " - " . $country_obj->get_name() ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select></td>
        ...
        <tr>
            <td style="padding-left:8px" class="header4"><b
                ...
                <div style="float:right">
                    <a href="/order/on_hold_admin?so_no=<?= $order_obj->get_so_no() ?>&search=1">
                        <button>HOLD</button>
                    </a>
                    <?php if ($allow_release) {
                        ?>
                        <a href="/order/on_hold_admin/oc_index/?so_no=<?= $order_obj->get_so_no() ?>">
            ...
            <td>
                <table width="100%" cellpadding="0" cellspacing="1" border="0">
                    <tr>
                        ...
                        <td width="35%" align="left"
                            class="value4"><?= $order_obj->get_platform_id() . " - " . $order_obj->get_biz_type() ?>
                            <br><?= $fulfillment_html ?></td>
                    </tr>
                    <tr>
                        ...
                        <td width="15%" align="left"
                            class="field4"><?= strtoupper($lang["expected_delivery_date"]) ?></td>
                        <td width="35%" align="left" class="value4">
                            <form name="edd_form" id="edd_form" method="post"
                                  action="<?= base_url() . "cs/quick_search/update_edd/" . $so_obj->get_so_no() . "/" ?>">
                                <?php
                    ...
                    <tr>
                        ...
                        <td width="35%" align="left"
                            class="value4"><?= $order_obj->get_currency_id() . " " . number_format($order_obj->get_amount() - $order_obj->get_delivery_charge(), 2) ?></td>
                        <td width="15%" align="left" class="field4"><?= strtoupper($lang["del_cost"]) ?></td>
                        <td width="35%" align="left"
                            class="value4"><?= $order_obj->get_currency_id() . " " . $order_obj->get_delivery_charge() ?></td>
                    </tr>
                    <tr>
                        ...
                        if ($order_obj->get_payment_gateway_id() == 'w_bank_transfer') {
                            ...
                            <td width="35%" align="left" class="value4">
                                ...
                                Total bank charges: <?= $order_obj->get_currency_id() . " " . $bt_total_bank_charge ?>
                                <br>
                                <b>TOTAL PAID: <?= $order_obj->get_currency_id() . " " . $net_received ?> </b>|| Net
                                Unpaid: <?= $order_obj->get_currency_id() . " " . $net_unpaid ?>
                            </td>
                        <?php
                        } else {
                            ?>
                            ...
                            <td width="35%" align="left"
                                class="value4"><?= $order_obj->get_currency_id() . " " . number_format($order_obj->get_amount(), 2) ?></td>
                        <?php
                        }
                        ?>
                        <td width="15%" align="left" class="field4"><?= strtoupper($lang["ship_service_level"]) ?></td>
                        <td width="35%" align="left"
                            class="value4"><?= $del_opt_list[$order_obj->get_delivery_mode()]->get_display_name() ?></td>
                    </tr>
                    <?php
...
html;
                        ...
                        <?= $riskref1_html ?>
                                        Total Fraud Score: <font
                                            color="#0000FF"><?= $sops_obj->get_risk_ref2() ?></font><br>
                    ...
                    <tr>
                        ...
                        <td width="35%" align="left"
                            class="value4"><?= $lang["status_name"][$order_obj->get_status()] ?></td>
                    ...
                    <tr>
                        ...
                        <td width="35%" align="left" class="value4">
                            <form name="chasing_order_form" id="chasing_order_form" method="post"
                                  action="<?= base_url() . "cs/quick_search/update_cs_order_query/" . $so_obj->get_so_no() . "/" ?>">
                                <?php
                                if ($so_obj->get_hold_status() == 15) {
                                    print "Update on Split Child below.";
                                } else {
                        ...
                        <td colspan="3" width="85%" align="left" class="value4">
                            <div style="width:100%; height:100px; overflow-y:scroll">
                                ...
                                foreach ($history_obj as $hobj) {
                                    ...
                                    ?>
                                    <div><?= $lang["change_to"] ?>
                                        <b><?= $lang["status_name"][$hobj->get_status()] ?></b>&nbsp;&nbsp;<i><?= $lang["change_username"] . " " . $name . " " . $lang["change_create_on"] . " " . $hobj->get_create_on() ?></i><br><br>
                                    </div>
                                <?php
...
html;
                    ...
                    <tr>
                        ...
                        <td colspan="1" width="35%" align="left" class="value4">
                            <form
                                action="<?= base_url() . "cs/quick_search/update_priority_score/" . $so_obj->get_so_no() . "/" ?>"
                                method="POST">
                                <div style="width:100%; height:100px; overflow-y:scroll">
...
html;
                        ...
                        <td class="value4" width="35%" style="padding:0;">
                            <form
                                action="<?= base_url() . "cs/quick_search/update_refund_score/" . $so_obj->get_so_no() . "/" ?>"
                                method="POST">
                                ...
                                <div style="width:100%;">
                                    ...
                                    if ($sorf_history_last_obj) {
                                        ?>
                                        <div><?= $lang["last_score"] ?><?= $sorf_history_last_obj->get_score() ?>
                                            <i><?= $lang["last_modify"] . " " . $sorf_history_last_obj->get_modify_by() . " " . $lang["change_create_on"] . " " . $sorf_history_last_obj->get_modify_on() ?></i><br><br>
                                        </div>
                                    <?php
                                    }
                                    ?>
                            ...
                            <td colspan="2">
                                <table width="100%" cellpadding="0" cellspacing="1" border="0" class="tb_list">
                                    ...
                                    <tr class="refund_row0">
                                        ...
                                        <td><?= $lang["refund_category"][$refund_reason->get_reason_cat()] ?>
                                            : <?= $refund_reason->get_description() ?></td>
                ...
                <td>
                    <table width="100%" cellpadding="0" cellspacing="1" border="0">
                        <tr>
                            ...
                            <td width="35%" align="left"
                                class="value6"><?= $order_obj->get_platform_id() . " - " . $order_obj->get_biz_type() ?>
                                <br></td>
                        </tr>
                        <tr>
                            <td width="15%" id="itemlist" align="left" class="field6">ITEM LIST<br>
                                <button onClick="window.open('<?= $base_split_url ?><?= $child_so_no ?>');">Split
                                    Order
                                </button>
                            </td>
                            <td colspan="3" width="85%" align="left" class="value6">
                        ...
                        <tr>
                            ...
                            <td width="35%" align="left"
                                class="value6"><?= $child_order_obj->get_currency_id() . " " . number_format($child_order_obj->get_amount() - $child_order_obj->get_delivery_charge(), 2) ?></td>
                            <td width="15%" align="left" class="field6"><?= strtoupper($lang["del_cost"]) ?></td>
                            <td width="35%" align="left"
                                class="value6"><?= $child_order_obj->get_currency_id() . " " . $child_order_obj->get_delivery_charge() ?></td>
                        </tr>
                        <tr>
                            <td width="15%" align="left" class="field6"><?= strtoupper($lang["total_paid"]) ?></td>
                            <td width="35%" align="left"
                                class="value6"><?= $child_order_obj->get_currency_id() . " " . number_format($child_order_obj->get_amount(), 2) ?></td>
                            <td width="15%" align="left"
                                class="field6"><?= strtoupper($lang["ship_service_level"]) ?></td>
                            <td width="35%" align="left"
                                class="value6"><?= $del_opt_list[$child_order_obj->get_delivery_mode()]->get_display_name() ?></td>
                        </tr>
                        <tr>
                            <td width="15%" align="left" class="field6"></td>
                            <td width="35%" align="left" class="value6"></td>
                        ...
                        <tr>
                            ...
                            <td width="35%" align="left"
                                class="value6"><?= $child_so_obj->get_order_create_date() ?></td>
                        ...
                        <tr>
                            ...
                            <td width="35%" align="left"
                                class="value6"><?= $lang["status_name"][$child_so_obj->get_status()] ?></td>
                        ...
                        <tr>
                            ...
                            <td colspan="3" width="85%" align="left" class="value6">
                                <form action="<?= base_url() . "cs/quick_search/view/$child_so_no" ?>" method="POST">
                                    ...
                                    <div>
                                        <?= $lang["create_note"] ?><br><input type="text" name="note"
        ...
        <td>
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <td style="padding-left:8px" class="header5"><b style="font-size:11px;color:#000000"><input
                            ...
                            onClick="window.open('/cs/compensation_create/create_view/<?= $order_obj->get_so_no() ?>/', 'compensation', 'width=1280 height=600,scrollbars=yes')"></b>
                </td>
            </table>
    </tr>
    <tr>
        ...
        <td style="background-color: <?= $detail_background ?>;">
            <table width="100%" cellpadding="0" cellspacing="1" border="0">
                ...
                <tr bgcolor="<?= $detail_background ?>">
                    <td colspan="2"
                        style="padding-left:10px; font-size: 14px; font-weight:bold; color:#bb0000;"><?= ($so_extend_obj && $so_extend_obj->get_vatexempt() == 1 ? $lang["vatex_order"] : "&nbsp;") ?></td>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="1" border="0" bgcolor="#666666;">
                            ...
                            <tr bgcolor="#eeeeff">
                                <td width="100%" colspan="2" align="right" style="padding-right:15px;">
                                    <?= $lang["total_gst"] . " : " . $order_obj->get_currency_id() . " " . number_format($total_gst, 2) ?>
                                    <br/>
                                    <?= $lang["order_amount"] . " : " . $order_obj->get_currency_id() . " " . number_format($total, 2) ?>
                                    <br/>
                                    <?= $lang["delivery_charge"] . " : " . $order_obj->get_currency_id() . " " . $order_obj->get_delivery_charge() ?>
                                    <br/>
                                    <?= $dc_message ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="right"
                                    style="background-color:#ff0000; padding-right:15px; color:#ffffff; font-weight:bold; font-size:11px;"><?= $order_obj->get_currency_id() . " " . number_format($order_obj->get_amount(), 2) ?></td>
                            </tr>
                            <?php if (check_app_feature_access_right($app_id, "CS000102_absolute_profit")) { ?>
                                <tr>
                                    <td align="right"
                                    ...
                                    <td align="right"
                                        style="background-color:#ff0000; padding-right:15px; color:#ffffff; font-weight:bold; font-size:11px;"><?= $order_obj->get_currency_id() . " " . number_format($total_profit, 2) ?></td>
                                </tr>
                            <? } ?>
                        </table>
                    </td>
