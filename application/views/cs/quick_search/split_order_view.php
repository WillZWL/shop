...
?>
    <div id="splitprocessor" style="width:900px;margin:auto;overflow:auto;padding:0px 50px;background-color:#FCFCFC;box-shadow:0 5px 10px rgba(0, 0, 0, 0.5);">
        ...
        <form name="splitorder" id="splitorder" method="post" >
            <div>
                <fieldset style="border-width:2px;margin-left:6px;margin-right:6px;padding:0 8px ;">
                    ...
                    <table width="100%" style="text-align=left;font-family: Lucida Sans Unicode,sans-serif;" cellpadding="5">
                        <col width="15%"><col width="40%">
                        <tr style="text-align:left">
                            <td>SO#</td>
                            <td><?=$so_no?> <?=$splitgrouphtml?> <input type="hidden" id="so_no" name="so_no" value="<?=$so_no?>"></td>
                            <td colspan="2">
                        </tr>
                        <tr style="text-align:left">
                ...
                <div style="padding:10px 15px;text-align:left;">
                    ...
                    <br>Items in the same group number will be assigned to the same split order number. Review the grouping and click 'Process' to finalize the split. <br>
                </div>
                <div>
                <fieldset style="border-width:2px;margin-left:6px;margin-right:6px;padding:0 5px">
                    ...
                    <table width="100%" style="text-align=left;font-family: Lucida Sans Unicode,sans-serif;border-spacing:0px 1px" cellpadding="1">
                    <col width="10%"><col width="10%"><col width="20%"><col width="15%"><col width="5%"><col width="10%"><col width="10%"><col width="5%"><col width="2%">
                        <?=$itemrow?>
