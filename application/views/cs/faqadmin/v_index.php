    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td width="400" align="right" class="title"><input type="button" value="<?= $lang["show_all_cc"] ?>"
                                                               class="button"
                                                               onclick="Redirect('<?= site_url('cs/faqadmin/') ?>')">
            </td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" height="70" class="tb_list" width="100%">
        ...
        <form name="fm" method="get">
            ...
            <tr class="search" id="tr_search">
                ...
                <td><select name="faq_ver">
                        <option value=""></option><?php
                        foreach ($faq_version as $key => $value) {
                            ?>
                            <option
                            value="<?= $key ?>" <?= $key == $this->input->get("faq_ver") ? "SELECTED" : "" ?>><?= $value ?></option><?php
                        }
                        ?></select></td>
        ...
        if ($list) {
            foreach ($list as $obj) {
                ...
                <?php
                    ...
                    ?>
                    <form name="fm_edit" action="<?= base_url() . "cs/faqadmin/?" . $_SERVER["QUERY_STRING"] ?>"
