<?php
class CustomerExtractionItemListDto
{
    private $title;
    private $forename;
    private $surname;
    ...
    public function setTransactionProfit($transaction_profit)
    {
        $this->transaction_profit = $transaction_profit;
    }

    public function getTransactionProfit()
    {
