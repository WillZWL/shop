<?php
class SoLastOrderWithClientDto
{
    private $so_no;
    private $email;
    private $client_id;
    ...
    public function setDeliveryNameSegment($delivery_name_segment)
    {
        $this->delivery_name_segment = $delivery_name_segment;
    }

    public function getDeliveryNameSegment()
    {
        return $this->delivery_name_segment;
    }
    ...
    {
        $this->delivery_address_segment = $delivery_address_segment;
    }

    public function getDeliveryAddressSegment()
    {
