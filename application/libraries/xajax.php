...
function autoCompressJavascript($sJsFullFilename=NULL,$bAlways=false){$sJsFile='js/xajax_js/xajax_core.js';if($sJsFullFilename){$realJsFile=$sJsFullFilename;}
...
function printJavascriptInclude(){$aJsFiles=$this->aJsFiles;$sJsURI=$this->sJsURI;if(0==count($aJsFiles)){$aJsFiles[]=array($this->_getScriptFilename('js/xajax_js/xajax_core.js'),'xajax');if(true===$this->bDebug)
$aJsFiles[]=array($this->_getScriptFilename('js/xajax_js/xajax_debug.js'),'xajax.debug');if(true===$this->bVerboseDebug)
$aJsFiles[]=array($this->_getScriptFilename('js/xajax_js/xajax_verbose.js'),'xajax.debug.verbose');if(null!==$this->sLanguage)
