...
class xajaxFunctionPlugin extends xajaxRequestPlugin
{
    ...
    function configure($sName, $mValue)
    {
        if ('wrapperPrefix' == $sName) {
            ...
            if (true === $mValue) $this->sDefer = 'defer '; else $this->sDefer = '';
...
class xajaxIncludeClientScriptPlugin extends xajaxRequestPlugin
{
    ...
    function configure($sName, $mValue)
    {
        if ('javascript URI' == $sName) {
            ...
            if (true === $mValue) $this->sStatusMessages = "true"; else $this->sStatusMessages = "false";
        } else if ("waitCursor" == $sName) {
            if (true === $mValue) $this->sWaitCursor = "true"; else $this->sWaitCursor = "false";
