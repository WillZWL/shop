...
class Product_banner_vo extends Base_vo
{
	...
	//primary key
	// private $primary_key = array("sku", "display_id", "position_id", "lang_id");
	...
	public function set_target_url($value)
	{
	...
	public function set_target_type($value)
	{
