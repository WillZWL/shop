...
class Flex_gateway_mapping_vo extends Base_vo
{
    ...
    //primary key
    private $primary_key = array("gateway_id", "currency_id");
    ...
    public function get_gateway_code()
    {
        return $this->gateway_code;
    }

    public function set_gateway_code($value)
    {
