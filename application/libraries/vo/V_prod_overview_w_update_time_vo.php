...
class V_prod_overview_w_update_time_vo extends Base_vo
{
    ...
    private $price_modify_on = '0000-00-00 00:00:00';
    ...
    public function get_price_modify_on()
    {
        return $this->price_modify_on;
    }

    public function set_price_modify_on($value)
    {
        $this->price_modify_on = $value;
        return $this;
    }
