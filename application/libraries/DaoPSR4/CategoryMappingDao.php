...
class CategoryMappingDao extends BaseDao
{
    ...
    public function getGooglebaseCatListWCountry($where, $option, $classname = "CategoryMappingVo")
    {
        ...
        return $this->common_get_list($where, $option, $classname = "CategoryMappingVo", 'cm.id, cm.country_id, cm.ext_id, ec.ext_name, cm.product_name');
    }

    public function get_yandex_cat_by_subcatid($subcat_id, $lang_id = "ru", $country_id = "RU", $classname = "CategoryMappingVo")
    {
        $this->db->from("category_mapping AS cm");
    ...
    public function get_external_catmapping($ext_party, $level, $subcat_id, $lang_id = "en", $country_id = "GB", $classname = "CategoryMappingVo")
    {
        $this->db->from("category_mapping AS cm");
