...
class Rpt_sourcing_region_report_service extends Report_service
{
	private $so_service;
	...
	{
		set_time_limit(300);
		$arr = $this->get_so_service()->get_dao()->get_sourcing_region_report($where, array("limit"=>-1));
//print $this->get_so_service()->get_dao()->db->last_query();
	...
	{
		return APPPATH . 'data/sourcing_region_report_xml2csv.txt';
	}
}
