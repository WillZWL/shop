...
class Rpt_expect_delivery_date_report_service extends Report_service
{
	private $so_service;
	...
	{
		set_time_limit(300);
		$arr = $this->get_so_service()->get_dao()->get_expect_delivery_date_report($where, array("limit"=>-1));
	...
	{
		set_time_limit(300);
		$arr = $this->get_so_service()->get_dao()->get_expect_delivery_date_report($where, $option);
		return $arr;
	}
	...
	{
		return APPPATH . 'data/expect_delivery_date_report_xml2csv.txt';
	}
}
