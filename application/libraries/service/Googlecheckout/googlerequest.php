...
//      // Get HTTP Status code from the response
    ...
    {
        $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"                  <charge-order xmlns=\"" . $this->schema_url .
    ...
    function SendRefundOrder($google_order, $amount, $reason,
                             $comment = '')
    {
        $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"                  <refund-order xmlns=\"" . $this->schema_url .
            "\" google-order-number=\"" . $google_order . "\">" .
    ...
    {
        $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"                  <cancel-order xmlns=\"" . $this->schema_url .
            "\" google-order-number=\"" . $google_order . "\">
                  <reason>" .
    ...
    function SendTrackingData($google_order, $carrier,
                              $tracking_no)
    {
        $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"                  <add-tracking-data xmlns=\"" . $this->schema_url .
            "\" google-order-number=\"" . $google_order . "\">
                  <tracking-data>
    ...
    {
        $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"                  <add-merchant-order-number xmlns=\"" . $this->schema_url .
            "\" google-order-number=\"" . $google_order . "\">
    ...
    {
        $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"                  <send-buyer-message xmlns=\"" . $this->schema_url .
            "\" google-order-number=\"" . $google_order . "\">
                  <message>" .
    ...
    {
        $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"                  <process-order xmlns=\"" . $this->schema_url .
            "\" google-order-number=\"" . $google_order . "\"/> ";
        return $this->SendReq($this->request_url,
            $this->GetAuthenticationHeaders(), $postargs);
    }
    ...
    {
        $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"                  <deliver-order xmlns=\"" . $this->schema_url .
            "\" google-order-number=\"" . $google_order . "\">";
    ...
    {
        $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"                  <archive-order xmlns=\"" . $this->schema_url .
            "\" google-order-number=\"" . $google_order . "\"/>";
        return $this->SendReq($this->request_url,
            $this->GetAuthenticationHeaders(), $postargs);
    }
    ...
    {
        $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"                  <ship-items xmlns=\"" . $this->schema_url .
            "\" google-order-number=\"" . $google_order . "\">" .
