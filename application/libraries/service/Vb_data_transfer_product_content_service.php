		...
		foreach($xml_vb->product as $pc)
		{
			...
			try
			{
				if ($fail_reason == "")
				{
					...
					$new_pc_obj["short_desc"] = $this->replace_special_chars($pc->short_desc);	
					...
					$new_pc_obj["series"] = $this->replace_special_chars($pc->series);
					...
					$new_pc_obj["model_1"] = $this->replace_special_chars($pc->model_1);
					$new_pc_obj["model_2"] = $this->replace_special_chars($pc->model_2);
					$new_pc_obj["model_3"] = $this->replace_special_chars($pc->model_3);
					$new_pc_obj["model_4"] = $this->replace_special_chars($pc->model_4);
					$new_pc_obj["model_5"] = $this->replace_special_chars($pc->model_5);
					...
					$new_pc_obj["extra_info"] = $this->replace_special_chars($pc->extra_info);				
					$new_pc_obj["website_status_long_text"] = $this->replace_special_chars($pc->website_status_long_text);
					$new_pc_obj["website_status_short_text"] = $this->replace_special_chars($pc->website_status_short_text);
					$new_pc_obj["youtube_id_1"] = $this->replace_special_chars($pc->youtube_id_1);
					$new_pc_obj["youtube_id_2"] = $this->replace_special_chars($pc->youtube_id_2);
				...
				elseif ($sku != "" && $sku != null)
				{
					...
					$new_pc_obj->set_short_desc($this->replace_special_chars($pc->short_desc));	
					...
					$new_pc_obj->set_series($this->replace_special_chars($pc->series));
					...
					$new_pc_obj->set_model_1($this->replace_special_chars($pc->model_1));
					$new_pc_obj->set_model_2($this->replace_special_chars($pc->model_2));
					$new_pc_obj->set_model_3($this->replace_special_chars($pc->model_3));
					$new_pc_obj->set_model_4($this->replace_special_chars($pc->model_4));
					$new_pc_obj->set_model_5($this->replace_special_chars($pc->model_5));
					...
					$new_pc_obj->set_extra_info($this->replace_special_chars($pc->extra_info));				
					$new_pc_obj->set_website_status_long_text($this->replace_special_chars($pc->website_status_long_text));
					$new_pc_obj->set_website_status_short_text($this->replace_special_chars($pc->website_status_short_text));
					$new_pc_obj->set_youtube_id_1($this->replace_special_chars($pc->youtube_id_1));
					$new_pc_obj->set_youtube_id_2($this->replace_special_chars($pc->youtube_id_2));
