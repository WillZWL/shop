...
class Price_website_service extends Price_service
{
    private $wms_wh_srv;
    ...
    public function __construct()
    {
        ...
        include_once(APPPATH."libraries/service/Ext_category_mapping_service.php");
        $this->set_ext_category_mapping_service(new Ext_category_mapping_service());
    }
    ...
    public function get_ext_category_mapping_service()
    {
        return $this->ext_category_mapping_service;
    }

    public function set_ext_category_mapping_service(Base_service $svc)
    {
        $this->ext_category_mapping_service = $svc;
    }
