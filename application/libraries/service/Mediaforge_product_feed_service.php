...
class Mediaforge_product_feed_service extends Data_feed_service
{
	...
	public function gen_data_feed($platform_id, $explain_sku = "")
	{
		...
		switch ($platform_id)
		{
			case 'WEBFR': $country='FR'; $countryname='france'; break;
			case 'WEBES': $country='ES'; $countryname='spain';  break;
			case 'WEBNZ': $country='NZ'; $countryname='new_zealand'; break; #SBF #2833
			case 'WEBSG': $country='SG'; $countryname='singapore'; break; #SBF #2834
			case 'WEBMY': $country='MY'; $countryname='malaysia'; break; #SBF #2835
			case 'WEBIT': $country='IT'; $countryname='italy'; break; #SBF #2836
			default: echo "Please input correct platform_id"; break;
		}
