...
class Rpt_order_not_in_ria_report_service extends Report_service
{
    private $so_service;
    ...
    {
        set_time_limit(300);
        $arr = $this->get_so_service()->get_dao()->get_order_not_in_ria_report($where, array("limit"=>-1));
    ...
    {
        set_time_limit(300);
        $arr = $this->get_so_service()->get_dao()->get_order_not_in_ria_report($where, $option);
        return $arr;
    }
