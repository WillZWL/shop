...
class Pmgw_report_paypal_hk_dto extends Base_dto
{
    //class variable
    private $date;
    private $time;
...
/* End of file pmgw_report_paypal_hk_dto.php */
/* Location: ./system/application/libraries/dto/pmgw_report_paypal_hk_dto.php */
