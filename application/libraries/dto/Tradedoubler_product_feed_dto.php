...
class Tradedoubler_product_feed_dto extends Base_dto
{
    private $sku;
    private $ext_sku;
    private $detail_desc;
    ...
    public function get_prod_feed()
    {
        return $this->prod_feed;
    }

    public function set_prod_feed($value)
    {
        $this->prod_feed = $value;
    }
