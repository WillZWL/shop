...
class Shopping_com_fr_product_feed_dto extends Base_dto
{
    private $sku;
    private $ext_sku;
    private $detail_desc;
...
/* End of file shopping_com_fr_product_feed_dto.php */
/* Location: ./system/application/libraries/dto/shopping_com_fr_product_feed_dto.php */