...
class Platform_biz_var_w_platform_name_dto extends Base_dto
{
    ...
    public function set_platform_name($value)
    {
        $this->platform_name = $value;
        return $this;
    }
    ...
    public function set_platform_country($value)
    {
        $this->platform_country = $value;
        return $this;
    }
