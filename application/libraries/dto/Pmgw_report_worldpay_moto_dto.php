...
class Pmgw_report_worldpay_moto_dto extends Base_dto
{
    //class variable
    private $full_so_no;
    private $txn_time;
...
/* End of file pmgw_report_worldpay_moto_dto.php */
/* Location: ./system/application/libraries/dto/pmgw_report_worldpay_moto_dto.php */
