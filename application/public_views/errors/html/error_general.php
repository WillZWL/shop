...
<head>
    ...
    <!-- load fonts -->
    <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,700&amp;subset=latin,cyrillic" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="/resources/css/style<?php print ($lang_id != 'en') ? ("_" . $lang_id) : ""; ?>.css" rel="stylesheet"
    ...
    <div class="wrapper">
        <div id="header">
            <ul id="head-nav">
                ...
                <li><a href="http://www.valuebasket.com/myaccount/myaccount?x_sign_in=1"
                       title="My account"><?= $ini_array["default_menu_my_account"]; ?></a></li>
                <li><a href="http://www.valuebasket.com/display/view/shipping"
                       title="Shipping"><?= $ini_array["default_menu_shipping"]; ?></a></li>
                <li><a href="http://www.valuebasket.com/contact"
                       title="Contact Us"><?= $ini_array["default_menu_contact_us"]; ?></a></li>
                <li><a href="http://www.valuebasket.com/display/view/faq"
                       title="Help"><?= $ini_array["default_menu_help"]; ?></a></li>
            </ul>
            <div class="separator">
                <div></div>
            </div>
            ...
            <div id="search" class="fix box-shadow-2">
                <form action="" method="get">
                    <input type="text" value="<?= $ini_array['default_text_find_your_product'] ?>" class="input"
                           name="w" title="<?= $ini_array['default_text_find_your_product'] ?>"/>
        ...
        <div id="footer">
            ...
            <div id="footer-bottom">
                <address><?= $ini_array["footer_text_all_rights_reserved"]; ?>/ <a
                        href="https://www.valuebasket.com/display/view/about_us"><?= $ini_array["footer_text_about_us"]; ?></a>
                    / <a href="/blog"><?= $ini_array["footer_text_blog"]; ?></a> / <a
                        href="https://www.valuebasket.com/display/view/conditions_of_use"><?= $ini_array["footer_text_conditions_of_use"]; ?></a>
                    / <a
                        href="https://www.valuebasket.com/display/view/privacy_policy"><?= $ini_array["footer_text_privacy_policy"]; ?></a>
                </address>
            </div>
        </div>
    </div>
