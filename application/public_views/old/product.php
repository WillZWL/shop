        ...
        <td>
            ...
            if ($prod_obj->get_flash() != "") {
                ...
                <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="190" height="190">
                    <param name="movie"
                           value="<?= base_url() ?>images/product/<?= $prod_obj->get_sku() ?>.<?= $prod_obj->get_flash() ?>"/>
                    <param name="wmode" value="transparent"/>
                    <!--[if !IE]>-->
                    <object type="application/x-shockwave-flash"
                            data="<?= base_url() ?>images/product/<?= $prod_obj->get_sku() ?>.<?= $prod_obj->get_flash() ?>"
                            width="190" height="190">
                        <!--<![endif]-->
                        <p><img border=0px
                                src="<?= base_url() ?>images/product/<?= $prod_obj->get_sku() ?>.<?= $prod_obj->get_image() ?>"/>
                        </p>
                        <!--[if !IE]>-->
                        <param name="wmode" value="transparent"/>
                    </object>
            ...
            <?php
                ...
                <a href="<?= base_url() . get_image_file($prod_obj->get_image(), '', $sku); ?>" class="top_up">
                    <img border="3px" src="<?= base_url() ?><?= get_image_file($prod_obj->get_image(), '', $sku); ?>"
                         width="190" height="190" border="1"/>
                </a>
            <?php
            }
            ?>
                ...
                if ($prod_obj->get_flash() != "") {
                    ...
                    <font face="Arial, Helvetica, sans-serif" size="1" color="#8e8e8e">
                        <a href="<?= base_url() ?>images/product/<?= $prod_obj->get_sku() . "." . $prod_obj->get_flash() ?>"
                           toptions="width = 550, height = 400, title = 360 Degree Product View, effect = switch">
                            <img border=0px src="<?= base_url() ?>images/04products_magglass.gif" width="11"
                                 height="11"/>&nbsp;<strong>Click to Enlarge</strong>
                        </a>
                    </font>
                <?php
                } else {
                    ...
                    <font face="Arial, Helvetica, sans-serif" size="1" color="#8e8e8e">
                        <a href="<?= base_url() . get_image_file($prod_obj->get_image(), '', $sku); ?>" class="top_up">
                            <img border=0px src="<?= base_url() ?>images/04products_magglass.gif" width="11"
                                 height="11"/>&nbsp;<strong>Click to Enlarge</strong></a>
                    </font>
                <?php
                }
                ?>
                                                                ...
                                                                <div class="iscrollable">
                                                                    <div class="iitems">
                                                                        ...
                                                                        if ($prod_obj->get_flash() != "") {
                                                                            ...
                                                                            ?>
                                                                            <img
                                                                                onclick="updateDisplayImage('<?= base_url() . "images/product/" . $prod_obj->get_sku() ?>', '<?= $prod_obj->get_image() ?>', '<?= $prod_obj->get_flash() ?>', 'flash')"
                                                                                width="36px" height="36px"
                                                                                src="<?= base_url() . "images/360image.gif" ?>"/>
                                                                            <?php
                                                                        ...
                                                                        foreach ($prod_image as $rskey => $image_obj) {
                                                                            ...
                                                                            ?>
                                                                            <img
                                                                                onclick="openTab();updateDisplayImage('<?= base_url() . "images/product/" . $image_obj->get_sku() . "_" . $image_obj->get_id() ?>', '<?= $image_obj->get_image() ?>', '', 'image')"
                                                                                width="38px" height="38px"
                                                                                src="<?= base_url() . "images/product/" . $image_obj->get_sku() . "_" . $image_obj->get_id() . "_s." . $image_obj->get_image() ?>"/>
                                                                            <?php
                                                                            if (($count) % 4 == 0 || $count == $total_items) {
                                                                                echo "</div>";
                                                                            }
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top"><font face="Arial, Helvetica, sans-serif"
                                                                               size="4"><strong><?= $prod_cont_obj->get_prod_name() ?></strong></font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <?php
                                                        ...
                                                        <td align="left"><font face="Arial, Helvetica, sans-serif"
                                                            ...
                                                            <?php if (!($prod_type['VIRTUAL'] == 1 && $prod_type['TRIAL'] == 1)) { ?>
                                                                <font face="Arial, Helvetica, sans-serif" size="1"
                                                                      color="#8eb53a"><strong>Usually ships
                                                                        in <?= $working_day ?> Business
                                                                        Days</strong></font>
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
                                                ...
                                                <table cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td rowspan="3" align="left">
                                                            ...
                                                            <div align="right">
                                                                <a href="http://www.facebook.com/pages/Chat-and-Vision/132709896785104"><img
                                                                        src="<?= base_url() ?>images/facebook.png"/></a>&nbsp;&nbsp;<a
                                                                    href="http://twitter.com/valuebasket"><img
                                                                        src="<?= base_url() ?>images/twitter.png"/></a>
                                                            </div>
                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="280" align="left">
                                                                            ...
                                                                            if (!empty($main_prod_video)) {
                                                                                ...
                                                                                if ($http) {
                                                                                    ?>
                                                                                    <a href="http://www.youtube.com/v/<?= $ref_id ?>&amp;fs=1&amp;rel=0&amp;border=1"
                                                                                       toptions="group = iv, type = flash, effect = show, width = 830, height = 495, overlayClose = 1, layout = quicklook, shaded = 1, title = {alt} ({current} of {total})"><img
                                                                                            height="41" width="96"
                                                                                            src="<?= base_url() ?>images/viewvideo.gif"/></a>
                                                                                <?php
                                                                                } else {
                                                                                    ?>
                                                                                    <a href="https://www.youtube.com/v/<?= $ref_id ?>&amp;fs=1&amp;rel=0&amp;border=1"
                                                                                       toptions="group = iv, type = flash, effect = show, width = 830, height = 495, overlayClose = 1, layout = quicklook, shaded = 1, title = {alt} ({current} of {total})"><img
                                                                                            height="41" width="96"
                                                                                            src="<?= base_url() ?>images/viewvideo.gif"/></a>
                                                                                <?php
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="280" align="left">
                                                                            ...
                                                                            if ($http) {
                                                                                ?>
                                                                                <a href="http://www.youtube.com/v/oXcu5dWIKuk&amp;fs=1&amp;rel=0&amp;border=1"
                                                                                   toptions="group = iv, type = flash, effect = show, width = 830, height = 495, overlayClose = 1, layout = quicklook, shaded = 1, title = {alt} ({current} of {total})"><img
                                                                                        height="41" width="96"
                                                                                        src="<?= base_url() ?>images/AboutUsVideo.png"/></a>
                                                                            <?php
                                                                            } else {
                                                                                ?>
                                                                                <a href="https://www.youtube.com/v/oXcu5dWIKuk&amp;fs=1&amp;rel=0&amp;border=1"
                                                                                   toptions="group = iv, type = flash, effect = show, width = 830, height = 495, overlayClose = 1, layout = quicklook, shaded = 1, title = {alt} ({current} of {total})"><img
                                                                                        height="41" width="96"
                                                                                        src="<?= base_url() ?>images/AboutUsVideo.png"/></a>
                                                                            <?php
                                ...
                                <td width="250" valign="top">
                                    <table width="250" border="0" cellspacing="5" cellpadding="0">
                                        ...
                                        if ($prod_type['VIRTUAL'] == 1 && $prod_type['TRIAL'] == 1) {
                                            ?>
                                            <tr>
                                                <td align="right" colspan="2" nowrap style="white-space:nowrap"><font
                                                        face="Arial, Helvetica, sans-serif" size="5"
                                                        color="red"><strong>Free !</strong></font>&nbsp;</td>
                                            </tr>
                                        <?php
                                        } else {
                                            ?>
                                            <tr>
                                                <td>&nbsp;&nbsp;<font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#999999"><b>MSRP:</b></font></td>
                                                <td width="80" align="right" colspan="2"><font
                                                        face="Arial, Helvetica, sans-serif" size="3" color="#999999">
                                                        <del><?= platform_curr_format(PLATFORMID, $prod_rrp) ?></del>
                                                    </font>&nbsp;&nbsp;</td>
                                            </tr>
                                            <!--
                                            <tr>
                                            ...
                                            <tr>
                                                <td>&nbsp;&nbsp;<font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#FF6600"><b>You Save:</b></font></td>
                                                <td width="80" align="right" colspan="2"><font
                                                        face="Arial, Helvetica, sans-serif" size="3"
                                                        color="#FF6600"><b><?= platform_curr_format(PLATFORMID, $prod_saved) ?></b></font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"></td>
                                                <td align="right" colspan="2" nowrap style="white-space:nowrap">&nbsp;&nbsp;<font
                                                        face="Arial, Helvetica, sans-serif" size="3" color="#FF6600"><b>Free
                                                            Delivery</b></font></td>
                                            </tr>
                                            <tr>
                                                <td height="5px"></td>
                                            ...
                                            <tr>
                                                <td>&nbsp;&nbsp;<font face="Arial, Helvetica, sans-serif" size="4"
                                                                      color="#00aff0"><strong>Our Price:</strong></font>
                                                </td>
                                                <?= $price ?>
                                                <td align="right" colspan="2" nowrap style="white-space:nowrap"><font
                                                        face="Arial, Helvetica, sans-serif" size="5"
                                                        color="#00aff0"><strong><?= platform_curr_format(PLATFORMID, $prod_price) ?></strong></font>
                                                </td>
                                            </tr>
                                        <?php
                                        }
                                        ...
                                        if ($quantity) {
                                            ...
                                            <tr height="40px" valign="bottom">
                                                <td align="right" colspan="3">&nbsp;&nbsp;<font
                                                        face="Arial, Helvetica, sans-serif"
                                                        size="2"><strong>Quantity:</strong></font>&nbsp;&nbsp;
                                                        ...
                                                        <tr>
                                                            <td colspan="2" align="center" height="40px">
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                       width="226">
                                                                    <tr>
                                                                        <td onclick="addToCart('<?= $sku ?>')"
                                                                            background="<?= base_url() ?>images/addtobasket.gif"
                                                                            style="width:100%;cursor:pointer"
                                                                            height="45" width="70">
                                                                            <font face="Arial, Helvetica, sans-serif"
                                                                                  size="3" color="#ffffff"
                                                                                  style="padding-left:40px;padding-right:55px"><strong>Add
                                                                                    to Basket</strong></font>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <?php if (!empty($ra_list)) { ?>
                                    <td width="220" height="26" align="center"
                                        background="<?= base_url() ?>images/oftenboughtbkgrd.gif"><font
                                            face="Arial, Helvetica, sans-serif" size="3" color="#ffffff"><strong>Often
                                                bought with</strong></font></td>
                                <?php } ?>
                            </tr>
                            <tr>
                                <td>
                                    ...
                                    if (!empty($ra_list)) {
                                        ...
                                        <table width="100%" height="25" border="0" cellspacing="0" cellpadding="0"
                                               style="border-width:1px;border-color:#60D4FF;border-style:solid">
                                            <?php
                                                    ...
                                                    <tr>
                                                        <td height="20">
                                                            <table width="210" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center"><a
                                                                            href="<?= base_url() ?>mainproduct/view/<?= $ra_item->get_sku() ?>"><img
                                                                                border="0px"
                                                                                src="<?= base_url() ?><?= get_image_file($ra_item->get_image(), 'l', $ra_item->get_sku()); ?>"
                                                                                width="80" height="80"/></a></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center"><a
                                                                            href="<?= base_url() ?>mainproduct/view/<?= $ra_item->get_sku() ?>"><font
                                                                                face="Arial, Helvetica, sans-serif"
                                                                                size="2"><strong><?= $ra_item->get_content_prod_name() ? $ra_item->get_content_prod_name() : $ra_item->get_prod_name(); ?></strong></font></a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center" nowrap
                                                                        style="white-space:nowrap"><font
                                                                            face="Arial, Helvetica, sans-serif" size="3"
                                                                            color="#00aff0"><strong><?= platform_curr_format(PLATFORMID, $ra_item->get_price()) ?></strong></font>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center">
                                                                        <table width="80" border="0" cellspacing="0"
                                                                               cellpadding="0">
                                                                            <tr>
                                                                                <td onclick="document.location.href = '<?= base_url() . "cart/add_item?sku=" . $ra_item->get_sku() ?>'"
                                                                                    width="80" height="22"
                                                                                    align="center"
                                                                                    background="<?= base_url() ?>images/addthebasket.gif"
                                                                                    style="background-repeat:no-repeat;cursor:pointer">
                                                                                    <font
                                                                                        face="Arial, Helvetica, sans-serif"
                                                                                        size="1"
                                                                                        color="#ffffff"><strong>add to
                                                                                            basket</strong></font>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                    ...
                    <td width="798" valign="top">
                        ...
                        <dl id="ra_tab">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table width="740" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td><img
                                                                                src="<?= base_url() ?>images/04products_say_01.gif"/>
                                                                        </td>
                                                                        <td background="<?= base_url() ?>images/04products_say_02.gif">
                                                                            <img
                                                                                src="<?= base_url() ?>images/04products_say_02.gif"
                                                                                width="760" height="5"/></td>
                                                                        <td><img
                                                                                src="<?= base_url() ?>images/04products_say_03.gif"/>
                                                                        </td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td background="<?= base_url() ?>images/04products_say_04.gif"
                                                                            style="background-repeat:no-repeat"><img
                                                                                src="<?= base_url() ?>images/04products_say_04.gif"/>
                                                                        </td>
                                                                        <td align="center"><font
                                                                                face="Arial, Helvetica, sans-serif"
                                                                                size="3"><strong>What we
                                                                                    say:</strong></font></td>
                                                                        <td background="<?= base_url() ?>images/04products_say_06.gif"
                                                                            style="background-repeat:repeat"><img
                                                                                src="<?= base_url() ?>images/04products_say_06.gif"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td background="<?= base_url() ?>images/04products_say_04.gif"
                                                                        ...
                                                                        <td align="center"><img
                                                                                src="<?= base_url() ?>images/03Subcategory_line.gif"
                                                                                width="680" height="2"/></td>
                                                                        <td background="<?= base_url() ?>images/04products_say_06.gif"
                                                                            style="background-repeat:repeat"><img
                                                                                src="<?= base_url() ?>images/04products_say_06.gif"/>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="735">
                                                                            <table align="center" width="735" border="0"
                                                                                   cellspacing="0" cellpadding="3">
                                                                                <tr>
                                                                                    <td align="center" valign="top"><img
                                                                                            src="<?= base_url() ?>images/quote_01.gif"
                                                                                            width="14" height="11"/>
                                                                                    </td>
                                                                                    <td width="710" align="center"><font
                                                                                            face="Arial, Helvetica, sans-serif"
                                                                                            size="2"><?= $prod_cont_obj->get_short_desc() ?></font>
                                                                                    </td>
                                                                                    <td align="center" valign="bottom">
                                                                                        <img
                                                                                            src="<?= base_url() ?>images/quote_02.gif"
                                                                                            width="14" height="11"/>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                    ...
                                                                    <tr>
                                                                        <td><img
                                                                                src="<?= base_url() ?>images/04products_say_07.gif"/>
                                                                        </td>
                                                                        <td background="<?= base_url() ?>images/04products_say_08.gif">
                                                                            <img
                                                                                src="<?= base_url() ?>images/04products_say_08.gif"
                                                                                width="760"/></td>
                                                                        <td><img
                                                                                src="<?= base_url() ?>images/04products_say_09.gif"/>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                if (!empty($feature)) {
                                                                    ...
                                                                    <tr>
                                                                        <td><font face="Arial, Helvetica, sans-serif"
                                                                                  size="4"><strong>Features</strong></font>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td height="10" align="center">
                                                                ...
                                                                if (!empty($requirement)) {
                                                                    ...
                                                                    <tr>
                                                                        <td><font face="Arial, Helvetica, sans-serif"
                                                                                  size="4"><strong>Requirements</strong></font>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td height="10" align="center">
                            ...
                            if ($prod_spec) {
                                ...
                                <dd id="spec">
                                    <table summary="specifications" width="100%" cellspacing="0" cellpadding="2"
                                           style="border-width:1px; border-color:#DADADA; border-style:solid; border-collapse:collapse;text-indent:1em;"
                                           rules="rows">
                                        <?php
                                            ...
                                            foreach ($ps_array AS $ps_key => $ps_obj) {
                                                ...
                                                <tr style="border-width:1px; border-color:#DADADA; border-style:solid;">
                                                    <td width="30%" bgcolor="#ECECEC"><font
                                                            face="Arial, Helvetica, sans-serif"
                                                            size="2"><b><?= $ps_key ?></b></font></td>
                                                    <td><font face="Arial, Helvetica, sans-serif"
                                                              size="2"><?= $ps_value ?></font></td>
                                                </tr>
                                            <?php
                                            }
                                        }
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr height="40px">
                                            <td valign="middle"><font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#333333"><strong>Customers who bought
                                                        "<?= $prod_obj->get_name() ?>" also bought these
                                        ...
                                        <tr>
                                            <td bgcolor="#ECECEC">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td><font face="Arial, Helvetica, sans-serif" size="2"
                                                                  color="#ffffff"><strong>&nbsp;</strong></font><font
                                                                face="Arial, Helvetica, sans-serif" size="2"
                                                                color="#ffffff"><strong>&nbsp;</strong></font><font
                                                                face="Arial, Helvetica, sans-serif" size="2">Product
                                                                Details</font></td>
                                                        <td width="80" align="center"><font
                                                                face="Arial, Helvetica, sans-serif"
                                                                size="2">Price</font></td>
                                                        <td width="80" align="center"><font
                                                                face="Arial, Helvetica, sans-serif" size="2">Stock
                                                                Details</font></td>
                                                        <td width="100">&nbsp;</td>
                                                    </tr>
                                                </table>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table width="100%" border="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td width="120"><a
                                                                                    href="<?= base_url() . "mainproduct/view/" . $item->get_sku() ?>"><img
                                                                                        src="<?= base_url() . get_image_file($item->get_image(), 'm', $item->get_sku()) ?>"
                                                                            ...
                                                                            <td>
                                                                                <table width="100%" border="0"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <a href="<?= base_url() . "mainproduct/view/" . $item->get_sku() ?>"><font
                                                                                                    face="Arial, Helvetica, sans-serif"
                                                                                                    size="2"><strong><?= $item->get_prod_name() ?></strong></font></a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td><font
                                                                                                face="Arial, Helvetica, sans-serif"
                                                                                                size="2"><?= $item->get_detail_desc() ?></font>
                                                                                            <br/><a
                                                                                                href="<?= base_url() . "mainproduct/view/" . $item->get_sku() ?>"><font
                                                                                                    face="Arial, Helvetica, sans-serif"
                                                                                                    size="1"
                                                                                                    color="#666666">click
                                                                                                    here for more
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="80" align="center"
                                                                                            ...
                                                                                            <font
                                                                                                face="Arial, Helvetica, sans-serif"
                                                                                                size="4"
                                                                                                color="#00aff0"><strong><?= platform_curr_format(PLATFORMID, $item->get_price()) ?></strong></font>
                                                                                        </td>
                                                                                        <td width="80" align="center">
                                                                                            <font
                                                                                                face="Arial, Helvetica, sans-serif"
                                                                                                size="1"
                                                                                                color="#8eb53a"><strong><?= $dstr ?></strong></font>
                                                                                        </td>
                                                                                        <td width="100" align="center">
                                                                                            <table width="79" border="0"
                                                                                                ...
                                                                                                if ($quantity) {
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td onclick="document.location.href = '<?= base_url() . "cart/add_item?sku=" . $ra_item->get_sku() ?>'"
                                                                                                            background="<?= base_url() ?>images/03Subcategory_addtobasket.gif"
                                                                                                            style="width:100%;cursor:pointer"
                                                                                                            height="23">
                                                                                                            <font
                                                                                                                face="Arial, Helvetica, sans-serif"
                                                                                                                size="2"
                                                                                                                color="#ffffff"
                                                                                                                style="padding-left:8px;padding-right:27px"><strong>Add
                                                                                                                    to</strong></font>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                <?php
                            ...
                            if ($show_tab['bundle']) {
                                ...
                                <dd id="bundle">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr height="40px">
                                            <td valign="middle"><font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#00aff0"><strong>Buy these Recommended
                                                        Bundles for more savings!</strong></font></td>
                                        </tr>
                                        <tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    foreach ($b_obj->get_component_sku_list() as $component) {
                                                                                        if ($count > 0) {
                                                                                            ?>
                                                                                            <td align="center"><img
                                                                                                    src="<?= base_url() ?>images/bundleplus.gif"
                                                                                                    width="10"
                                                                                                    height="10"/></td>
                                                                                        <?php
                                                                                        }
                                                                                        ...
                                                                                        <td align="center">
                                                                                            <div class="bundle-image"
                                                                                                ...
                                                                                                <a class="info"
                                                                                                   href="<?= base_url() ?>product_skype/info/<?= $component['component_sku'] ?>"
                                                                                                   rel="lyteframe"
                                                                                                   rev="width: 600px; height:527px; scrolling: auto;padding: 40px;">
                                                                                                    <img
                                                                                                        class="prod-img"
                                                                                                        src="<?= base_url() . get_image_file($component['component_image_file_ext'], 'm', $component['component_sku']) ?>"
                                                                                                        width="50"
                                                                                                        height="50"/>
                                                                                                </a>
                                                                                                ...
                                                                                                <div class="modal">
                                                                                                    <img
                                                                                                        name="large_image"
                                                                                                        src="<?= base_url() . get_image_file($component['component_image_file_ext'], 'l', $component['component_sku']) ?>"
                                                                                                        border="0"
                                                                                                        width="150"
                                                                                                        height="150"/>
                                                                                                </div>
                                                                                                    ...
                                                                                                    <font
                                                                                                        ...
                                                                                                        foreach ($b_obj->get_component_sku_list() as $component) {
                                                                                                            ...
                                                                                                            if ($sku != $component['component_sku']) {
                                                                                                                ?>
                                                                                                                <a class="info"
                                                                                                                   href="<?= base_url() ?>mainproduct/info/<?= $component['component_sku'] ?>"
                                                                                                                   rel="lyteframe"
                                                                                                                   rev="width: 600px; height:527px; scrolling: auto;padding: 40px;">
                                                                                                                    <font
                                                                                                                        face="Arial, Helvetica, sans-serif"
                                                                                ...
                                                                                <tr>
                                                                                    <td width="80" align="center" nowrap
                                                                                        style="white-space:nowrap"><font
                                                                                            face="Arial, Helvetica, sans-serif"
                                                                                            size="4"
                                                                                            color="#00aff0"><strong><?= platform_curr_format(PLATFORMID, $b_obj->get_total_price()) ?></strong></font>
                                                                                    </td>
                                                                                    <td width="80" align="center"><font
                                                                                            face="Arial, Helvetica, sans-serif"
                                                                                            size="1"
                                                                                    ...
                                                                                    <td width="100" align="center">
                                                                                        <table width="79" border="0"
                                                                                            ...
                                                                                            <tr>
                                                                                                <?if ($quantity) {
                                                                                                    ?>
                                                                                                    <td onclick="document.location.href = '<?= base_url() . "cart/add_item?sku=" . $b_obj->get_prod_sku() ?>'"
                                                                                                        background="<?= base_url() ?>images/03Subcategory_addtobasket.gif"
                                                                                                        style="width:100%;cursor:pointer"
                                                                                                        height="23">
                                                                                                        <font
                                                        ...
                                                        <tr>
                                                            <td><font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#ffffff"><strong>
                                                                        &nbsp;&nbsp;</strong></font><font
                                                                    face="Arial, Helvetica, sans-serif"
                                                                    size="2"><strong>View our Reviews</strong></font>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0"
                                                                        ...
                                                                        if ($http) {
                                                                            ...
                                                                            <td align="center">
                                                                                <object width="554" height="344">
                                                                                    <param name="movie"
                                                                                           value="http://www.youtube.com/v/<?= $ref_id ?>&amp;fs=1"></param>
                                                                                    ...
                                                                                    <param name="autoplay"
                                                                                           value="0"></param>
                                                                                    <embed
                                                                                        src="http://www.youtube.com/v/<?= $ref_id ?>&amp;fs=1"
                                                                                ...
                                                                                <br/>
                                                                                <a href="http://www.youtube.com/v/<?= $ref_id ?>&amp;fs=1&amp;rel=0&amp;border=1"
                                                                                   toptions="group = fr, type = flash, effect = show, width = 830, height = 495, overlayClose = 1, layout = quicklook, shaded = 1, title = {alt} ({current} of {total})"><span
                                                                                        style="font-size:10px;color:blue;"><b>Enlarge
                                                                                            Video</b></span></a>
                                                                            </td>
                                                                        <?php
                                                                        } else {
                                                                            ...
                                                                            <td align="center">
                                                                                <object width="554" height="344">
                                                                                    <param name="movie"
                                                                                           value="https://www.youtube.com/v/<?= $ref_id ?>&amp;fs=1"></param>
                                                                                    <param name="allowFullScreen"
                                                                                           value="true"></param>
                                                                                    <param name="allowscriptaccess"
                                                                                           value="always"></param>
                                                                                    ...
                                                                                    <param name="autoplay"
                                                                                           value="0"></param>
                                                                                    <embed
                                                                                        src="https://www.youtube.com/v/<?= $ref_id ?>&amp;fs=1"
                                                                                        type="application/x-shockwave-flash"
                                                                                        wmode="transparent"
                                                                                        allowscriptaccess="always"
                                                                                        allowfullscreen="true"
                                                                ...
                                                                if (!empty($featured_review_video)) {
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"><font
                                                                                face="Arial, Helvetica, sans-serif"
                                                                                size="3"><?= get_video_title($ref_id, $src); ?></font>
                                                                        </td>
                                                                    </tr>
                                                                <?php
                                                                }
                                                                            ...
                                                                            <div class="scrollable">
                                                                                ...
                                                                                <div class="items">
                                                                                    ...
                                                                                    foreach ($latest_review_video as $count => $rv_obj) {
                                                                                        ...
                                                                                        if ($http) {
                                                                                            ?><a
                                                                                            href="http://www.youtube.com/v/<?= $rv_obj->get_ref_id() ?>&amp;fs=1&amp;rel=0&amp;border=1"
                                                                                            toptions="group = lrv, type = flash, effect = show, width = 830, height = 495, overlayClose = 1, layout = quicklook, shaded = 1, title = {alt} ({current} of {total})">
                                                                                            <img
                                                                                                src="http://img.youtube.com/vi/<?= $rv_obj->get_ref_id() ?>/1.jpg"
                                                                                                valign="center"
                                                                                                width="124px"
                                                                                                height="96px" title=""
                                                                                                alt="View our Reviews"
                                                                                                border="0"/></a>
                                                                                            <br/><font
                                                                                                face="Arial, Helvetica, sans-serif"
                                                                                                size="2"><?= get_video_title($rv_obj->get_ref_id(), $rv_obj->get_src()) ?></font><?php
                                                                                        } else {
                                                                                            ?><a
                                                                                            href="https://www.youtube.com/v/<?= $rv_obj->get_ref_id() ?>&amp;fs=1&amp;rel=0&amp;border=1"
                                                                                            toptions="group = lrv, type = flash, effect = show, width = 830, height = 495, overlayClose = 1, layout = quicklook, shaded = 1, title = {alt} ({current} of {total})">
                                                                                            <img
                                                                                                src="http://img.youtube.com/vi/<?= $rv_obj->get_ref_id() ?>/1.jpg"
                                                                                                valign="center"
                                                        ...
                                                        <tr>
                                                            <td><font face="Arial, Helvetica, sans-serif" size="2"
                                                                      color="#ffffff"><strong>
                                                                        &nbsp;&nbsp;</strong></font><font
                                                                    face="Arial, Helvetica, sans-serif"
                                                                    size="2"><strong>View our Guides</strong></font>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
                                                                    ...
                                                                    if (!empty($featured_guide_video)) {
                                                                        ...
                                                                        if ($http) {
                                                                            ...
                                                                            <td align="center">
                                                                                ...
                                                                                <br/>
                                                                                <a href="http://www.youtube.com/v/<?= $ref_id ?>&amp;fs=1&amp;rel=0&amp;border=1"
                                                                                   toptions="group = fg, type = flash, effect = show, width = 830, height = 495, overlayClose = 1, layout = quicklook, shaded = 1, title = {alt} ({current} of {total})"><span
                                                                                        style="font-size:10px;color:blue;"><b>Enlarge
                                                                                            Video</b></span></a>
                                                                            </td>
                                                                        <?php
                                                                            ...
                                                                            <div class="scrollable">
                                                                                ...
                                                                                <div class="items">
                                                                                    ...
                                                                                    foreach ($latest_guide_video as $count => $gv_obj) {
                                                                                        ...
                                                                                        if ($gv_obj->get_src() == "Y") {
                                                                                            ?><a
                                                                                            href="http://www.youtube.com/v/<?= $gv_obj->get_ref_id() ?>&amp;fs=1&amp;rel=0&amp;border=1"
                                                                                            toptions="group = lgv, type = flash, effect = show, width = 830, height = 495, overlayClose = 1, layout = quicklook, shaded = 1, title = {alt} ({current} of {total})">
                                                                                            <img
                                                                                                src="http://img.youtube.com/vi/<?= $gv_obj->get_ref_id() ?>/1.jpg"
                                                                                                valign="center"
                                                                                                width="124px"
                                                                                                height="96px" title=""
                                                                                                alt="View our Guides"
                                                                                            ...
                                                                                            <br/><font
                                                                                                face="Arial, Helvetica, sans-serif"
                                                                                                size="2"><?= get_video_title($gv_obj->get_ref_id(), $gv_obj->get_src()) ?></font><?php
                                                                                        } elseif ($gv_obj->get_src() == "V") {
                                                                                            ?><a
                                                                                            href="http://view.vzaar.com/<?= $gv_obj->get_ref_id() ?>.flashplayer"
                                                                                            toptions="group = lgv, type = flash, effect = show, width = 830, height = 495, overlayClose = 1, layout = quicklook, shaded = 1, title = {alt} ({current} of {total})">
                                                                                            <img
                                                                                                src="http://vzaar.com/videos/<?= $gv_obj->get_ref_id() ?>.thumb"
                                                                                                title=""
                                                                                                alt="View our Guides"
                                                                                                border="0"/></a>
                                                                                            <br/><font
            ...
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="1010" align="center" bgcolor="#00AFF0"><font face="Arial, Helvetica, sans-serif"
                                                                                size="3" color="#ffffff"><strong>What Do
                                    Customers Ultimately Buy After Viewing This Item?</strong></font></td>
                        <td><img src="<?= base_url() ?>images/02category_94.gif" width="5" height="28"/></td>
                    </tr>
                    <tr>
                        <td background="<?= base_url() ?>images/02category_95.gif" style="background-repeat:repeat"><img
                                src="<?= base_url() ?>images/02category_95.gif" width="5" height="130"/></td>
                        <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                foreach ($ra_list as $rskey => $ra_item) {
                                    if ($rskey <= 3) {
                                        if ($rskey != 0) {
                                            ?>
                                            <tr>
                                                <td height="10" align="center"><img
                                                        src="<?= base_url() ?>images/03Subcategory_line.gif" width="750"
                                                        height="2"/></td>
                                            </tr>
                                        <?php
                                        }
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="120" align="center"><a
                                                                href="<?= base_url() . "mainproduct/view/" . $ra_item->get_sku() ?>"><img
                                                                    src="<?= base_url() ?><?= get_image_file($ra_item->get_image(), 'm', $ra_item->get_sku()); ?>"
                                                        ...
                                                        <td>
                                                            <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <a href="<?= base_url() . "mainproduct/view/" . $ra_item->get_sku() ?>"><font
                                                                                face="Arial, Helvetica, sans-serif"
                                                                                size="2"><strong><?= $ra_item->get_content_prod_name() ? $ra_item->get_content_prod_name() : $ra_item->get_prod_name(); ?></strong></font></a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><font face="Arial, Helvetica, sans-serif"
                                                                              size="2"><?= $ra_prod_cont_list[$rskey]->get_short_desc(); ?></font>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                                ...
                                                                                if ($ra_item->get_with_bundle()) {
                                                                                    ...
                                                                                    <td>
                                                                                        <a href="<?= base_url() . "mainproduct/view/" . $ra_item->get_sku() . "?tab=bundle" ?>">
                                                                                            <strong>&nbsp;<img
                                                                                                    src="<?= base_url() ?>images/buddle.gif"
                                                                                                    width="20"
                                                                                                    height="19"/>&nbsp;
                                                                                            </strong>
                                                                                            <font
                                                                                                face="Arial, Helvetica, sans-serif"
                                                                                                size="2">See available
                                                                                                bundles</font>
                                                                                        </a>
                                                                                    </td>
                                                                                <?php
                                                            ...
                                                            <table width="100" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center"><font
                                                                            ...
                                                                            color="#00aff0" nowrap
                                                                            style="white-space:nowrap"><strong><?= platform_curr_format(PLATFORMID, $ra_item->get_price()); ?></strong></font>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center">
                        ...
                        <td background="<?= base_url() ?>images/02category_97.gif" style="background-repeat:repeat"><img
                                src="<?= base_url() ?>images/02category_97.gif" width="5" height="130"/></td>
                    </tr>
                    <tr>
                        <td width="5" height="2"><img src="<?= base_url() ?>images/02category_98.gif" width="5"
                                                      height="2"/></td>
                        <td background="<?= base_url() ?>images/02category_99.gif" height="2"><img
                                src="<?= base_url() ?>images/02category_99.gif" width="1010" height="2"/></td>
                        <td width="5" height="2"><img src="<?= base_url() ?>images/02category_100.gif" width="5"
                                                      height="2"/></td>
                    </tr>
                </table>
            </td>
