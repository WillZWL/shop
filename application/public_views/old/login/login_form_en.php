    ...
    <table style="text-align:left" cellspacing="0" cellpadding="1" bgcolor="#87ceeb" width="500px" height="100">
        <tr>
            <td height="10px" colspan="3"
                style="text-align:center; font-weight:bold; border-left:1px solid #00AFF0; border-top:1px solid #00AFF0; border-right:1px solid #00AFF0; padding:8px; ">
        ...
        <tr>
            ...
            <td>Email:</td>
            <td style="border-right:1px solid #00AFF0;"><input name="email"
        ...
        <tr>
            ...
            <td colspan="2"
                style="text-align:center; border-right:1px solid #00AFF0; border-bottom:1px solid #00AFF0; padding:8px;">
                <a href="<?= base_url() ?>forget_password" style="color: #0000FF;text-decoration:underline">Forgotten
                    password? </a>
            </td>
