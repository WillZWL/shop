...
<!-- Login Form Start -->
<script type="text/javascript" src="<?=base_url()?>js/checkform.js?lang=<?=get_lang_id()?>"></script>
<?php
/*
if(strpos($back, "checkout") !== FALSE)
{
...
?>
	...
	<?php }?>
						...
						Continue shopping at <a href="http://shop.skype.com" style="text-decoration:underline;">Skype Shop</a>.
					</td>
