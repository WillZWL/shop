                            ...
                            <td>
                                <p>
                                    ...
                                    if ($so_ps && $so_ps->get_payment_status() == "S") {
                                        ?>
                                        Vi har skickat en order konfirmation till din registrerade e-mailadress: <?= $_SESSION["client"]["email"] ?>.
                                        <br/><br/>
                                    <?php
                                    } else {
                                        ?>
                                        Vi har skickat dig en orderkonfirmation för denna order till din registrerade e-mailadress: <?= $_SESSION["client"]["email"] ?>. Vi kommer informera dig igen när betalningen är klar.
                                        <br/><br/>
                                    <?php
                                    }
                                    ?>

                                    Om du har ytterligare frågor så tveka inte att besöka vår <a
                                        href="<?= base_url() ?>faq">F.A.Q</a> sida eller emaila oss på <a
                                        href="mailto:support-se@chatandvision.com">support-se@chatandvision.com</a> för
                                    vidare assistans.
                                </p>
                            </td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    Du kan se över betalningsinformationen angiven och försöka igen. I annat fall
                                    kontakta vår Kundtjänstpersonal på <a href="mailto:support-se@chatandvision.com">support-se@chatandvision.com</a><?= $so_no ? ", och ange följande referensnummer: {$so_no} för vidare assistans." : "." ?>
                                    <br/><br/>
