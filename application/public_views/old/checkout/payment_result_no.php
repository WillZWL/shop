                            ...
                            <td>
                                <p>
                                    ...
                                    if ($so_ps && $so_ps->get_payment_status() == "S") {
                                        ?>
                                        Vi har sendt en bekreftelse på denne bestillingen til din registrerte e-post på <?= $_SESSION["client"]["email"] ?>.
                                        <br/><br/>
                                    <?php
                                    } else {
                                        ?>
                                        Vi har sendt en anerkjennelse av denne bestillingen til din registrerte e-post til <?= $_SESSION["client"]["email"] ?>. Vi vil informere deg igjen når betalingen er fullført.
                                        <br/><br/>
                                    <?php
                                    }
                                    ?>

                                    Ved spørsmål, ikke nøl med å besøke vår <a href="<?= base_url() ?>faq">F.A.Q</a>
                                    side eller e-mail oss på <a href="mailto:support-no@chatandvision.com">support-no@chatandvision.com</a>
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    Det kan være lurt å gjennomgå faktureringsinformasjon og prøve igjen. Ellers kan du
                                    kontakte våre kundeserviceagenter på <a href="mailto:support-no@chatandvision.com">support-no@chatandvision.com</a><?= $so_no ? "  indikere dette referansenummeret: {$so_no} for videre assistanse. " : "." ?>
                                    <br/><br/>
                                    Vi beklager eventuelle ulemper dette måtte medføre, og håper å høre fra deg
                                    snart.<br/>
                                </p>
                            </td>
                            <td>&nbsp;</td>
