...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td>
                ...
                for ($j = 0; $j < count($chk_cart); $j++) {
                    ...
                    <tr>
                        <td rowspan="3" align="center">
                            <img src="<?= base_url() . get_image_file($item->get_image(), 'm', $item->get_sku()) ?>"
                                 border='0'/>
                        </td>
                        <td style="padding:3px;">
                            <font
                                size="2"><strong><?= $item->get_content_prod_name() ? $item->get_content_prod_name() : $item->get_prod_name() ?></strong></font>
                        </td>
                        <td align="right">
                            <font size="2"
                            ...
                            <?php
                                ...
                                if ($quantity) {
                                    ...
                                    <select name="qty<?= $idx ?>" id="select"
                                            onChange="Redirect('<?= base_url() . 'checkout_facebook/update/' . $chk_cart[$j]["sku"] ?>/' + this.value<?= $debug ? " + '/$debug'" : '' ?>)">
                                        <?php
                        ...
                        <td align="center">
                                    <span id="link">
                                        <font face="Arial, Helvetica, sans-serif" size="1" color="#8e8e8e">
                                            <a href="<?= base_url() . get_image_file($item->get_image(), '', $item->get_sku()); ?>"
                                               class="top_up" target="CV_Facebook">
                                                <strong>Click for a bigger view</strong>&nbsp;<img border=0px
                                                                                                   src="<?= base_url() ?>images/04products_magglass.gif"
                                                                                                   width="11"
                                                                                                   height="11"/></a>
                                        </font>
                                    </span>
                            ...
                            <tr>
                                <td>
                                    <form id="fm_delivery" name="fm_delivery"
                                          action="<?= base_url() ?>checkout_facebook<?= $debug ? "/index/1" : "" ?>"
                                          method="post">
                                        <?php
                                        if ($dc) {
                                            ...
                                            foreach ($dc as $courier_id => $ar_dc) {
                                                ...
                                                ?>
                                                <tr>
                                                    <td nowrap style="white-space:nowrap"><input type="radio"
                                                                                                 name="delivery"
                                                                                                 align="absbottom"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="line-height:20px;">
                            ...
                            <tr>
                                ...
                                <?php
                                    ...
                                    ?>
                                    <td colspan="2"><span id="promo_msg"
                                                          style="font-weight:bold;line-height:13px;"></span></td>
                                <?php
                                }
                                ?>
                            </tr>
                            <tr>
                                ...
                                <td align="right">
                                    <span id="span_total"
                                          style="font-weight: bold; color: rgb(0, 175, 240); font-size: 14px;"><?= platform_curr_format(PLATFORMID, ($grand_total = $total + $delivery - $promo_disc_amount)) ?></span>
                        ...
                        <table border="0" cellpadding="10" cellspacing="0" width="100%">
                            <tr valign="bottom">
                                ...
                                <td align="right"><input type="image"
                                                         ...
                                                         height="30" onClick="ProcessPaymentForm();"/></td>
                            </tr>
                        </table>
                    </td>
                </tr>
            ...
            <iframe width="<?= $iframe_width ?>px" height="<?= $iframe_height ?>px" noresize frameborder="0"
                    marginwidth="0" marginheight="0"
                    src="<?= base_url() ?>checkout_facebook/psform<?= $debug ? "?debug=1" : "" ?>" name='psform'
                    id="psform" style="display:none"></iframe>
        </td>
