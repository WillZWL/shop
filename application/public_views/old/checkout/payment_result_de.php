                            ...
                            <td>
                                <p>
                                    ...
                                    if ($so_ps && $so_ps->get_payment_status() == "S") {
                                        ?>
                                        Wir haben eine Bestaetigungsemail an Ihre registrierte email <?= $_SESSION["client"]["email"] ?> gesandt.
                                        <br/><br/>
                                    <?php
                                    } else {
                                        ?>
                                        Wir haben eine Bestaetigungsemail dieser Bestellung an Ihre registrierte email <?= $_SESSION["client"]["email"] ?> gesandt. Wir informieren Sie erneut wenn die Zahlung eingetroffen ist.
                                        <br/><br/>
                                    <?php
                                    }
                                    ?>

                                    Fuer jegliche Anfragen besuchen Sie bitte unsere Haeufig Gestellte Fragen oder
                                    senden eine email an <a href="mailto:support-de@chatandvision.com">support-de@chatandvision.com</a>.
                                </p>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    Bitte ueberpruefen Sie die Rechnungsdetails erneut oder kontaktieren Sie unseren
                                    Kundendienst unter <a href="mailto:support-de@chatandvision.com">support-de@chatandvision</a><?= $so_no ? "  mit folgender Referenz: {$so_no} fuer weitere Hilfe. " : "." ?>
                                    <br/>
                                </p>
                            </td>
                            <td>&nbsp;</td>
