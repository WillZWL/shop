                            ...
                            <td>
                                <p>
                                    ...
                                    if ($so_ps && $so_ps->get_payment_status() == "S") {
                                        ?>
                                        등록된 고객님의 이메일 주소 <?= $_SESSION["client"]["email"] ?> 로 주문 확인 메일이 발송되었습니다. <br/>
                                        <br/>
                                    <?php
                                    } else {
                                        ?>
                                        고객님의 등록된 이메일 주소 <?= $_SESSION["client"]["email"] ?>. 로 구매 승인서가 발송되었습니다. <br/>
                                        <br/>
                                    <?php
                                    }
                                    ?>

                                    문의사항은<a href="<?= base_url() ?>faq"> FAQ</a>란은 참고하시거나 <a
                                        href="mailto:support-kr@chatandvision.com">support-kr@chatandvision.com</a> 로 메일
                                    보내주시기 바랍니다.
                                </p>
                            </td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    거래액을 확인 후 재시도 바랍니다. 도움이 필요하신 경우 <?= $so_no ? " 다음의 조회 번호 {$so_no} 와 함께 " : "" ?><a
                                        href="mailto:support-kr@chatandvision.com">support-kr@chatandvision.com</a> 주소로
                                    고객 서비스 대리점으로 연락 하시기 바랍니다.
                                    <br/><br/>
