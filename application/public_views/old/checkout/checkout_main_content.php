    ...
    <div id="checkoutOnepageBox">
        ...
        <div class="checkoutOnepageBox_left left">
            <ol class="opc" id="checkoutSteps">
                ...
                <li id="opc-login" class="<?= $data["show_block"]["login"] ?>">
                    <div class="step-title">
                        <span
                            class="number"><?= ($data["show_block"]["login"] != "hide") ? $section_number++ : ""; ?></span>
                    ...
                    <div id="checkout-step-login" class="step a-item" style="display:none">
                                ...
                                <div class="col-1">
                                    ...
                                    <ul class="form-list">
                                        ...
                                        if (!$data["allow_login"]) {
                                            ...
                                            <li>
                                                <label for="email"
                                                       class="required"><em>*</em><?= $data['data']['lang_text']['email'] ?>
                                                </label>

                                                <div class="input-box">
                                                    <input type="text" class="input-text required-entry validate-email"
                                                           title="<?= $data['data']['lang_text']['email'] ?>"
                                                           dname="Email" notEmpty validEmail id="guest_email"
                                ...
                                if ($data["allow_login"]) {
                                    ...
                                    <div class="col-2">
                                        ...
                                        <form name='login_form' id="login_form"
                                              action="<?= base_url() ?>login/checkout_login?back=checkout_onepage"
                                              method="post">
                                            <fieldset>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="input-box">
                                                            <input type="text"
                                                                   ...
                                                                   title="<?= $data['data']['lang_text']['email'] ?>"
                                                                   dname="Email" notEmpty validEmail id="email"
                                                                   name="email" value=""/>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <label for="password"
                                                               class="required"><em>*</em><?= $data['data']['lang_text']['password'] ?>
                                                        </label>

                                                        <div class="input-box">
                                                            <input type="password" class="input-text required-entry"
                                                                   title="<?= $data['data']['lang_text']['password'] ?>"
                                                                   id="password" name="password" notEmpty/>
                                                        </div>
                                                    </li>
                                                </ul>
                            ...
                            <div class="col2-set">
                                <div class="col-1">
                                    <div class="buttons-set">
                                        <p class="required">&nbsp;</p>
                                        <button id="onepage-guest-register-button" type="button" class="magbutton"
                                                onclick="if (checkGuestEmail(<?php print ($data["allow_login"]) ? "true" : "false";?>, '<?php print $data["data"]["lang_text"]["warning_put_email"];?>')) setActiveBlockRunning('<?= $data['next_step'] ?>')">
                                ...
                                if ($data["allow_login"]) {
                                    ...
                                    <div class="col-2">
                                        <div class="buttons-set normal-href">
                                            <p class="required">
                                                * <?= $data['data']['lang_text']['required_field'] ?></p>
                                            <a href="<?= base_url() ?>forget_password?back=checkout_onepage"
                                               rel="lyteframe"
                                               rev="width: 600px; height:240px; scrolling: auto;padding: 40px;" title=""
                                               class="f-left"><?= $data['data']['lang_text']['forgot_password'] ?></a>
                                            <button id="onepage-guest-login-button" type="submit" class="magbutton"
                                                    onclick="if(CheckForm(document.login_form))document.login_form.submit();">
                                                <span><span><?= $data['data']['lang_text']['login'] ?></span></span>
                                            </button>
                                        </div>
                                    </div>
                                <?php
                        ...
                        ?>
                            <div class="col1-layout">
                                <div class="col-main">
                                    <h3><?= $data['data']['lang_text']['logged_in_before'] ?>
                                        (<?= $data['data']['lang_text']['login_as'] ?> <?= $client["email"] ?>)</h3>

                                    <div class="buttons-set">
                                        <button id="onepage-already-login-button" type="button" class="magbutton"
                                                onclick="setActiveBlockRunning('billing')">
                ...
                <li id="opc-billing" class="<?= $data["show_block"]["billing"] ?>">
                    <div class="step-title">
                        <span
                            class="number"><?= ($data["show_block"]["billing"] != "hide") ? $section_number++ : ""; ?></span>
                                ...
                                <ul class="form-list">
                                        ...
                                        <fieldset>
                                            <ul>
                                                    ...
                                                    <div class="delivery-country">
                                                        ...
                                                        <div class="field">
                                                            <label for="billing_country_id"
                                                                   class="required"><em>*</em><?= $data['data']['lang_text']['country'] ?>
                                                            </label>
                                                            ...
                                                            <div class="input-box">
                                                                ...
                                                                ?>
                                                                <select notEmpty
                                                                        onchange="checkCountry('<?= $data['selected_country'] ?>', this, '<?php print get_lang_id(); ?>', '<?php print $selectedCountryName; ?>'); calculateDeliverySurcharge();"
                                                                        name="billing_country_id"
                                                                        id="billing_country_id" class="validate-select"
                                                                        title="<?= $data['data']['lang_text']['country'] ?>">
                                                    ...
                                                    <div class="customer-name">
                                                        <div class="field name-firstname">
                                                            <label for="billing_firstname"
                                                                   class="required"><em>*</em><?= $data['data']['lang_text']['first_name'] ?>
                                                            </label>

                                                            <div class="input-box">
                                                                <input notEmpty type="text" id="billing_firstname"
                                                                       name="billing_firstname"
                                                                       value="<?= $data['billing_data']['billing_firstname'] ?>"
                                                                       title="<?= $data['data']['lang_text']['first_name'] ?>"
                                                        ...
                                                        <div class="field name-lastname">
                                                            <label for="billing_lastname"
                                                                   class="required"><em>*</em><?= $data['data']['lang_text']['last_name'] ?>
                                                            </label>

                                                            <div class="input-box">
                                                                <input notEmpty type="text" id="billing_lastname"
                                                                       name="billing_lastname"
                                                                       value="<?= $data['billing_data']['billing_lastname'] ?>"
                                                                       title="<?= $data['data']['lang_text']['last_name'] ?>"
                                                                       class="input-text required-entry"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="fields">
                                                    <div class="field">
                                                        <label
                                                            for="billing_company"><?= $data['data']['lang_text']['company'] ?></label>

                                                        <div class="input-box">
                                                            <input type="text" id="billing_company"
                                                                   name="billing_company"
                                                                   value="<?= $data['billing_data']['billing_company'] ?>"
                                                                   title="<?= $data['data']['lang_text']['company'] ?>"
                                                                   class="input-text"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    if ($data['no_login_before']) {
                                                        ...
                                                        <div class="field">
                                                            <label for="billing_email"
                                                                   class="required"><em>*</em><?= $data['data']['lang_text']['email_address'] ?>
                                                            </label>

                                                            <div class="input-box">
                                                                <input notEmpty validEmail type="text"
                                                                       name="billing_email" id="billing_email"
                                                                       value="<?= $data['billing_data']['billing_email'] ?>"
                                                                       title="<?= $data['data']['lang_text']['email_address'] ?>"
                                                ...
                                                if ($data["show_client_id"]) {
                                                    ...
                                                    <li class="fields">
                                                        <div class="field">
                                                            <label
                                                                for="client_id_no"><?= $data['data']['lang_text']['client_id_no'] ?>
                                                                <a href=""
                                                                   title="<?= $data['data']['lang_text']['client_id_title'] ?>">[?]</a></label>

                                                            <div class="input-box">
                                                                <input type="text" id="client_id_no" name="client_id_no"
                                                                       value="<?= $data['billing_data']['billing_client_id_no'] ?>"
                                                                       title="<?= $data['data']['lang_text']['client_id_no'] ?>"
                                                                       class="input-text"/>
                                                            </div>
                                                        </div>
                                                    </li>
                                                ...
                                                <li class="wide">
                                                    <label for="address1"
                                                           class="required"><em>*</em><?= $data['data']['lang_text']['address'] ?>
                                                    </label>

                                                    <div class="input-box">
                                                        <input notEmpty <?= $pobox_check ?> type="text"
                                                               title="<?= $data['data']['lang_text']['address'] ?>"
                                                               name="address1" id="address1"
                                                               value="<?= $data['billing_data']['address1'] ?>"
                                                               maxlength=40 class="input-text required-entry"/>
                                                    </div>
                                                </li>

                                                <li class="wide">
                                                    <div class="input-box">
                                                        <input <?= $pobox_check ?> type="text" title="" name="address2"
                                                                                   id="address2"
                                                                                   value="<?= $data['billing_data']['address2'] ?>"
                                                                                   maxlength=40 class="input-text"/>
                                                    </div>
                                                </li>

                                                <li class="wide">
                                                    <div class="input-box">
                                                        <input <?= $pobox_check ?> type="text" title="" name="address3"
                                                                                   id="address3"
                                                                                   value="<?= $data['billing_data']['address3'] ?>"
                                                                                   maxlength=40 class="input-text"/>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="fields">
                                                    <div class="field">
                                                        <label for="billing_city"
                                                               class="required"><em>*</em><?= $data['data']['lang_text']['city'] ?>
                                                        </label>

                                                        <div class="input-box">
                                                            <input notEmpty type="text"
                                                                   title="<?= $data['data']['lang_text']['city'] ?>"
                                                                   name="billing_city"
                                                                   value="<?= $data['billing_data']['billing_city'] ?>"
                                                                   class="input-text required-entry" id="billing_city"/>
                                                        </div>
                                                    </div>

                                                    <div class="field">
                                                        <label for="billing_state" id="billing_state_label"
                                                               class="required"><em>*</em><?= $data['data']['lang_text']['state_province'] ?>
                                                        </label>

                                                        <div class="input-box">
                                                            <select notEmpty id="billing_state" name="billing_state"
                                                                    title="<?= $data['data']['lang_text']['state_province'] ?>"
                                                ...
                                                <li class="fields">
                                                    <div class="field">
                                                        <label for="billing_post_code" id="billing_post_code_label"
                                                               class="required"><em>*</em><?= $data['data']['lang_text']['postal_code'] ?>
                                                        </label>

                                                        <div class="input-box">
                                                            <input validPostal="billing_country_id" type="text"
                                                                   title="<?= $data['data']['lang_text']['postal_code'] ?>"
                                                                   name="billing_post_code" id="billing_post_code"
                                                                   value="<?= $data['billing_data']['billing_post_code'] ?>"
                                                ...
                                                <li class="fields">
                                                    <label
                                                        class="required"><?= $data['data']['lang_text']['telephone'] ?></label>
                                                </li>
                                                <li class="fields">
                                                    <div class="tel_field">
                                                        <label for="billing_telephone1"
                                                               class="required"><?= $data['data']['lang_text']['country_code'] ?></label>

                                                        <div class="">
                                                            <input isNumber type="text" name="billing_telephone1"
                                                                   value="<?= $data['billing_data']['billing_telephone1'] ?>"
                                                                   title="<?= $data['data']['lang_text']['country_code'] ?>"
                                                                   class="tel12_input-text required-entry"
                                                                   id="billing_telephone1"/>
                                                        </div>
                                                    </div>
                                                    <div class="tel_field_space"></div>
                                                    <div class="tel_field">
                                                        <label for="billing_telephone2"
                                                               class="required"><?= $data['data']['lang_text']['area_code'] ?></label>

                                                        <div class="input-box">
                                                            <input isNumber type="text" name="billing_telephone2"
                                                                   value="<?= $data['billing_data']['billing_telephone2'] ?>"
                                                                   title="<?= $data['data']['lang_text']['area_code'] ?>"
                                                                   class="tel12_input-text required-entry"
                                                                   id="billing_telephone2"/>
                                                        </div>
                                                    </div>
                                                    <div class="tel_field_space"></div>
                                                    <div class="tel_field">
                                                        <label for="billing_telephone3"
                                                               class="required"><em>*</em><?= $data['data']['lang_text']['number'] ?>
                                                        </label>

                                                        <div class="input-box">
                                                            <input notEmpty isNumber type="text"
                                                                   name="billing_telephone3"
                                                                   value="<?= $data['billing_data']['billing_telephone3'] ?>"
                                                                   title="<?= $data['data']['lang_text']['telephone'] ?>"
                                                                   class="tel_input-text required-entry"
                                                                   id="billing_telephone3"/>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="no-display"><input type="hidden"
                                                                              name="billing_save_in_address_book"
                                                                              value="1"/></li>
                                            </ul>
                                    ...
                                    if ($data['no_login_before']) {
                                        ...
                                        <li class="fields">
                                            ...
                                            <div class="field">
                                                <label
                                                    for="billing_password"><?= $data['data']['lang_text']['password'] ?></label>

                                                <div class="input-box">
                                                    <input type="password" autocomplete="off"
                                                           title="<?= $data['data']['lang_text']['password'] ?>"
                                                           name="billing_password" value=""
                                                           class="input-text required-entry" id="billing_password"/>
                                                </div>
                                            </div>

                                            <div class="field">
                                                <label
                                                    for="billing_confirm_password"><?= $data['data']['lang_text']['confirm_password'] ?></label>

                                                <div class="input-box">
                                                    <input type="password" autocomplete="off"
                                                           title="<?= $data['data']['lang_text']['confirm_password'] ?>"
                                                           name="billing_confirm_password" value=""
                                                           class="input-text required-entry"
                                                           id="billing_confirm_password"/>
                                                </div>
                                            </div>
                                        </li>
                                    <?php
                                    ...
                                    <div id="shipping_delivery_option">
                                        <li class="control">
                                            <input type="radio" name="billing_use_for_shipping"
                                                   id="billing_use_for_shipping_yes"
                                                   value="1" <?= $data['billing_data']['billing_use_for_shipping'] == '1' ? 'checked="checked"' : ''; ?>
                                                   title="<?= $data['data']['lang_text']['ship_to_this'] ?>"
                                                   class="radio"/><label
                                                for="billing_use_for_shipping_yes"><?= $data['data']['lang_text']['ship_to_this'] ?></label>
                                        </li>
                                        <li class="control">
                                            <input type="radio" name="billing_use_for_shipping"
                                                   id="billing_use_for_shipping_no"
                                                   value="0" <?= $data['billing_data']['billing_use_for_shipping'] != '1' ? 'checked="checked"' : ''; ?>
                                                   title="<?= $data['data']['lang_text']['ship_to_different'] ?>"
                                                   class="radio"/><label
                                                for="billing_use_for_shipping_no"><?= $data['data']['lang_text']['ship_to_different'] ?></label>
                                        </li>
                                    </div>
                                </ul>
                                    ...
                                    <div class="conditions_agreement">
                                        ...
                                        if (strpos($conditions_agreement_available_country, $data['selected_country'] . '|') !== FALSE) {
                                            ...
                                            <span class="agreement">
                                                ...
                                                <span class="hyper_link"
                                                      onclick="window.open('<?= base_url() . 'display/view/conditions_of_use' ?>', 'TC', 'width=600,height=400,left=50,resizeable=yes,scrollbars=yes,titlebar=yes,resizeable=1,scrollbars=1,titlebar=1');">
                                        ...
                                        <button id="onepage_billing_continue" type="button"
                                                title="<?= $data['data']['lang_text']['continue'] ?>" class="magbutton"
                                                onclick="if (CheckForm(this.form)) {billingFormContinue(); calculateDeliverySurcharge();}">
                                            <span><span><?= $data['data']['lang_text']['continue'] ?></span></span>
                                        </button>
                                    </div>
                                </div>
                ...
                <li id="opc-shipping" class="<?= $data["show_block"]["shipping"] ?>">
                    <div class="step-title">
                        <span
                            class="number"><?= ($data["show_block"]["shipping"] != "hide") ? $section_number++ : ""; ?></span>
                        ...
                        <form action="" id="co-shipping-form">
                                    ...
                                    <fieldset>
                                        <ul>
                                            <li class="fields">
                                                <div class="customer-name">
                                                    <div class="field name-firstname">
                                                        ...
                                                        <div class="input-box">
                                                            <input notEmpty type="text" id="shipping_firstname"
                                                                   name="shipping_firstname"
                                                                   value="<?= $data['shipping_data']['shipping_firstname'] ?>"
                                                                   title="<?= $data['data']['lang_text']['first_name'] ?>"
                                                                   class="input-text required-entry"
                                                                   onchange="setDifferentFromBillingAddr();"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="field name-lastname">
                                                        ...
                                                        <div class="input-box">
                                                            <input notEmpty type="text" id="shipping_lastname"
                                                                   name="shipping_lastname"
                                                                   value="<?= $data['shipping_data']['shipping_lastname'] ?>"
                                                                   title="<?= $data['data']['lang_text']['last_name'] ?>"
                                                                   class="input-text required-entry"
                                                                   onchange="setDifferentFromBillingAddr();"/>
                                                        </div>
                                            ...
                                            <li class="fields">
                                                <div class="fields">
                                                    <label
                                                        for="shipping_company"><?= $data['data']['lang_text']['company'] ?></label>

                                                    <div class="input-box">
                                                        <input type="text" id="shipping_company" name="shipping_company"
                                                               value="<?= $data['shipping_data']['shipping_company'] ?>"
                                                               title="<?= $data['data']['lang_text']['company'] ?>"
                                                               class="input-text"
                                                               onchange="setDifferentFromBillingAddr();"/>
                                                    </div>
                                            ...
                                            <li class="wide">
                                                ...
                                                <div class="input-box">
                                                    <input notEmpty <?= $pobox_check ?> type="text"
                                                           ...
                                                           value="<?= $data['shipping_data']['shipping_address1'] ?>"
                                                           maxlength=40 class="input-text required-entry"
                                                           onchange="setDifferentFromBillingAddr();"/>
                                                </div>
                                            </li>
                                            ...
                                            <li class="wide">
                                                <div class="input-box">
                                                    <input <?= $pobox_check ?> type="text"
                                                                               title="<?= $data['data']['lang_text']['address'] ?> 2"
                                                                               name="shipping_address2"
                                                                               id="shipping_address2"
                                                                               value="<?= $data['shipping_data']['shipping_address2'] ?>"
                                                                               maxlength=40 class="input-text"
                                                                               onchange="setDifferentFromBillingAddr();"/>
                                                </div>
                                            </li>
                                            ...
                                            <li class="wide">
                                                <div class="input-box">
                                                    <input <?= $pobox_check ?> type="text"
                                                                               title="<?= $data['data']['lang_text']['address'] ?> 3"
                                                                               name="shipping_address3"
                                                                               id="shipping_address3"
                                                                               value="<?= $data['shipping_data']['shipping_address3'] ?>"
                                                                               maxlength=40 class="input-text"
                                                                               onchange="setDifferentFromBillingAddr();"/>
                                                </div>
                                            </li>
                                            ...
                                            <li class="fields">
                                                <div class="field">
                                                    ...
                                                    <div class="input-box">
                                                        <input notEmpty type="text"
                                                               title="<?= $data['data']['lang_text']['city'] ?>"
                                                               name="shipping_city"
                                                               value="<?= $data['shipping_data']['shipping_city'] ?>"
                                                               class="input-text required-entry" id="shipping_city"
                                                               onchange="setDifferentFromBillingAddr();"/>
                                                    </div>
                                                </div>
                                                <?php
                                                if ($data["allow_login"]) {
                                                    ?>
                                                    <div class="field">
                                                        <label for="shipping_state" id="shipping_state_label"
                                                               class="required"><em>*</em><?= $data['data']['lang_text']['state_province'] ?>
                                                        </label>

                                                        <div class="input-box">
                                                            <select notEmpty id="shipping_state" name="shipping_state"
                                                                    title="<?= $data['data']['lang_text']['state_province'] ?>"
                                            ...
                                            <li class="fields">
                                                <div class="field">
                                                    <label for="shipping_post_code" id="shipping_post_code_label"
                                                           class="required"><em>*</em><?= $data['data']['lang_text']['postal_code'] ?>
                                                    </label>

                                                    <div class="input-box">
                                                        <input validPostal="shipping_country_id" type="text"
                                                               title="<?= $data['data']['lang_text']['postal_code'] ?>"
                                                               name="shipping_post_code" id="shipping_post_code"
                                                               value="<?= $data['shipping_data']['shipping_post_code'] ?>"
                                                               class="input-text validate-zip-international required-entry"
                                                               onchange="setDifferentFromBillingAddr(); calculateDeliverySurcharge();"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="field">
                                                    ...
                                                    <div class="input-box">
                                                        <select notEmpty name="shipping_country_id"
                                                                id="shipping_country_id" class="validate-select"
                                                                title="<?= $data['data']['lang_text']['country'] ?>"
                                                                disabled onchange="setDifferentFromBillingAddr();">
                                                            <?php
                                                            if ($data["allow_login"]) {
                                                                foreach ($data['country_list'] as $country) {
                                            ...
                                            <li class="fields">
                                                <div class="tel_field">
                                                    <label for="shipping_telephone1"
                                                           class="required"><?= $data['data']['lang_text']['country_code'] ?></label>

                                                    <div class="">
                                                        <input isNumber type="text" name="shipping_telephone1"
                                                               value="<?= $data['shipping_data']['shipping_telephone1'] ?>"
                                                               title="<?= $data['data']['lang_text']['country_code'] ?>"
                                                               class="tel12_input-text required-entry"
                                                               id="shipping_telephone1"/>
                                                    </div>
                                                </div>
                                                <div class="tel_field_space"></div>
                                                <div class="tel_field">
                                                    <label for="shipping_telephone2"
                                                           class="required"><?= $data['data']['lang_text']['area_code'] ?></label>

                                                    <div class="input-box">
                                                        <input isNumber type="text" name="shipping_telephone2"
                                                               value="<?= $data['shipping_data']['shipping_telephone2'] ?>"
                                                               title="<?= $data['data']['lang_text']['area_code'] ?>"
                                                               class="tel12_input-text required-entry"
                                                               id="shipping_telephone2"/>
                                                    </div>
                                                </div>
                                                <div class="tel_field_space"></div>
                                                <div class="tel_field">
                                                    <label for="shipping_telephone3"
                                                           class="required"><em>*</em><?= $data['data']['lang_text']['number'] ?>
                                                    </label>

                                                    <div class="input-box">
                                                        <input notEmpty isNumber type="text" name="shipping_telephone3"
                                                               value="<?= $data['shipping_data']['shipping_telephone3'] ?>"
                                                               title="<?= $data['data']['lang_text']['telephone'] ?>"
                                                               class="tel_input-text required-entry"
                                                               id="shipping_telephone3"
                                                               onchange="setDifferentFromBillingAddr();"/>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="no-display"><input type="hidden"
                                                                          name="shipping_save_in_address_book"
                                                                          value="1"/></li>
                                        </ul>
                                    </fieldset>
                                </li>
                                ...
                                if ($data["allow_login"]) {
                                    ...
                                    <li class="control">
                                        <input type="checkbox" name="shipping_same_as_billing"
                                               ...
                                               value="1" <?= ($data['shipping_data']['shipping_same_as_billing'] == 1 ? ' checked' : ''); ?>
                                               title="<?= $data['data']['lang_text']['use_billing_address'] ?>"
                                               onclick="useBillingAddress(this.checked);"/>
                                        <label
                                            for="shipping_same_as_billing"><?= $data['data']['lang_text']['use_billing_address'] ?></label>
                                    </li>
                                <?php
                                }
                                ?>
                            ...
                            <div class="buttons-set" id="shipping-buttons-container">
                                ...
                                <div class="conditions_agreement">
                                    ...
                                    <button id="onepage_shipping_continue" type="button" class="magbutton"
                                            title="<?= $data['data']['lang_text']['continue'] ?>"
                                            onclick="if (CheckForm(this.form)) {updateShippingAddrInSummaryBox(); setActiveBlockRunning('payment');}">
                                        <span><span><?= $data['data']['lang_text']['continue'] ?></span></span>
                                    </button>
                                </div>
                            </div>
                ...
                <li id="opc-payment" class="<?= $data["show_block"]["payment"] ?>">
                    <div class="step-title">
                        <span
                            class="number"><?= ($data["show_block"]["payment"] != "hide") ? $section_number++ : ""; ?></span>
                    ...
                    <div id="checkout-step-payment" class="step a-item" style="display:none;">
                        <div id='card_form'>
                            <div id='select_a_card'><b><?= $data['data']['lang_text']['please_a_payment_options'] ?></b><br><br>
                            </div>
                                ...
                                <div id='card_list' name='card_list'>
                                    <?php if (PLATFORMID == "WEBRU") {
                                        ...
                                        <div>
                                            ...
                                            <div id="kiosk-block">
                                                <div
                                                    class="card-block-title"><?= $data['data']['lang_text']['ru_payment_form_kiosk_title'] ?></div>
                                                <div class="card_row">
                                                    <a href="javascript::void(0)"
                                                       onclick="loadingPaymentGateway('GP%%yandex%%yd_ATM')">
                                                        <div style="float:left;"><img
                                                                src="/images/90x45/cash_kiosk1.png" border="0"></div>
                                                    </a>

                                                    <div
                                                        style="float:left;width:400px;"><?= $data['data']['lang_text']['ru_payment_form_kiosk_paragraph'] ?></div>
                                                </div>
                                                <div id="kiosk" class="card_row">
                                                    <a href="javascript::void(0)"
                                                       onclick="loadingPaymentGateway('GP%%yandex%%yd_ATM')"><img
                                                            src="/images/90x45/cash_kiosk2.png" border="0"></a>
                                                    <a href="javascript::void(0)"
                                                       onclick="loadingPaymentGateway('GP%%yandex%%yd_ATM')"><img
                                                            src="/images/90x45/cash_kiosk3.png" border="0"></a>
                                                    <a href="javascript::void(0)"
                                                       onclick="loadingPaymentGateway('GP%%yandex%%yd_ATM')"><img
                                                            src="/images/90x45/cash_kiosk4.png" border="0"></a>
                                                    <a href="javascript::void(0)"
                                                       onclick="loadingPaymentGateway('GP%%yandex%%yd_ATM')"><img
                                                            src="/images/90x45/cash_kiosk5.png" border="0"></a>
                                                    <a href="javascript::void(0)"
                                                       onclick="loadingPaymentGateway('GP%%yandex%%yd_ATM')"><img
                                                            src="/images/90x45/cash_kiosk6.png" border="0"></a>
            <span><?= $data['data']['lang_text']['ru_payment_form_kiosk_etc'] ?><span>
                                            ...
                                            <div id="card-block">
                                                <div
                                                    class="card-block-title"><?= $data['data']['lang_text']['ru_payment_form_credit_card_title'] ?></div>
                                                <div class="card_row">
                                                    <a href="javascript::void(0)"
                                                       onclick="loadingPaymentGateway('AC%%yandex%%yd_VSA')"><img
                                                            src="/images/90x45/powered-btn-visa-90x45.png"
                                                            border="0"></a>
                                                    <a href="javascript::void(0)"
                                                       onclick="loadingPaymentGateway('AC%%yandex%%yd_VSE')"><img
                                                            src="/images/90x45/powered-btn-visacredit-90x45.png"
                                                            border="0"></a>
                                                    <a href="javascript::void(0)"
                                                       onclick="loadingPaymentGateway('AC%%yandex%%yd_VSE')"><img
                                                            src="/images/90x45/powered-btn-mc-90x45.png" border="0"></a>
                                                </div>
                                                <div class="card_row">
                                                    <a href="javascript::void(0)"
                                                       onclick="loadingPaymentGateway('Maestro%%paypal%%paypal_MAE')"><img
                                                            src="/images/90x45/powered-btn-maestro-90x45.png"
                                                            border="0"></a>
                                                    <a href="javascript::void(0)"
                                                       onclick="loadingPaymentGateway('AMX%%paypal%%paypal_AMX')"><img
                                                            src="/images/90x45/powered-btn-amex-90x45.png"
                                                            border="0"></a>
                                                    <a href="javascript::void(0)"
                                                       onclick="loadingPaymentGateway('DISCOVER%%paypal%%paypal_DIS')"><img
                                                            src="/images/90x45/powered-btn-discover-90x45.png"
                                                            border="0"></a>
                                                </div>
                                            </div>
                                            <div id="web-money-block">
                                                <div
                                                    class="card-block-title"><?= $data['data']['lang_text']['ru_payment_form_web_money_title'] ?></div>
                                                <div class="card_row"><a href="javascript::void(0)"
                                                                         onclick="loadingPaymentGateway('paypal%%paypal%%paypal')"><img
                                                            src="/images/btn_paypal.png" border="0"></a></div>
                                                <div class="card_row"><a href="javascript::void(0)"
                                                                         onclick="loadingPaymentGateway('PC%%yandex%%yd_money')"><img
                                                            src="/images/90x45/yandex-money-90x45.png" border="0"></a>
                                                </div>
                                                <div class="card_row"><a href="javascript::void(0)"
                                                                         onclick="loadingPaymentGateway('WM%%yandex%%yd_WM')"><img
                                                            src="/images/90x45/yandex-wm-90x45.png" border="0"></a>
                                                </div>
                                ...
                                <div id='trustly_container' style="display:none;">
                                    ...
                                    <div id='trustly_div_text'><a id='fancy_trustly' style="text-decoration:underline;"
                                                                  class='fancybox iframe'
                                                                  title='https://trustly.com/whatistrustly'
                                                                  href='https://trustly.com/whatistrustly'><?= $data['data']['lang_text']['trustly_message_1'] ?>
                                            <span
                                                class='frame'></span></a><br><b><?= $data['data']['lang_text']['trustly_message_2'] ?></b>
                                    </div>
                                    <div style="clear:both;"></div>
                                ...
                                <div id='bank_transfer_container' style="display:none;">
                                    ...
                                    <div id='bank_transfer_div_text'
                                         style="position:relative;float:left;"><?= $data['data']['lang_text']['bank_transfer_message'] ?></div>
                                    <div style="clear:both;"></div>
                        ...
                        <? if (PLATFORMID == "WEBIT") { ?>
                            <div id="payment_tips"
                                 style="display:inline-block; border: 1px solid #E4E4E4;padding:10px 10px; background-color:white; margin-top:10px;">
                        ...
                        <div class="buttons-set" id="payment-buttons-container">
                            <?php if (PLATFORMID != "WEBRU") {
                                ...
                                <button id="onepage_payment_continue" type="button" class="magbutton"
                                        onclick="loadingPaymentGateway('')">
                                    <span><span><?= $data['data']['lang_text']['continue'] ?></span></span></button>
                            <?php
                            }
                            ?>
                        </div>
                        ...
                        <input type="hidden" name="cybersource_fingerprint" id='cybersource_fingerprint'
                               value="<?= $data['cybersource_fingerprint']; ?>">

                        <div id='loading_display' style="text-align:center;display:none;position:relative;"><img
                                src='/images/loading.gif' border='0'></div>
                        <div id='payment_gateway_block'>
                            <iframe id="payment_frame" name="payment_frame"
                                    style="position:relative;width:100%;height:100%" src="about:blank" frameborder='0'
                                    scrolling='auto'>
                            </iframe>
                        </div>
            ...
            <div id='card_explanation' style="padding-top:10px;display:none;">
                ...
                if (isset($data['data']['lang_text']['card_message']) && ($data['data']['lang_text']['card_message'] != "")) {
                    ...
                    <div style="padding-top:10px;text-align:center;">
                        <img
                            src=<?php print base_cdn_url() . "/resources/images/" . get_lang_id() . "_cards.jpg" ?> border='0'>
                    </div>
                <?php
                } else {
                    ?>
                    <div style="padding-top:10px;text-align:left;">
                        <div>
                            <div style="float:left;padding-top:6px;"><img width="120px"
                                                                          src=<?php print base_cdn_url() . "/resources/images/card_explain_visa.jpg" ?> border='0'>
                            </div>
                            <div style="float:left;padding-top:10px;width:500px;font-size:13px;">
                                ...
                                if ($card_url != "") {
                                    ?>
                                    <a target="_blank" href="https://<?php print $card_url?>"
                        ...
                        <div style="clear:both;"></div>
                        <div>
                            <div style="float:left;"><img width="120px"
                                                          src=<?php print base_cdn_url() . "/resources/images/card_explain_master.jpg" ?> border='0'>
                            </div>
                            <div style="float:left;padding-top:10px;width:500px;font-size:13px;">
                        ...
                        <div style="float:left;padding-top:10px;width:600px;font-size:13px;">
                            ...
                            <a target="_blank" href="https://<?php print $cvv_url?>"
                               style="font-weight:bold;text-decoration:underline;">
                                <?= $data['data']['lang_text']['card_message_click_here'] ?>
                            </a>
                        </div>
...
//if it is not allow to edit, just do nothing.
                    ...
                    if (display_block_list_arr[i] != activeBlockName) {
                        ...
                        if (i > afterActiveId) {
                            ...
                            opcBlock.onmousedown = (function (inputBlockName) {
                                return function () {
                                    setActiveBlockRunning(inputBlockName);
                                }
        ...
        <div class="checkoutOnepageBox_right right">
            ...
            <div id="order-sidebar-wrapper">
                ...
                <ul id="basket-products">
                    ...
                    for ($j = 0; $j < count($chk_cart); $j++) {
                        ...
                        <li>
                            ...
                            <ins><?= $chk_cart[$j]["qty"] ?> @
                                <strong><?= platform_curr_format(PLATFORMID, $chk_cart[$j]["price"]) ?></strong></ins>
                        </li>
                        <?php
                ...
                <p>
                    <?= $data['data']['lang_text']['subtotal'] ?>:
                    <strong><?= platform_curr_format(PLATFORMID, $data['subtotal']) ?></strong><br/>
                    <?php
                    ...
                    ?>
                    <?= $data['data']['lang_text']['shipping_fee'] ?>:
                    <strong><?= platform_curr_format(PLATFORMID, $data["dc_default"]["charge"]) ?></strong><br/>
                    <?= $data['data']['lang_text']['grand_total'] ?>: <strong><span
                            id="grandTotal"><?= platform_curr_format(PLATFORMID, $data["grand_total"]) ?></span></strong><br/>
                    <br/>
                </p>
                    ...
                    <div class="block-title">
                        <div class="block-content">
                            ...
                            <dl id="assistant_block" style="display:none;">
                                ...
                                <dd class="assistant_complete"><?= $data['data']['lang_text']['require_assistance_4'] ?>
                                    <a id="assistant_link"
                                       href="<? print base_url() . "checkout_onepage/payment_result/0?type=assistant"; ?>"
                                       style="color:#FF1962;text-decoration:underline;"><?= $data['data']['lang_text']['require_assistance_2'] ?></a>
...
<img
    src="https://h.online-metrix.net/fp/clear.png?org_id=<?= $data["cybersource_fingerprint_id"]; ?>&session_id=<?= $data["cybersource_fingerprint_label"]; ?>&m=2"
    alt="">
<object type="application/x-shockwave-flash"
        data="https://h.online-metrix.net/fp/fp.swf?org_id=<?= $data["cybersource_fingerprint_id"]; ?>&session_id=<?= $data["cybersource_fingerprint_label"]; ?>"
        width="1" height="1" id="thm_fp">
    <param name="movie"
           value="https://h.online-metrix.net/fp/fp.swf?org_id=<?= $data["cybersource_fingerprint_id"]; ?>&session_id=<?= $data["cybersource_fingerprint_label"]; ?>"/>
    <div></div>
</object>
<script
    src="https://h.online-metrix.net/fp/check.js?org_id=<?= $data["cybersource_fingerprint_id"]; ?>&session_id=<?= $data["cybersource_fingerprint_label"]; ?>"
