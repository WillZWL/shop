...
<head>
    ...
    <title>ChatandVision - Pagamento<?= $success ? "Processed" : "Unsuccessful" ?></title>
                            ...
                            <td>
                                <p>
                                    ...
                                    if ($so_ps && $so_ps->get_payment_status() == "S") {
                                        ?>
                                        We have sent a confirmation of this order to your registered email at <?= $_SESSION["client"]["email"] ?>.
                                        <br/><br/>
                                    <?php
                                    } else {
                                        ?>
                                        Enviamos uma notificação de recebimento para seu e-mail registrado em <?= $_SESSION["client"]["email"] ?>. O informaremos novamente quando o pagamento for liberado.
                                        <br/><br/>
                                    <?php
                                    }
                                    ?>

                                    Em caso de dúvidas, por favor, não hesite em visitar <a href="<?= base_url() ?>faq">
                                        a nossa página de perguntas e respostas</a> ou nos envie um e-mail para <a
                                        href="mailto:support-br@chatandvision.com">support-br@chatandvision.com</a>para
                                    maior assistência.
                                </p>
                            </td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    Você pode conferir os detalhes da cobrança e tentar novamente. Caso contrário, entre
                                    em contato com nossos agentes de Atendimento ao Cliente em <a
                                        href="mailto:support-br@chatandvision.com">support-br@chatandvision.com</a><?= $so_no ? ", indicando o número de referência: {$so_no} para maior assistência." : "." ?>
                                    <br/><br/>
                                    Pedimos desculpas por qualquer inconveniente causado, e aguardamos o seu contato em
                                    breve.<br/>
                                </p>
                            </td>
                            <td>&nbsp;</td>
