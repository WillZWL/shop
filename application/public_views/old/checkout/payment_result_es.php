                            ...
                            <td>
                                <p>
                                    ...
                                    if ($so_ps && $so_ps->get_payment_status() == "S") {
                                        ?>
                                        Hemos enviado una confirmación de esta orden al correo electrónico registrado a <?= $_SESSION["client"]["email"] ?>.
                                        <br/><br/>
                                    <?php
                                    } else {
                                        ?>
                                        Hemos enviado un reconocimiento de esta orden al correo electrónico registrado <?= $_SESSION["client"]["email"] ?>. Le informaremos nuevamente cuando su pago se haga efectivo.
                                        <br/><br/>
                                    <?php
                                    }
                                    ?>

                                    Si tiene alguna duda, por favor no dude en visitar nuestra página <a
                                        href="<?= base_url() ?>faq">F.A.Q</a> o mándenos un correo electrónico a <a
                                        href="mailto:support-es@chatandvision.com">support-es@chatandvision.com</a>.
                                </p>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    Por favor revise los detalles de facturación e intente nuevamente. De lo contrario,
                                    por favor contacte a nuestros agentes de Atención al Cliente a <a
                                        href="mailto:support-es@chatandvision.com">support-es@chatandvision.com</a><?= $so_no ? " indicando este número de referencia: {$so_no} para mayor asistencia. " : "." ?>
                                    <br/><br/>
                                    Le pedimos disculpas por las molestias causadas y esperamos oír de usted
                                    pronto.<br/>
                                </p>
                            </td>
                            <td>&nbsp;</td>
