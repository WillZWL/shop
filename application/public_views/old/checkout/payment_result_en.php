                            ...
                            <td>
                                <p>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        We have sent an acknowledgement of this order to your registered email at <?= $_SESSION["client"]["email"] ?>.  We'll inform you again once the payment is cleared.
                                        <br/><br/>
                                    <?php
                                    }
                                    ?>

                                    In the event of any queries, please do not hesitate to visit our <a
                                        href="<?= base_url() ?>faq">F.A.Q</a> page <br> or e-mail us at <a
                                        href="mailto:support@valuebasket.com">support@valuebasket.com</a> for further
                                    assistance.
                                </p>
                            </td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    You may wish to review the billing details and try again. Otherwise, please contact
                                    our Customer Services agents at <a href="mailto:support@valuebasket.com">support@valuebasket.com</a><?= $so_no ? " indicating this reference number: {$so_no} for further assistance. " : "." ?>
                                    <br/><br/>
