                            ...
                            <td>
                                <p>
                                    ...
                                    if ($so_ps && $so_ps->get_payment_status() == "S") {
                                        ?>
                                        Enviámos uma confirmação desta encomenda para o seu e-mail registado <?= $_SESSION["client"]["email"] ?>.
                                        <br/><br/>
                                    <?php
                                    } else {
                                        ?>
                                        Enviámos uma cópia de conhecimento desta encomenda para o seu e-mail registado em  <?= $_SESSION["client"]["email"] ?>. Iremos informá-lo novamente logo que o pagamento seja efectuado.
                                        <br/><br/>
                                    <?php
                                    }
                                    ?>

                                    Na eventualidade de surgir qualquer questão, por favor, não hesite em visitar a
                                    nossa página de <a href="<?= base_url() ?>faq">F.A.Q (Perguntas Frequentes)</a> ou
                                    em enviar-nos um e-mail para <a href="mailto:support-pt@chatandvision.com">support-pt@chatandvision.com</a>
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    Pode desejar rever os detalhes de facturação e tentar novamente. Caso contrário,
                                    contacte os nossos agentes do Serviço ao Cliente em <a
                                        href="mailto:support-pt@chatandvision.com">support-pt@chatandvision.com</a><?= $so_no ? " indicando este número de referência: {$so_no} para obter mais assistência. " : "." ?>
                                    <br/><br/>
                                    Pedimos desculpa por qualquer inconveniente causado e aguardamos notícias suas
                                    brevemente.<br/>
                                </p>
                            </td>
                            <td>&nbsp;</td>
