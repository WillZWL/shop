...
<?php include VIEWPATH."checkout/checkoutprocessbar.php"; ?>
		...
		<table width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<div id="loading" style="position:absolute; left:50%"> <img src="/images/pleasewait.gif"> </div>
				<iframe name="redirect" style="position:relative" src="<?=$this->input->post("url_togoto")?>" frameborder='0' scrolling='auto' width='100%' height='650' onLoad="document.getElementById('loading').style.display='none'"></iframe>
