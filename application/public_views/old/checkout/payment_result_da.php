        ...
        <table align="center" width="1000" border="0" cellspacing="5" cellpadding="5">
			...
			<tr>
			  	<td>
					...
					<?php
						...
						{
					?>
					Vi har sendt en bekræftelse af bestillingen til din registrerede E-mail adresse hos: <?=$_SESSION["client"]["email"]?>. <br /><br />
					<?php
						}
						else
						{
					?>
					Vi har sendt en bekræftelse af bestillingen til din registrerede E-mail adresse hos: <?=$_SESSION["client"]["email"]?>. Vi vil informerer dig igen, når betalingen er gennemført. <br /><br />
					<?php
						}
					?>

					I tilfælde af eventuelle forespørgsler, er du velkommen til, at besøge vores <a href="<?=base_url()?>faq">F.A.Q</a> side eller sende en E-mail til: <a href="mailto:support-dk@chatandvision.com">support-dk@chatandvision.com</a>, for yderligere hjælp.
					</p>
				</td>
			<td>&nbsp;</td>
		</tr>
          ...
          <tr>
		  	<td>
				...
				Gennemgå venligst betalingsoplysningerne og prøv igen. Ellers bedes du kontakte vores kundeservice repræsentanter på <a href="mailto:support-dk@chatandvision.com">support-dk@chatandvision.com</a><?=$so_no?", og oplys dette referencenummer: {$so_no} for yderligere hjælp.":"."?>
				<br /><br />
