                            ...
                            <td>
                                <p>
                                    ...
                                    if ($so_ps && $so_ps->get_payment_status() == "S") {
                                        ?>
                                        Wysłaliśmy potwierdzenie zamówienia na podany przez Państwa przy rejestracji adres e-mail: <?= $_SESSION["client"]["email"] ?>.
                                        <br/><br/>
                                    <?php
                                    } else {
                                        ?>
                                        Wysłaliśmy potwierdzenie złożenia zamówienia na podany przez Państwa przy rejestracji adres e-mail: <?= $_SESSION["client"]["email"] ?>. Skontaktujemy się z Państwem ponownie po weryfikacji płatności.
                                        <br/><br/>
                                    <?php
                                    }
                                    ?>

                                    W razie pytań i wątpliwości, prosimy o odwiedzenie działu <a
                                        href="<?= base_url() ?>faq">Często Zadawanych Pytań (FAQ) </a>lub e-mail na
                                    adres <a href="mailto:support-pl@chatandvision.com">
                                        support-pl@chatandvision.com </a>.
                                </p>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    Prosimy o zapoznanie się ze szczegółami transakcji i ponowienie próby. W przypadku
                                    dalszych problemów, proszę skontaktować się z pracownikami naszego Biura Obsługi
                                    Klienta pod adresem ,<a href="mailto:support-pl@chatandvision.com">support-pl@chatandvision.com</a><?= $so_no ? ", podając następujący numer referencyjny :{$so_no}." : "." ?>
                                    <br/><br/>
                                    Przepraszamy za wszelkie niedogodności i mamy nadzieję, że wkrótce się Państwo z
                                    nami skontaktują.<br/>
                                </p>
                            </td>
                            <td>&nbsp;</td>
