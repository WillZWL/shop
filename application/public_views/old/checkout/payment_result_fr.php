                            ...
                            <td>
                                <p>
                                    ...
                                    if ($so_ps && $so_ps->get_payment_status() == "S") {
                                        ?>
                                        Nous avons envoyé une confirmation sur votre adresse email d'inscription a <?= $_SESSION["client"]["email"] ?>.
                                        <br/><br/>
                                    <?php
                                    } else {
                                        ?>
                                        Nous avons envoyé un accusé de réception de votre commande à votre adresse email <?= $_SESSION["client"]["email"] ?>. Nous vous informerons de nouveau lorsque le paiement aura été validé.
                                        <br/><br/>
                                    <?php
                                    }
                                    ?>

                                    Au cas où vous avez des demandes, n'hésitez surtout pas à visiter notre F.A.Q. ou à
                                    nous contacter par email à <a href="mailto:support-fr@chatandvision.com">support-fr@chatandvision.com</a>
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    Nous vous invitons à verifier vos coordonnées de facturation et essayer de nouveau.
                                    Parallèlement, pour plus de détails, vous pouvez contacter nos représentants de
                                    service clientèle à <a href="mailto:support@chatandvision.com">support@chatandvision.com</a><?= $so_no ? " en indicant votre numéro de commande: {$so_no}. " : "." ?>
                                    <br/><br/>
                                    Nous nous excusons pour tout désagrément occasionné et espérons pouvoir vous
                                    assister prochainement.<br/>
                                </p>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
