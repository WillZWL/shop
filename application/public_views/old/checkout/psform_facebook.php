    ...
    <form name="fm_pmgw" id="fm_pmgw" method="post" target="lbIframe">
        <div id="div_del_info_contact_detail">
            <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>
                    <td colspan="3" height="30px"><font size="2"><strong>Delivery Information &amp; Contact
                ...
                <tr>
                    <td rowspan="2" valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="1">
                            ...
                            <tr>
                                <td colspan="3">
                                    <select name="del_country_id" id="del_country_id" class="pmgw_input"
                                            onChange="if (this.value != '') { ChgDelCountry(this); }">
                            ...
                            <tr>
                                <td><input type="text" class="pmgw_input" dname="First Name" notEmpty
                                           value="<?= htmlspecialchars($_SESSION["POSTFORM"]["del_first_name"]) ?>"
                                           id="del_first_name" name="del_first_name"/></td>
                                <td></td>
                                <td><input type="text" class="pmgw_input" dname="Surname" notEmpty
                                           value="<?= htmlspecialchars($_SESSION["POSTFORM"]["del_last_name"]) ?>"
                                           id="del_last_name" name="del_last_name"/></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="3"><input type="text" class="pmgw_input" onblur="checkImmediate(this)"
                                                       isLatin dname="Company Name"
                                                       value="<?= htmlspecialchars($_SESSION["POSTFORM"]["del_company"]) ?>"
                                                       id="del_company" name="del_company"/></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="3"><input type="text" class="pmgw_input" onblur="checkImmediate(this)"
                                                       isLatin
                                                       dname="Address" <?= $require_client_detail ? "notEmpty" : "" ?>
                                                       value="<?= htmlspecialchars($_SESSION["POSTFORM"]["del_address_1"]) ?>"
                                                       id="del_address_1" name="del_address_1" maxLen="35"/></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="3"><input type="text" class="pmgw_input" onblur="checkImmediate(this)"
                                                       isLatin dname="Address Line 2"
                                                       value="<?= htmlspecialchars($_SESSION["POSTFORM"]["del_address_2"]) ?>"
                                                       id="del_address_2" name="del_address_2" maxLen="35"/></td>
                            </tr>
                            ...
                            <tr>
                                <td><input type="text" class="pmgw_input" onblur="checkImmediate(this)" isLatin
                                           dname="City" <?= $require_client_detail ? "notEmpty" : "" ?>
                                           value="<?= htmlspecialchars($_SESSION["POSTFORM"]["del_city"]) ?>"
                                           id="del_city" name="del_city"/></td>
                                <td></td>
                                <td>
                                    <div id="div_del_state">
                                        <input name="del_state" type="text" id="del_state" class="pmgw_input"
                                               value="<?= htmlspecialchars($_SESSION["POSTFORM"]["del_state"]) ?>"
                                               dname="State" isLatin
                                               onblur="checkImmediate(this);xajax.call('_check_surcharge', { parameters: [xajax.getFormValues('fm_pmgw'), document.fm_pmgw.del_surcharge.value, parent.document.getElementById('input_total').value], callback: x_CallBack.del_state});"/>
                                    </div>
                            ...
                            <tr>
                                <td>
                                    <input name="del_postcode" type="text" class="pmgw_input" id="del_postcode"
                                           ...
                                           onblur="checkImmediate(this);xajax.call('_check_surcharge', { parameters: [xajax.getFormValues('fm_pmgw'), document.fm_pmgw.del_surcharge.value, parent.document.getElementById('input_total').value], callback: x_CallBack.del_postcode});"/>
                                    <span id="span_pc_surcharge" style="color:#FF0000;"></span>
                                </td>
                                <td></td>
                                <td><input name="tel_3" type="text" class="pmgw_input" id="tel_3"
                    ...
                    <td valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="1" align="center">
                            ...
                            <tr>
                                <td><input name="email" type="text" id="email" class="pmgw_input"
                            ...
                            <tr>
                                <td><input type="text" class="pmgw_input" dname="Confirm email address" validEmail
                                           notEmpty match="email" id="confirm_email" name="confirm_email"
                            ...
                            <tr>
                                <td>
                                    ...
                                    <span style="color:#c90509; font-weight:bold;"
                                          id="span_surcharge"><?= $surcharge * 1 ? platform_curr_format(PLATFORMID, $surcharge) : "" ?></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <span id="span_total_plus_surcharge"
                                          style="font-weight: bold; color: rgb(0, 175, 240); font-size: 14px;"></span>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td valign="bottom" align="right">
                        <input type="image" src="<?= base_url() ?>images/btn_continue_<?= get_lang_id() ?>.png"
                               height="34" onClick="NextPage(); return false;"/>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div id="div_payment_method_billing_info" style="display:none">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td colspan="3" height="30px"><font size="2"><strong>Payment Method &amp; Billing
                ...
                <tr>
                    <td rowspan="2">
                        <table width="100%" border="0" cellspacing="0" cellpadding="1" align="center">
                            ...
                            <tr>
                                <td colspan="3">
                                    <input type="checkbox" name="billaddr" id="billaddr"
                                           onclick="DeliveryAddrAsBillingAddr()"
                            ...
                            <tr>
                                <td colspan="3">
                                    <select name="country_id" id="country_id" class="pmgw_input"
                                            onChange="if (this.value != '') { <?= $js_card_func ?>(this.value, document.getElementById('rs_card')); ChangeCardNoRadio(this.value, window.parent.document.getElementById('rs_card')); xajax.call('_check_state', { parameters: [this.value], callback: x_CallBack.country_id}); }">
                                        <option value="">Select country</option>
                                        <?php
                            ...
                            <tr>
                                ...
                                <td>Surname*</td>
                            <tr>
                                <td><input name="forename" type="text" id="forename" class="pmgw_input"
                            ...
                            <tr>
                                <td colspan="3"><input name="companyname" type="text" id="companyname"
                                                       class="pmgw_input"
                            ...
                            <tr>
                                <td colspan="3"><input name="address_1" type="text" id="address_1" class="pmgw_input"
                            ...
                            <tr>
                                <td colspan="3"><input name="address_2" type="text" id="address_2" class="pmgw_input"
                                                       value="<?= htmlspecialchars($_SESSION["POSTFORM"]["address_2"]) ?>"
                                                       maxLen="35"/></td>
                            </tr>
                ...
                <tr>
                    <td valign="bottom" align="right">
                        <input
                            onClick="if(PreValidateForm(document.fm_pmgw) && CheckForm(document.fm_pmgw)){document.getElementById('a_check').onclick();} return false;"
                            type="image" src="<?= base_url() ?>images/btn_continue_<?= get_lang_id() ?>.png"
                            height="34"/><a id="a_check"
                                            href="<?= base_url() ?>checkout_facebook/psform?hidden=1<?= $this->input->get("debug") ? "&debug=1" : "" ?>"
                                            rel="lyteframe"
                                            rev="width:<?= $pmgw_frame_width ?>px; height:<?= $pmgw_frame_height ?>px; scrolling: auto;padding: 40px;"></a>
                    </td>
                </tr>
            </table>
        </div>
