                            ...
                            <td>
                                <p>
                                    ...
                                    if ($so_ps && $so_ps->get_payment_status() == "S") {
                                        ?>
                                        Abbiamo inviato una conferma di questo ordine alla tua casella email registrata su <?= $_SESSION["client"]["email"] ?>.
                                        <br/><br/>
                                    <?php
                                    } else {
                                        ?>
                                        Abbiamo inviato la conferma di questo ordine alla tua casella email registrata su <?= $_SESSION["client"]["email"] ?>. Ti informeremo quando il pagamento sarà  stato accettato.
                                        <br/><br/>
                                    <?php
                                    }
                                    ?>

                                    Nel caso avessi eventuali domande, non esitare a visitare la nostra pagina <a
                                        href="<?= base_url() ?>faq">"FAQ"</a> oppure a mandarci una email a <a
                                        href="mailto:support-it@chatandvision.com">support-it@chatandvision.com</a> per
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    È possibile rivedere i dettagli relativi alla fatturazione e riprovare. In caso
                                    contrario, ti preghiamo di contattare il Servizio Clienti a <a
                                        href="mailto:support-it@chatandvision.com">support-it@chatandvision.com</a><?= $so_no ? " indicando il seguente riferimento: {$so_no} per ulteriore assistenza. " : "." ?>
                                    <br/><br/>
