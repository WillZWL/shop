			...
			<tr>
			  	<td>
					...
					<?php
						...
						{
					?>
					この注文の確認メールをお客様の登録済みメールアドレス<?=$_SESSION["client"]["email"]?>宛に送信致しました。<br /><br />
					<?php
						}
						else
						{
					?>
					この注文の受領確認メールを、お客様の登録済みメールアドレス<?=$_SESSION["client"]["email"]?>宛に送信致しました。支払処理が完了しましたら再度ご連絡致します。 <br /><br />
					<?php
						}
					?>

					お問い合わせの際は、弊社のよくある<a href="<?=base_url()?>faq">質問ページ</a>をご覧いただくか、<a href="mailto:support-jp@chatandvision.com">support-jp@chatandvision.com</a>までお気軽にメールをお送り下さい。
					</p>
				</td>
			<td>&nbsp;</td>
		</tr>
