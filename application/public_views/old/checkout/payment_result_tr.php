                            ...
                            <td>
                                <p>
                                    ...
                                    if ($so_ps && $so_ps->get_payment_status() == "S") {
                                        ?>
                                        Bu sipariş için <?= $_SESSION["client"]["email"] ?>`de kayıtlı e-posta adresinize onay mesajı gönderildi.
                                        <br/><br/>
                                    <?php
                                    } else {
                                        ?>
                                        Bu sipariş için <?= $_SESSION["client"]["email"] ?>`de kayıtlı e-posta adresinize onay gönderildi. Ödeme tamamlandığında sizi bu konuda bilgilendireceğiz.
                                        <br/><br/>
                                    <?php
                                    }
                                    ?>
                                    Herhangi bir sorun durumunda, <a href="<?= base_url() ?>faq"> S.S.S.</a> sayfasını
                                    ziyaret edebilirsiniz ya da <a href="mailto:support_tr@chatandvision.com">support_tr@chatandvision.com</a>
                                    adresine daha fazla yardım için e-posta gönderebilirsiniz.
                                </p>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    Fatura bilgilerinizi gözden geçirebilir ve tekrar deneyebilirsiniz. Aksi takdirde,
                                    <a href="mailto:support_tr@chatandvision.com">support_tr@chatandvision.com</a> deki
                                    Müşteri Hizmetleri temsilcimizle daha fazla yardım
                                    için <?= $so_no ? "{$so_no} referans numarasını belirterek iletişime geçebilirsiniz. " : "." ?>
                                    <br/><br/>
