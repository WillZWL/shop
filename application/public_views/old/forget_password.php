        ...
        if (stripos($thisemail, "@") === false) {
            ...
            if (stripos($thisafterat, ".") === false) {
                ...
                foreach ($invalchars as $charf) {
                    if (stripos($thisemail, $charf) && $error != 4) {
                        $error = 4;
                    };
                }
            }
        ...
        <tr>
            <td align="center" valign="top" style="padding-top:80px; padding-bottom:30px;">
                        ...
                        <tr>
                            <td height="20px" colspan="3"
                                ...
                                if ($error != 0) {
                                    ...
                                    if ($no_user == 1) {
                                        echo $lang_text['email_not_exist'];
                                    }
                                }
                                ?>
                            </td>
                ...
                <form name="fm_login" method="GET" onSubmit="return CheckForm(this)" style="margin-top:5px">
                    <table style="text-align:left" cellspacing="0" cellpadding="1" bgcolor="#FFA042" width="500"
                           height="100">
                        <tr>
                            <td height="10px" colspan="3"
                                style="text-align:center; font-weight:bold; border-left:1px solid #EF5F16; border-top:1px solid #EF5F16; padding:8px; ">
                        ...
                        <tr>
                            <?php if ($error != 0 && $displayn == 1) { ?>
                                ...
                                <td><input name="email"
                                           value="<?= $this->input->get("page") ? "" : htmlspecialchars($this->input->get("email")) ?>"
                                           notEmpty><input type="submit" value="<?= $lang_text['go'] ?>"></td>
                            <?php } else { ?>
                        ...
                        <tr>
                            <td colspan="4"
                                style="border-left:1px solid #EF5F16; border-bottom:1px solid #EF5F16; padding:8px; border-right:1px solid  #EF5F16; ">
                                &nbsp;</td>
                        </tr>
                    </table>
