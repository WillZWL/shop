...
<div align="center">
    <table border="0" width="871" height="276" id="table20" background="/images/landing/pdtpop.png">
            ...
            <td colspan="2" valign="bottom">
                <p align="left">
                    <b><a href="<?= base_url() ?>mainproduct/view/<?= $popular->get_sku() ?>"><font face="Arial"
                                                                                                    size="4"><?= $popular->get_content_prod_name(); ?></font>
                        </a></b>
            </td>
            <td rowspan="6">
                    ...
                    <tr>
                        <td align="left">
                            <object height="150" width="232">
                                ...
                                <param value="https://www.youtube.com/watch?v=<?= $popular->get_youtube_id(); ?>"
                                       name="movie">
                                <embed height="150" width="232" wmode="transparent" allowfullscreen="true"
                                       allowscriptaccess="always"
                                       type="application/x-shockwave-flash"
                                       src="https://www.youtube.com/v/<?= $popular->get_youtube_id(); ?>? autoplay=1;fs=1&amp;hl=en_US&amp;rel=0">
                                    <?php } else { ?>
                                    <param value="http://www.youtube.com/watch?v=<?= $popular->get_youtube_id(); ?>"
                                           name="movie">
                                <embed height="150" width="232" wmode="transparent" allowfullscreen="true"
                                       allowscriptaccess="always"
                                       type="application/x-shockwave-flash"
                                       src="http://www.youtube.com/v/<?= $popular->get_youtube_id(); ?>? autoplay=1;fs=1&amp;hl=en_US&amp;rel=0">
                                    <?php } ?>
                            </object>
                        </td>
                    </tr>
                        ...
                        <td align="left">
                            <p>
                                <a href="<?= base_url() ?>mainproduct/view/<?= $popular->get_sku() ?>" style="background:url(/images/landing/bluebutton.png);
                                        ...
                                        margin: 0; background-repeat: no-repeat;" valign="top"><font face="Arial"
                                                                                                     color="#FFFFFF"
                                                                                                     size="1">learn
                                        more</font></a>
                            </p>
            ...
            <td colspan="2" valign="top">
                <p align="left">
                    <b><font color="#01AFEC" face="Arial" size="2">
                            <img border="0" src="/images/landing/arrow.png" width="16"
                                 height="16">&nbsp;<?= $popular->get_display_quantity(); ?>
                            in stock</font></b>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" valign="top">
                <p align="left">
                    <a href="<?= base_url() ?>cart/add_item/<?= $popular->get_sku() ?>"
                       style="background: url('/images/landing/yellowbutton.png'); display: block; padding-left: 15px; padding-top: 3px; width: 98px; height: 34px; margin: 0; background-repeat: no-repeat;"
                       valign="top">
                        <font face="Arial" color="#FFFFFF" size="1">add to cart</font></a>
            </td>
        </tr>
