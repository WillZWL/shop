...
<head>
    ...
    <meta name="copyright"
          content="Copyright 2001 - <?php echo date("Y"); ?> <?= $_SESSION["domain_platform"]["site_name"] ?> All rights reserved.">
...
<div id="container">
    <table width="800" cellpadding="0" cellspacing="0" border="0" align="center">
        ...
        <tr>
            <td width="706" align="left" valign="top"><a href="www.valuebasket.com"><img
                        src="/images/valuebasket_logo.png" height="50" border="0"/></a></td>
            <td>&nbsp;</td>
            <td align="right"></td>
        </tr>
        <tr>
                ...
                <table width="100%" border="0" cellpadding="3px" cellspacing="0" style="text-align:left">
                    ...
                    <tr>
                        ...
                        <td class="rma_field">
                            <table border=0 cellpadding=0 cellspacing=0 width=99%>
                                ...
                                <col>
                                <tr>
                                    <td><?= $lang_text['rma_number'] ?>
                                        &nbsp;:&nbsp;<?= htmlspecialchars($rma_obj->get_id()) ?></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td><?= $lang_text['order_number'] ?>
                                        &nbsp;:&nbsp;<?= htmlspecialchars($rma_obj->get_client_id()?>
                                        -<?= $new_so_no ?></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td><?= $lang_text['purchase_date'] ?>
                                        &nbsp;:&nbsp;<?= date("Y-m-d", strtotime($order->get_order_create_date())) ?></td>
                                    <td></td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="rma_field">
                            <table border=0 cellpadding=0 cellspacing=0 width=99%>
                                ...
                                <col>
                                <tr>
                                    <td><b><?= $lang_text['first_name'] ?>
                                            :</b><br><?= htmlspecialchars($rma_obj->get_forename()) ?></td>
                                    <td><b><?= $lang_text['surname'] ?>
                                            :</b><br><?= htmlspecialchars($rma_obj->get_surname()) ?></td>
                                    <td></td>
                                </tr>
                                <tr height="10px"></tr>
                                <tr>
                                    <td><b><?= $lang_text['country'] ?> :</b><br><?= htmlspecialchars($country_name) ?>
                                    </td>
                                    <td><b><?= $lang_text['city'] ?>
                                            :</b><br><?= htmlspecialchars($rma_obj->get_city()) ?></td>
                                    <td><b><?= $lang_text['state'] ?>
                                            :</b><br><?= htmlspecialchars($rma_obj->get_state()) ?></td>
                                </tr>
                                <tr height="10px"></tr>
                                <tr>
                                    <td><b><?= $lang_text['address'] ?>
                                            :</b><br><?= htmlspecialchars($rma_obj->get_address_1()) ?>
                                        <br><?= htmlspecialchars($rma_obj->get_address_2()) ?></td>
                                    <td><b><?= $lang_text['postcode'] ?>
                                            :</b><br><?= htmlspecialchars($rma_obj->get_postcode()) ?></td>
                                    <td></td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="rma_field">
                            <table border=0 cellpadding=0 cellspacing=0 width=99%>
                                ...
                                <col>
                                <tr>
                                    <td><b><?= $lang_text['product_returned'] ?>
                                            :</b><br><?= htmlspecialchars($rma_obj->get_product_returned()) ?></td>
                                    <td><b><?= $lang_text['serial_number'] ?>
                                            :</b><br><?= htmlspecialchars($rma_obj->get_serial_no()) ?></td>
                                    <td><b><?= $lang_text['categories'] ?>
                                            :</b><br><?= $cat_arr[$rma_obj->get_category()]; ?></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="rma_field">
                            <table border=0 cellpadding=0 cellspacing=0 width=99%>
                                ...
                                <col>
                                <tr>
                                    <td><b><?= $lang_text['reason_for_returns'] ?>
                                            :</b><br><?= $reason_arr[$rma_obj->get_reason()]; ?></td>
                                    <td><b><?= $lang_text['action_required'] ?>
                                            :</b><br><?= $action_arr[$rma_obj->get_action_request()]; ?></td>
                                    <td></td>
                                </tr>
                                <tr height="10px"></tr>
                                <tr>
                                    <td colspan="3"><b><?= $lang_text['detail_desc_of_product'] ?>
                                            :</b><br><?= htmlspecialchars($rma_obj->get_details()) ?></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="rma_field">
                            ...
                            <input type="checkbox" value="1" dname="Declaration" checked
                                   disabled>&nbsp;<?= $lang_text['agree_terms'] ?>
                        </td>
                    </tr>
                </table>
                <!-- RMA formform end-->
