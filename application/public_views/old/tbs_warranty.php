...
switch (strtolower(PLATFORMCOUNTRYID)) {
    case 'es' :
        $warranty_youtube_id = 'nMKfwSE-78g';
        break;

    case 'nz' :
        $warranty_youtube_id = 'lHbfqkxUNww';
        break;
    case 'sg' :
        $warranty_youtube_id = 'RLBOGfQ2y38';
        break;
    case 'my' :
        $warranty_youtube_id = 'HYHLEPUoVtM';
        break;
    case 'hk' :
    case 'au' :
        $warranty_youtube_id = 'ySi1pV2E6ms';
        break;

    case 'gb' :
        $warranty_youtube_id = '3ixvQc9tKDw';
        break;
    case 'fi' :
    case 'ie' :
    case 'us' :
        $warranty_youtube_id = 'upv2j5oA7jM';
        break;
    case 'fr' :
        $warranty_youtube_id = '5wmxgyC_xA0';
        break;
    case 'be' :
        $warranty_youtube_id = '5wmxgyC_xA0';
        break;
    case 'it' :
        $warranty_youtube_id = 'IHArQen8au8';
        break;
