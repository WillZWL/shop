    ...
    <div id="bd">
        ...
        <div class="intro">
            ...
            <p>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <span class="invalid"><img src="img/g.gif"
                                           class="validation-icon"/> - invalid. need your attention</span>
            </p>
        </div>
        <?php
        ...
        <div class="section">
            ...
            <div class="sub-section">
                ...
                <p>
                    You are currently running ClickTale PHP Integration module version 0.16 (08.15.2010)
                </p>
            </div>
        ...
        <div class="section">
            ...
            <?php foreach ($validatorsValues as $key => $val) : ?>
                ...
                <div class="sub-section">
                    <h3 class="<?php echo $class; ?>"><img src="img/g.gif"
                                                           class="validation-icon"/> <?php echo $val['title']; ?></h3>
        ...
        <div class="section">
            ...
            <?php if ($cacheConfigValid): ; ?>
                <p>
                    On the left there is a page which will be cached using the settings you specified in the integration
                    module's config.php<br/>
                ...
                <div class="sub-section">
                    ...
                    and wait <input type="text" style="width: 100px;" id="delay-before-fetching" value="0.5"/> sec for
                    fetching
                    <br/><br/>
