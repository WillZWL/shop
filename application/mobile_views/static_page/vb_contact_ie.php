...
<!--phone flag -->
          ...
          <div style="width:280" id="byPhone">
            ...
            <img onmouseover="mouseOver(this,'p')" class="" src="[cdn_url]images/contactus/icon-ie.png" width="24" height="24" border=0 alt="ie-phone version" id="iep" /></a>            
            <a>
