...
<!--phone flag -->
          ...
          <div style="width:280" id="byPhone">
            ...
            <a>
            <img onmouseover="mouseOver(this,'p')" class="" src="[cdn_url]images/contactus/icon-au.png" width="24" height="24" border=0 alt="au-phone version" id="aup" /></a>
...
<!--Map flag -->
          ...
          <div id="byMap">
            ...
            <img onmouseover="mouseOver(this,'m')" class="" src="[cdn_url]images/contactus/icon-au.png" width="24" height="24" border=0 alt="au-phone version" id="aum" /></a>
