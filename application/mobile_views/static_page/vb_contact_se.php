...
<!--phone flag -->
          ...
          <div style="width:280" id="byPhone">
            ...
            <img onmouseover="mouseOver(this,'p')" class="" src="[cdn_url]images/contactus/icon-gb.png" width="24" height="24" border=0 alt="my-phone version" id="gbp" /></a>
