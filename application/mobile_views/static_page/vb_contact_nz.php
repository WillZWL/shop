...
<!--phone flag -->
          ...
          <div style="width:280" id="byPhone">
            ...
            <img onmouseover="mouseOver(this,'p')" class="" src="[cdn_url]images/contactus/icon-nz.png" width="24" height="24" border=0 alt="nz-phone version" id="nzp" /></a>
...
<!--Map flag -->
          ...
          <div id="byMap">
            ...
            <img onmouseover="mouseOver(this,'m')" class="" src="[cdn_url]images/contactus/icon-nz.png" width="24" height="24" border=0 alt="nz-Address version" id="nzm" /></a>
            ...
            <img onmouseover="mouseOver(this,'m')" class="" src="[cdn_url]images/contactus/iconBW-sg.png" width="24" height="24" border=0 alt="sg-Address version" id="sgm" /></a>
