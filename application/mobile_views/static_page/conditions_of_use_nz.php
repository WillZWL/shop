<div id="content">
	<h5 class="side_title">Conditions of Use</h5>
	...
	<div class="text silver_box static_page">
		<p>
			...
			Please review our <a href="[base_url;noerr;]privacy_policy">Privacy Policy</a> for our applicable practices when using our website.
			<br /><br />
			...
			<br /><br />
			ValueBasket.com reserves the right to refuse service, terminate accounts, remove or edit content, or cancel orders at ValueBasket.com's absolute discretion with giving any reason therefor. You may cancel your account at any time via information found on our <a href="[base_url;noerr;]contact">Contact Us</a> page.
			<br /><br />
			...
			ValueBasket.com has registered offices<br>
			<table>
				...
				<tr>
					<td></td>
					<td>New Zealand</td>
					<td>Blackmore Virtue & Owens, 18 Broadway, Auckland, 1023, NZ &#40;GST 111-549-265&#41;</td>
				</tr>
			</table>
			<br /><br />
			The website of ValueBasket.com is found at <a href="[base_url;noerr;]">www.ValueBasket.com</a>.
			<br /><br />
		</p>
	</div>
</div>