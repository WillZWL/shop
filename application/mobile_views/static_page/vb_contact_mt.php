...
<!--phone flag -->
          ...
          <div style="width:280" id="byPhone">
            ...
            <img onmouseover="mouseOver(this,'p')" class="" src="[cdn_url]images/contactus/icon-mt.png" width="24" height="24" border=0 alt="mt-phone version" id="mtp" /></a> 
...
<!-- 		SBF #2425
            ...
            <img onmouseover="mouseOver(this,'p')" class="" src="[cdn_url]images/contactus/iconBW-gb.png" width="24" height="24" border=0 alt="gb-phone version" id="gbp" /></a>
...
<!--phone txt fi -->
   ...
   <div style="display: block; width:240" class="PhoneDescription" id="mt-phone">
   
   <div class="arrow">&nbsp;</div>

   <p><font style="color:#F60; font-weight: bold; font-family: Arial; font-size: 14px;">Malta<br />

   <br />

  </font>(+356) 27780416<br />
