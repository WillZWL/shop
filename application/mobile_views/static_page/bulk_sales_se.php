...
<div id="content">
	...
	<div class="text silver_box static_page">
		<p>
			[lang_text.bulk_sales_paragraph_1;noerr;htmlconv=no;]<a href="#enquiry_box_anchor" onclick="ShowEnquiryBox('Bulk');document.getElementById('enquiry_box_question').value = 135;">[lang_text.bulk_sales_contact;noerr;htmlconv=no;]</a> [lang_text.bulk_sales_paragraph_1_1;noerr;htmlconv=no;] [cs_phone_no;noerr;magnet=(div)].
			<br /><br />
			...
			<br /><br />
			[lang_text.bulk_sales_min_order_1;noerr;htmlconv=no;][platform_currency_id;noerr;htmlconv=no;] [lang_text.bulk_sales_min_order_2;noerr;htmlconv=no;]
			<br /><br />
			[lang_text.bulk_sales_paragraph_2;noerr;htmlconv=no;]
			<br /><br />
