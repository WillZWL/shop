...
<!-- SBF #2425
			...
			<p>
			Si desea ponerse en contacto con nosotros por teléfono, por favor utlice los números indicados a continuación: 
	            <br /><br /><br /></p>
 -->
			<!--phone txt fr -->
<!-- SBF #2425		
			<div style="display: block; width:240" class="PhoneDescription" id="fr-phone">
			<p><font style="color:#F60; font-weight: bold; font-family: Arial; font-size: 14px;">España<br />
			<br /></font>
			93 181 66 45<br />
			CET 8h00 - 16h00 (de lunes a viernes)<br /></p>
			</div>
			</td>
 -->
