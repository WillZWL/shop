...
<div id="content">
	...
	<div class="text silver_box static_page">
		<p>
			[lang_text.bulk_sales_paragraph_1;noerr;htmlconv=no;]
			<br /><br />
			[lang_text.bulk_sales_paragraph_2;noerr;htmlconv=no;]<a href="#enquiry_box_anchor" onclick="ShowEnquiryBox('Bulk');document.getElementById('enquiry_box_question').value = 135;">[lang_text.bulk_sales_contact;noerr;htmlconv=no;]</a>.
			<br /><br />
			[lang_text.bulk_sales_paragraph_3;noerr;htmlconv=no;]
			<br /><br />
			...
			<br>
				...
				<img src="http://cdn.valuebasket.com/808AA1/vb//images/aboutus/gls.jpg" width="111" height="64" /> 
				<br />
