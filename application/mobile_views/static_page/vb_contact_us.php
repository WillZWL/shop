			...
			<form name="fm_enquiry" class="form-holder" method="post" onsubmit="if (CheckForm(this)) {SubmitEnquiry(this);} return false;" target="enquiry_result_iframe" enctype="multipart/form-data">
				...
				<table>
					<tr>
						...
						<td colspan="2">
							<fieldset class="medium">
								<input id="enquiry_box_fullname" type="text" notempty islatin dname="Name" name="fullname">
							</fieldset>
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="2">
							<fieldset class="medium">
								<input id="enquiry_box_email" type="text" notempty validEmail dname="Email Address" name="email">
							</fieldset>
						</td>
					</tr>
...
<!--phone flag -->
          ...
          <div style="width:280" id="byPhone">
            ...
            <img onmouseover="mouseOver(this,'p')" class="" src="[cdn_url]images/contactus/icon-us.png" width="24" height="24" border=0 alt="us-phone version" id="usp" /></a> 
