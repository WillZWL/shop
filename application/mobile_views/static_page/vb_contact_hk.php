...
<!--phone flag -->
          ...
          <div style="width:280" id="byPhone">
            ...
            <img onmouseover="mouseOver(this,'p')" class="" src="[cdn_url]images/contactus/icon-hk.png" width="24" height="24" border=0 alt="hk-phone version" id="hkp" /></a>
...
<!--Map flag -->
          ...
          <div id="byMap">
            ...
            <img onmouseover="mouseOver(this,'m')" class="" src="[cdn_url]images/contactus/icon-hk.png" width="24" height="24" border=0 alt="hk-Address version" id="hkm" /></a>
