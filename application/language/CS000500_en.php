<?php
	$lang = array(	"title"=>"Request Compensation",
			...
			"header_message"=>"For your reference history of the compensation is listed below.<br>Please fill in all necessary information below to setup a compensation request.",
			"so_no"=>"Sales Order #",
