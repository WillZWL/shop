...
class Product_overview_amuk_model extends CI_Model
{
    ...
    {
        return $this->amuk_price_service->get_product_overview_tr($where, $option, "Product_cost_dto", $lang);
    }

    public function get_product_list_total($where = array(), $option = array())
    {
        return $this->amuk_price_service->get_product_overview($where, array_merge($option, array("num_rows" => 1)));
    }
