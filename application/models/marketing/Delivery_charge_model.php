...
class Delivery_charge_model extends CI_Model
{
    ...
    {
        return $this->delivery_type_service->get_delivery_type_list();
    }
    ...
    {
        return $this->weight_cat_service->get_full_weight_cat_charge_list($where, $option);
    }
    ...
    {
        return $this->weight_cat_service->update_wcc($obj);
    }

    public function insert_wcc($obj)
    {
        return $this->weight_cat_service->insert_wcc($obj);
    }

    public function get_weight_cat_charge_obj($where = array())
    {
        return $this->weight_cat_service->get_wcc_dao()->get($where);
    }
