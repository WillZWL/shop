...
class Pricing_tool_amuk_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->load->library('service/amuk_price_service');
    ...
    {
        $this->amuk_price_service->set_dto($dto);
    }

    public function calc_profit_ps()
    {
        $this->amuk_price_service->calc_profit();
    }

    public function get_table_header_ps()
    {
        return $this->amuk_price_service->draw_table_header_row();
    }

    public function get_table_row_ps($default_st)
    {
        return $this->amuk_price_service->draw_table_row_for_pricing_tool($default_st);
    }

    public function get_table_row_ps_pg($default_st)
    {
        return $this->amuk_price_service->draw_table_row_for_pricing_tool_for_pg($default_st);
    }

    public function get_js_ps()
    {
        return $this->amuk_price_service->print_js_for_pricing_tool();
    }

    public function get_currency()
    {
        return $this->amuk_price_service->get_dto()->get_platform_currency_id();
    }
    ...
    public function get_note($sku = "", $type = "")
    {
        if ($sku == "") {
            ...
            return $this->product_note_service->get_dao()->get_note_with_author_name($type == "M" ? "AMUK" : "", $sku, $type);
        }
    }
