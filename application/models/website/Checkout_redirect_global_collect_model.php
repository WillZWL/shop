...
include_once(APPPATH . "libraries/service/payment_gateway_redirect_global_collect_service.php");

class Checkout_redirect_global_collect_model extends Checkout_redirect_model
{
	...
	{
		$this->pmgw_redirect_service = new Payment_gateway_redirect_global_collect_service($this->debug);
	}
