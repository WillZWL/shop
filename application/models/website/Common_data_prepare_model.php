	...
	protected function login__index($controller, $url_paras)
	{
		...
		else
		{
			...
			if ($salecycle_enabled)
			{
				...
				{
					case "GB": $script_name = "VALUEBASKET"; break;
					case "AU": $script_name = "VALUEBASKETAU"; break;

					# SBF#2117
					case "NZ": $script_name = "VALUEBASKETNZ"; break;
					case "FR": $script_name = "VALUEBASKETFR"; break;
					case "SG": $script_name = "VALUEBASKETSG"; break;
					case "ES": $script_name = "VALUEBASKETES"; break;
				}
