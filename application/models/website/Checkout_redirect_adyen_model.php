...
include_once(APPPATH . "libraries/service/payment_gateway_redirect_adyen_service.php");

class Checkout_redirect_adyen_model extends Checkout_redirect_model
{
	...
	{
		$this->pmgw_redirect_service = new Payment_gateway_redirect_adyen_service($this->debug);
	}
