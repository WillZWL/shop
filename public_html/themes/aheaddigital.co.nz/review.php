...
<div id="review_order" class="col-md-12">
    <div id="content">
        ...
        <div class="row" style="position: absolute;bottom: 65px;">
            <div class="col-sm-6">
                <p style="font-size: 12px;padding: 0;margin: 0;line-height: 18px;">
                Depending on the payment option available, you may be subject to a variable fee to cover 
                the exchange rate into local currency. By placing an order with us, you agree to pay all
                payment fees incurred in connection with your purchase(s).
                </p>
            </div>
        </div>
        <div class="buttons">
