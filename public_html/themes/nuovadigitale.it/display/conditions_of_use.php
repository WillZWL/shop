...
<?= _('Tutte le informazioni contenute sul sito incluse immagini, illustrazioni, design, foto, video, testo ed altri materiali sul sito (collettivamente qui definiti "Contenuti") consistono in proprietà intellettuali tutelate in base ai diritti d’ autore, marchi, nominativi commerciali, che appartengono o sono controllati da ChatandVision (HK) Limited , aziende sussidiarie ed affiliate ("ChatandVision") o sono riconducibili ai rispettivi proprietari. Il nome ChatandVision ed il logo ChatandVision sono marchi registrati ChatandVision.') ?>
                    ...
                    <p>
                        <?= _("Il periodo in cui puoi esercitare il diritto di recesso è 14 giorni dopo la ricezione dell’ ordine. La richiesta ci deve pervenire per iscritto – email o lettera. I beni inutilizzati (inclusi accessori inclusi nel prezzo del prodotto) devono essere restituiti a tue spese entro 14 giorni dalla ricezione del tuo acquisto ed il cliente è responsabile per qualsiasi danno riconducibile al transito (regolamento applicato anche a regali di Natale). Ci riserviamo il diritto di far ispezionare il prodotto da un tecnico prima del rimborso o restituzione. Per favore, considera che pacchetti software possono essere restituiti solo non aperti. Se cancelli il tuo ordine entro il periodo di 14 giorni, rispettando tutte le condizioni qui sopra, hai diritto ad un rimborso completo per gli articoli acquistati.  Ogni cancellazione successiva ai 14 giorni  non sarà accettata.") ?>
                    </p>
                    <br /><br />
