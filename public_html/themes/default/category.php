                                                        ...
                                                        <div class="collapse navbar-collapse navbar-ex1-collapse">
                                                            <ul class="nav navbar-nav verticalmenu">
                                                                <li class="topdropdow parent dropdown ">
                                                                    <a href="<?=base_url('cat/view/1');?>" class="dropdown-toggle" data-toggle="dropdown"><i class=""></i><span class="menu-title">SmartPhones</span><b class="caret"></b></a>
                                                                    <!--
                                                                ...
                                                                <li class="topdropdow parent dropdown ">
                                                                    <a href="<?=base_url('cat/view/2');?>" class="dropdown-toggle" data-toggle="dropdown"><i class=""></i><span class="menu-title">Webcams</span><b class="caret"></b></a>
																	<!--
                                                                    <div class="dropdown-menu" style="width:700px">
                                                                        <div class="dropdown-menu-inner">
                                                                            <div class="row">
                                                                ...
                                                                <li class="">
                                                                    <a href="<?=base_url('cat/view/4');?>"><i class=""></i><span class="menu-title">Conference Phones</span></a>
                                                                </li>
                                                                <li class="">
                                                                    <a href="<?=base_url('cat/view/6');?>"><i class=""></i><span class="menu-title">Accessories</span></a>
                                                                </li>
                                                                <li class="">
                                                                    <a href="<?=base_url('cat/view/29');?>"><i class=""></i><span class="menu-title">Software</span></a>
                                                                </li>
                                                                <li class="">
                                                                    <a href="<?=base_url('cat/view/44');?>"><i class=""></i><span class="menu-title">Computing</span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
