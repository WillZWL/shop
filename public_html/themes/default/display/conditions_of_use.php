                <div class="contacts">
                    ...
                    <ol style = "list-style: decimal; list-style-position: inside">
                        <li><a href="#conditions_of_use"><?= _('CONDITIONS OF USE') ?></a></li>
                        <li><a href="#site_contents"><?= _('SITE CONTENTS, OWNERSHIP, AND USE RESTRICTIONS') ?></a></li>
                        <li><a href="#placing_order"><?= _('PLACING AN ORDER') ?></a></li>
                        <li><a href="#tax_duties"><?= _('TAX AND DUTIES') ?></a></li>
...
<?= _('The information contained in this Site including all images, illustrations, designs, photographs, video clips, writings and other materials that appear herein are copyrights, trademarks, trade dress or other intellectual property owned, controlled, or licensed (all of which, collectively, are herein referred to as the "Contents") by ChatandVision (HK) Limited or its subsidiaries and affiliates ("ChatandVision") or are the property of their respective owners. The name ChatandVision and the ChatandVision logo are registered marks of ChatandVision. ') ?>
                        ...
                        <ul>
                            <li><?= _('placing an order with DigitalDiscount.co.uk or') ?></li>
                        ...
                        <br /><br />
                        <?= _('If you choose to leave this Site via links to other non-ChatandVision operated sites, ChatandVision is not responsible for the privacy policies of those sites or the cookies those sites use.') ?>
                    </p>
                    <br /><br />

                    <h3 id="placing_order"><?= _('PLACING AN ORDER') ?></h3>
                    <p>
                        <?= _('The prices advertised on this Site are for Internet orders. Prices and the availability of items are subject to change without notice. Any recommended retail prices used on this Site are based on manufacturers’ suggested retail prices and may not be indicative of the actual selling prices in your area.') ?>
                        <br /><br />
                        <?= _('Any reference to savings used on this Site indicates the promotional savings off the recommended retail price and the actual savings will vary depending upon the goods purchased and the date of the transaction.') ?>
                        <br /><br />
                    ...
                    <h3 id="tax_duties"><?= _('TAX AND DUTIES') ?></h3>
                    <p>
                        <?= _('In using our services, you authorize ChatandVision to make arrangements for customs clearance for the products ordered. The responsibility for ensuring that your ordered product can be lawfully imported outside of Hong Kong to your destination country remains with our customers, and any applicable import duties and taxes will be subjected to the recipient. We do not have control over these import duties and taxes. Customs policies vary widely from country to country, hence if you should have any queries regarding your local Customs policies, contact your local Customs office for further information. ') ?>
                        <br /><br />
                        <?= _('Where the price of the goods allows, certain shipments to some countries may include a fee which is borne by ChatandVision, for import of the goods. This will be noted on your shipment invoice.') ?>
                        <br /><br />
                        <?= _('In the event where customs clearance is required, this will cause delays to the original delivery estimate.') ?>
                    </p>
                    <br /><br />

                    <h3 id="delivery"><?= _('DELIVERY') ?></h3>
                    <p>
                        <i><?= _('Goods will be sent to the address given by you in your order. If you are ordering more than one item, your goods may be sent to you in separate shipments. There will not be extra delivery charges for these delivery cases.') ?></i>
                        <br /><br />
                        <i><?= _('Your order should not take any more than 7 to 14 working days to arrive, however, this is not guaranteed and we cannot be held responsible for events outside of our control. If you have not received your order within 20 working days you should contact our Customer Support team.') ?></i>
                    </p>
                    <br /><br />

                    <h3 id="cancel_order"><?= _('CANCELLING YOUR ORDER') ?></h3>
                    <p>
                        <?= _("The period in which you can exercise the right to cancel an order is 30 days beginning the day after your goods are received. The cancellation request has to be received by us in writing - by email, or letter. The unused goods (including any accessories which were included in the price of the goods) must be returned at the customer's expense within 30 days after receipt of parcel and customer is responsible for any damage during the transit of the returned goods, (it also applies to products purchased as Christmas presents). We reserve the right to have the goods inspected by a technician prior to replacement or refund. Please note that software packages may only be returned unopened. Should you cancel your order within the cooling off period we will issue you a full refund for the price you paid for the item(s). Any cancellation made outside the 30 day \"cooling-off\" period may not be accepted.") ?>
                    </p>
                    <br /><br />

                    <h3 id="defective"><?= _('DEFECTIVE ITEM') ?></h3>
                    <p>
                    ...
                    <h3 id="security"><?= _('SECURITY') ?></h3>
                    <p>
                    <?= _('In using this Site you agree to the following:') ?>
                    </p>
                        <ol style = "list-style: lower-alpha; list-style-type: inside hanging; overflow: hidden; padding-left: 2em">
                            <li><?= _('You will not use any device, software, or other instrumentality to disrupt, damage or interfere with or attempt to disrupt, damage or interfere with the proper functioning of this site;') ?></li>
                            <li><?= _('You will not to violate or attempt to violate the security of this Site, including, without limitation,') ?>
                            <ol style = "list-style: lower-roman; list-style-type: inside hanging; overflow: hidden; padding-left: 3em">
                                <li><?= _('logging onto an account which you are not authorized to access;') ?></li>
                                <li><?= _('attempting to interfere with service to any user, host or network, including, without limitation, via means of submitting a virus to the Site, overloading, flooding, spamming, mail bombing or crashing; or') ?></li>
                                <li><?= _('attempt to transmit any virus, Trojan horse or other software destruction or disruption device; and') ?></li>
                            </ol>
                            </li>
                        <li><?= _('You will not intentionally or unintentionally violate any applicable international, federal, state or local law, including but not limited to any regulations applicable to your use of this Site. ') ?></li>
                        </ol>
                        <br /><br />
