                <div class="main-columns container">
                	...
                	<li><a href="#why_collect">WHY WE COLLECT</a></li>
                    <li><a href="#what_collect">WHAT WE COLLECT</a></li>
                    <li><a href="#gather">WHAT WE DO WITH THE INFORMATION WE GATHER</a></li>
                    <li><a href="#security">SECURITY</a></li>
                    <li><a href="#cookies">HOW WE USE COOKIES</a></li>
                    <li><a href="#links">LINKS TO OTHER WEBSITES</a></li>
                    <li><a href="#questions">PRIVACY QUESTIONS</a></li>
                    <br /><br />
                    ...
                    <br /><br />
                    <p>
                        We collect personal information because it helps us to deliver a customised customer service experience for you. This affords you convenient access to our product range and helps focus on categories most likely to interest you. In addition, your personal information helps allow us to keep you updated on the latest product announcements, special offers, and events that you might like to hear about.
                    </p>
                    <br /><br />
                    
                    <h3 id="what_collect">WHAT WE COLLECT</h3>
                    <br /><br />
                    <p>
                    ...
                    <h3 id="gather">WHAT WE DO WITH THE INFORMATION WE GATHER</h3>
                    <br /><br />
                    <p>
                        The personal information may help us give you a better shopping experience with us in the following areas:
                    </p>		
                    <li>we may ask for your personal information when you're discussing a service issue on the phone with a representative, making a purchase, or registering your product.</li>
					<li>we may use the information to improve our product range and services offered.</li>
					<li>we may send promotional emails (to the email address provided) about new products, special offers or other information which we think you may find interesting.</li>
					...
					<li>We will use the information to create an account area to which you can login and access your order history.</li>
                    <br /><br />
