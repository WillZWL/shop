                    ...
                    <p>
                        <?= _('When you shop with us we like to keep it simple, our free shipping offer applies to all orders no matter the size or value. ') . SITE_NAME . _(' not only accepts payment in your local currency but also ships directly to your doorstep free of charge* via our courier partners.') ?>
                    </p>
                    ...
                    <p>
                        <?= _('Once your order has been processed, an email containing your order and account information will be sent to your registered email. You can always check the status of your order by visiting the My Account page on our website and viewing your order history.') ?>
                    </p>
                    ...
                    <br />
                    <p style="color: grey;font-size: 10px;">
                        <?= _('** Although we do our best to ensure a smooth shipping process please note delivery speed to some regions may experience delays depending on a wide variety of factors (e.g. specific address location and customs delay) which are outside of our control.') ?>
                    </p>
