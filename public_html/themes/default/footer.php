                        ...
                        <div class="row">
                            <div class="column col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <div class="panel-heading panel-white">
                                    <!--<a href="/display/view/about_us">--><h4 class="panel-title"><?= _('About Us') ?></h4></div><!--</a>-->
                                <p><?= _('DigitalDiscount prides itself on great deals without compromise on service! Feel free to contact us anytime for more information') ?>
                                    <br>
                                </p>
                            </div>
                            <div class="column border-right col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <p class="contact"><?= _('Units 12- 15') ?>
                                    <br><?= _('ate sit amet lacinia.') ?></p>
                                <ul class="list-unstyled address">
                                    <li><i class="fa fa-map-marker"></i><?= _('No 1123, Sky Tower, New York, USA') ?></li>
                                    <li><i class="fa fa-tablet"></i><?= _('0870 295 9128') ?></li>
                                    <li><i class="fa fa-envelope-o"></i><a href="mailto:info@digitaldiscount.com"><?= _('info@digitaldiscount.com') ?></a></li>
                                </ul>
                            </div>
