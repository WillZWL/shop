CREATE TABLE `product` (
  ...
  `lang_restricted` tinyint(4) DEFAULT '1' COMMENT 'value 0 = completely no selection, bit 0 = Not applicable, bit 1 = FR, bit 2 = ES, bit 3 = RU, bit 4 = PL, bit 5= IT',
