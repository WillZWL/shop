...
DELIMITER ;;
CREATE DEFINER=`panther`@`127.0.0.1` PROCEDURE `add_feature_right`(IN in_app_id VARCHAR(20), IN last_id INT, IN in_role_id VARCHAR(20))
begin
...
DELIMITER ;;
CREATE DEFINER=`panther`@`127.0.0.1` PROCEDURE `add_feature_right_by_name`(IN in_app_id VARCHAR(20), IN in_feature_name VARCHAR(128), IN in_role_id VARCHAR(20))
begin
...
DELIMITER ;;
CREATE DEFINER=`panther`@`127.0.0.1` PROCEDURE `add_role_right`(IN in_app_id VARCHAR(64), IN in_role_id VARCHAR(64))
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`panther`@`127.0.0.1` PROCEDURE `create_feature_id`(IN new_feature VARCHAR(128), OUT last_id INT)
BEGIN
/* insert */
...
DELIMITER ;;
CREATE DEFINER=`panther`@`127.0.0.1` FUNCTION `current_value`(i_seq_name VARCHAR(64)) RETURNS bigint(20)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`panther`@`127.0.0.1` PROCEDURE `find_application_id`(IN in_app_id VARCHAR(10), IN in_user_name VARCHAR(32))
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`panther`@`127.0.0.1` PROCEDURE `find_role_in_app`(IN in_app_id VARCHAR(64))
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`panther`@`127.0.0.1` PROCEDURE `get_app_feature_id_by_name`(IN new_feature VARCHAR(128), OUT out_app_feature_id INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`panther`@`127.0.0.1` FUNCTION `next_value`(i_seq_name VARCHAR(64)) RETURNS bigint(20)
BEGIN
